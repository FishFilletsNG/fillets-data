...
dialogStr("Vi kan försöka att stoppa tillbakas den.")
...
dialogStr("Och dessutom: är det sannolikt att någon kommer hit någonsin? Bara sepior kommer att knapra på den ibland.")


dialogId("sp-v-pocit", "font_big", "We are going to feel good about it.")
dialogStr("Vi kommer att känna oss stolta över det här.")
...
dialogStr("Vi kommer att bli besvikna. Tror du att bossen kommer att tro oss? En jättelik propp som är urdragen? Och vad har ni gjort? Satt dit den igen. Ha, ha, ha.")


dialogId("sp-v-vzit", "font_big", "You might be right. Maybe it would be better to take it along.")
dialogStr("Du kanske har rätt. Kanske det är bäst att ta med den.")
...
dialogStr("Men om vi skulle lämna proppen här?")
