...
dialogStr("Ще се почувстваме добре, че сме го направили.")
...
dialogStr("Ще се почувстваме неловко. Мислиш ли, че шефът ще повярва? Извадена гигантска запушалка? И какво я направихте? Пъхнахме я обратно. Ха, ха, ха.")

dialogId("sp-v-vzit", "font_big", "You might be right. Maybe it would be better to take it along.")
dialogStr("Може би си права. Може би ще е по-добре да я вземем с нас.")
...
dialogStr("Дали да не зарежем тази запушалка къде то си е?")
