...
dialogStr("Que sommes nous supposés en faire ?")
...
dialogStr("Nous pouvons le remettre en place, comme une marque de notre estime pour l'effort héroïque des citoyens pour empêcher la catastrophe. En mémoire de leur nature industrieuse, ingénieuse et... persévérante.")
...
dialogStr("Pardon ? ’Où cours-tu ? Je dois passer commande de huit épées.’ La Providence elle-même à débouché ce trou. Imagines-tu entendre ce genre de choses à la maison. Jour après jour.")
...
dialogStr("Et de plus, c'est comme si personne n'était jamais venu ici. Seuls quelques mollusques le grignotent à l'occasion.")
...
dialogStr("Nous ne nous sentirons pas mieux après. Penses-tu que le patron va croire un truc pareil ? Le bouchon géant débouché. Et qu'avons nous fait ? Nous l'avons remis en place. Ah, ah, ah.")


dialogId("sp-v-vzit", "font_big", "You might be right. Maybe it would be better to take it along.")
dialogStr("Tu as peut-être raison. Peut-être vaudrait-il mieux l'emmener.")
...
dialogStr("Je me fiche de ce que le patron va penser de moi.")


dialogId("sp-m-vydrz", "font_small", "Hold on. We are sure to solve it.")
dialogStr("Attends. Nous allons certainement réussir..")
...
dialogStr("Ou alors, nous pouvons dire que la cité a sombré à cause de la fonte de la calotte arctique.")


dialogId("sp-m-vymluva2", "font_small", "An earthquake could have sunk the city, for example.")
dialogStr("Un tremblement de terre aurait pu faire sombrer la cité par exemple.")
...
dialogStr("Nous pourrions dire qu'un volcan est entré en éruption au beau milieu de la cité.")
...
dialogStr("Cette fois-ci notre but est de nous débarrasser de ce bouchon.")
