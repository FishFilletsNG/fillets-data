...
dialogStr("Nous pouvons le remettre en place, comme une marque de notre estime de l'effort héroïque des citoyens pour empêcher la catastrophe. En mémoire de leur nature industrielle, ingénieuse et... persévérante.")
...
dialogStr("Pardon ? `Ou cours-tu ? Je dois passer commande de huit épées.` La Providence elle-même à débouché ce trou. Imagines-tu entendre ce genre de chose à la maison. Jour après jour.")
...
dialogStr("Et de plus, c'est comme si personne n'était jamais venu ici. Seul quelques mollusques le grignotent à l'occasion.")


dialogId("sp-v-pocit", "font_big", "We are going to feel good about it.")
dialogStr("Nous nous sentirons mieux après.")
