...
dialogStr("Sapremo di aver fatto una buona azione.")
...
dialogStr("Sapremo di aver fatto un'idiozia. Pensi che il capo ci crederà? Un grande tappo fuori posto? E voi cosa avete fatto? Lo abbiamo ritappato. Ah ah ah.")

dialogId("sp-v-vzit", "font_big", "You might be right. Maybe it would be better to take it along.")
dialogStr("Forse hai ragione. Forse sarebbe meglio portarcelo dietro.")
...
dialogStr("Perché non lo lasciamo lì e basta?")
...
dialogStr("Forza. Lo risolveremo senz'altro.")

dialogId("sp-m-spunt", "font_small", "The darned plug. What if we just make up something.")
dialogStr("Dannato tappo. Potremmo inventarci qualcosa.")
