...
dialogStr("Schau mal, wie soll ich denn hier rauskommen?")
...
dialogStr("Ähm... Korallen! Bist du taub oder was?")


dialogId("ncp-m-tvrdy", "font_small", "Oh my, this is a hard coral.")
dialogStr("Oh je, ist die Koralle hart!.")


dialogId("ncp-v-mekky", "font_big", "Oh my, this is a soft coral.")
dialogStr("Oh je, ist die Koralle weich!")
