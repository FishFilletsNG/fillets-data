...
dialogStr("Dis-moi, comment vais-je sortir d'ici ?")
...
dialogStr("Comment t'es tu débrouillée pour arriver là-dedans ?")
...
dialogStr("Il y a tellement de coraux ici...")
...
dialogStr("Hé bien, c'est un corail mou.")
...
dialogStr("Hmm, je ne peux pas passer ici...")
