...
dialogStr("Tellement de corail. tu es sourd ou quoi ?")


dialogId("ncp-m-tvrdy", "font_small", "Oh my, this is a hard coral.")
dialogStr("Hé bien, c'est un corail dur.")


dialogId("ncp-v-mekky", "font_big", "Oh my, this is a soft coral.")
dialogStr("Hé bien, c'est un corail doux.")
