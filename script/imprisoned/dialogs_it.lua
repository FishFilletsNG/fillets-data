...
dialogStr("Come hai fatto a cacciarti là dentro?")
...
dialogStr("Ci sono così tanti cavalli qui...")
...
dialogStr("Tanti coralli. Sei sordo o cosa?")


dialogId("ncp-m-tvrdy", "font_small", "Oh my, this is a hard coral.")
dialogStr("Oh, questo è un corallo rigido.")


dialogId("ncp-v-mekky", "font_big", "Oh my, this is a soft coral.")
dialogStr("Oh, questo è un corallo morbido.")
...
dialogStr("Mi piacciono i colori...")
