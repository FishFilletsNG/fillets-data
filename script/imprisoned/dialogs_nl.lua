...
dialogStr("Zo veel koralen. Ben je doof ofzo?")


dialogId("ncp-m-tvrdy", "font_small", "Oh my, this is a hard coral.")
dialogStr("O, dit is een hard stuk koraal.")


dialogId("ncp-v-mekky", "font_big", "Oh my, this is a soft coral.")
dialogStr("O jeetje, dit is een zacht stuk koraal.")
...
dialogStr("Nu kun je eruit, of niet?")


dialogId("ncp-v-neprojedu", "font_big", "Hmm, I can’t get through here...")
dialogStr("Hmm, hier pas ik niet tussendoor...")
