...
dialogStr("Ik vraag me af waarom de koralen hier zulke rare vormen hebben.")


dialogId("kor-v-juchacka", "font_big", "That was some number, wasn`t it?")
dialogStr("Dat was geen slecht nummer, vond je niet?")
...
dialogStr("Ik krijg dit niet los van hieraf. Ik zou het van de linker kant moeten proberen.")


dialogId("kor-m-budesmuset", "font_small", "Well you`ll have to go that way through those anemones.")
dialogStr("Dan moet je wel langs de annemonen zien te komen.")


dialogId("kor-m-neniono", "font_small", "That`s not what I had in mind...")
dialogStr("Ik had iets anders in gedachten...")


dialogId("kor-m-tudiru", "font_small", "We should have plugged that hole beforehand.")
dialogStr("We hadden die kuil vantevoren op moeten vullen.")
