...
dialogStr("Они спят тысячи лет... вечный покой...")
...
dialogStr("Ух, а он отличный музыкант.")
...
dialogStr("Тебе не кажется, что уже хватит?")
...
dialogStr("Мы должны заткнуть эту дыру заранее.")
