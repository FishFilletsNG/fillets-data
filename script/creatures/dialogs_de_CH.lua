...
dialogStr("Ausser wenn wir diesen Kraken anschubsen.")


dialogId("kor-m-hraje", "font_small", "Yeah, he`s a great player.")
dialogStr("Mann, er ist ein grossartiger Spieler.")


dialogId("kor-m-tovis", "font_small", "Well, you know, it`s not all that much fun down here at the bottom of the ocean.")
dialogStr("Naja, weisst du, hier am Meeresgrund ist nicht alles so lustig.")
