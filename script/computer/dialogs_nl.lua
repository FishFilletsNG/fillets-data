...
dialogStr("Wat een ranzige troep!")
...
dialogStr("Moet je zien wat mensen allemaal door de plee spoelen.")
...
dialogStr("Er liggen hier vast allemaal rare dingen.")
...
dialogStr("Vast niet! Dit is geen krachtige multimediacomputer. Dis een ouwe XT bak met een 12 inch schermpje.")
...
dialogStr("Waar wachten we nog op? Zet de verdachte bestanden op de diskette en dan kunnen we hem smeren.")
