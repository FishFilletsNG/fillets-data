...
dialog_addDialog("poc-v-kam0", "cs", "sound/"..codename.."/cs/poc-v-kam0.ogg", "font_big", "Kam tak èlovìk - chci øíci ryba - mù¾e vlézt záchodem?")

dialog_addDialog("poc-v-kam1", "en", "", "font_big", "It looks like a cozy little dump.")
dialog_addDialog("poc-v-kam1", "cs", "sound/"..codename.."/cs/poc-v-kam1.ogg", "font_big", "Vypadá to na malé úhledné smeti¹tì.")
...
dialog_addDialog("poc-v-kam3", "cs", "sound/"..codename.."/cs/poc-v-kam3.ogg", "font_big", "Kdy¾ jsem sem lezl, tak jsem to èekal hor¹í.")

dialog_addDialog("poc-v-nenajde", "en", "", "font_big", "You can find many strange things in such a dump.")
dialog_addDialog("poc-v-nenajde", "cs", "sound/"..codename.."/cs/poc-v-nenajde.ogg", "font_big", "Co v¹echno se na takovém smeti¹ti nenajde.")

dialog_addDialog("poc-m-myslis", "en", "", "font_small", "Do you think this is the computer that`s in stake in this game?")
dialog_addDialog("poc-m-myslis", "cs", "sound/"..codename.."/cs/poc-m-myslis.ogg", "font_small", "Myslí¹, ¾e tohle je ten poèítaè, o který se tu hraje?")
...
dialog_addDialog("poc-v-multimed", "cs", "sound/"..codename.."/cs/poc-v-multimed.ogg", "font_big", "No dovol! Tohle pøece není výkoný multimediální poèítaè. To je XTéèko s dvanáctipalcovým monitorem.")
...
dialog_addDialog("poc-v-vyresil", "cs", "sound/"..codename.."/cs/poc-v-vyresil.ogg", "font_big", "Ten, kdo první vyøe¹í, chci øíci vyøe¹il, v¹echny zbývající levely, vyhraje, chci øíci vyhrál, poèítaè s technologií MMX, 3Dfx kartou, spoustou pamìti, olbøímím diskem...")
...
dialog_addDialog("poc-m-kcemu", "cs", "sound/"..codename.."/cs/poc-m-kcemu.ogg", "font_small", "No a k èemu to je? Já tøeba znám spoustu her, skroro stejnì dobrých, jako je tahle, a ty by klidnì bì¾ely i na tomhle XTéèku.")
...
dialog_addDialog("poc-v-napad", "cs", "sound/"..codename.."/cs/poc-v-napad.ogg", "font_big", "Hele, jen takový nápad: Co kdy¾ je to ten poèítaè, který máme hledat?")
...
dialog_addDialog("poc-v-stahni", "cs", "sound/"..codename.."/cs/poc-v-stahni.ogg", "font_big", "Tak na co èekáme? Stáhni na disketu ta podezøelá data a mù¾eme jít.")
...
dialog_addDialog("poc-m-ukryta", "cs", "sound/"..codename.."/cs/poc-m-ukryta.ogg", "font_small", "To nebude tak jednoduché. Data v nìm budou urèitì dobøe ukryta. Budu se muset dostat dovnitø.")

dialog_addDialog("poc-v-dira", "en", "", "font_big", "And what about getting in through that opening?")
dialog_addDialog("poc-v-dira", "cs", "sound/"..codename.."/cs/poc-v-dira.ogg", "font_big", "Co tam zkusit vlézt tøeba támhletou dírou?")
...
dialog_addDialog("poc-m-zezadu", "cs", "sound/"..codename.."/cs/poc-m-zezadu.ogg", "font_small", "Musím se k nìmu dostat zezadu.")

dialog_addDialog("poc-m-vyvrtka", "en", "", "font_small", "Put down that corkscrew and come to help me.")
dialog_addDialog("poc-m-vyvrtka", "cs", "sound/"..codename.."/cs/poc-m-vyvrtka.ogg", "font_small", "Polo¾ tu vývrtku a pojï mi pomoct.")

dialog_addDialog("poc-m-kram", "en", "", "font_small", "Oh my, what a sloppy machine. So big, so heavy and surely so slow.")
dialog_addDialog("poc-m-kram", "cs", "sound/"..codename.."/cs/poc-m-kram.ogg", "font_small", "To je ale odporný krám. Velký, tì¾ký a urèitì stra¹nì pomalý.")
