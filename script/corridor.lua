...
createRoom(34, 37, "images/corridor/chodba-p2.png")
...
addItemAnim(wall, "images/corridor/chodba-okoli.png")
...
addItemAnim(rightpes, "images/corridor/robright_00.png")
...
addItemAnim(leftpes, "images/corridor/robleft_00.png")
...
addItemAnim(vypinac, "images/corridor/vypinac_00.png")
...
addItemAnim(item_heavy, "images/corridor/chodba-4-tmp.png")
...
addItemAnim(item_heavy, "images/corridor/chodba-5-tmp.png")

item_heavy = addModel("item_heavy", 10, 1,
[[
X
]])
addItemAnim(item_heavy, "images/corridor/chodba-6-tmp.png")

item_heavy = addModel("item_heavy", 10, 4,
[[
X
]])
addItemAnim(item_heavy, "images/corridor/chodba-7-tmp.png")

item_heavy = addModel("item_heavy", 23, 1,
[[
X
]])
addItemAnim(item_heavy, "images/corridor/chodba-8-tmp.png")

item_heavy = addModel("item_heavy", 23, 4,
[[
X
]])
addItemAnim(item_heavy, "images/corridor/chodba-9-tmp.png")
...
addItemAnim(dvere1, "images/corridor/dvere-b_00.png")
...
addItemAnim(dvere2, "images/corridor/dvere-b_00.png")
-- extsize=3; first="dvere-b1.bmp"
...
addItemAnim(dvere3, "images/corridor/dvere-a_00.png")
...
addItemAnim(dvere4, "images/corridor/dvere-a_00.png")
-- extsize=3; first="dvere-a1.bmp"
...
addItemAnim(item_heavy, "images/corridor/chodba-14-tmp.png")
...
addItemAnim(item_heavy, "images/corridor/chodba-15-tmp.png")

poklop2 = addModel("item_light", 25, 22,
[[
XXXXX
]])
addItemAnim(poklop2, "images/corridor/poklop_00.png")
...
addItemAnim(poklop1, "images/corridor/poklop_00.png")
-- extsize=3; first="poklop1.BMP"
...
addItemAnim(item_heavy, "images/corridor/chodba-20-tmp.png")
...
addItemAnim(item_heavy, "images/corridor/chodba-21-tmp.png")
...
addItemAnim(item_heavy, "images/corridor/chodba-22-tmp.png")
...
addItemAnim(item_heavy, "images/corridor/chodba-23-tmp.png")
...
addItemAnim(item_heavy, "images/corridor/chodba-24-tmp.png")

item_heavy = addModel("item_heavy", 19, 25,
[[
X
]])
addItemAnim(item_heavy, "images/corridor/chodba-25-tmp.png")

item_heavy = addModel("item_heavy", 14, 25,
[[
X
]])
addItemAnim(item_heavy, "images/corridor/chodba-26-tmp.png")

item_light = addModel("item_light", 12, 34,
[[
X
]])
addItemAnim(item_light, "images/corridor/matka_a.png")
