...
dialogStr("Ihre Augen bewegen sich alle gleich. Als wenn sie durch ein gemeinsames Überbewusstsein kontrolliert werden.")
...
dialogStr("Sie werden durch ein Programm gesteuert. Genauso wie die Wellen im Wasser und dein blödes Gequatsche.")


dialogId("sec-v-socha", "font_big", "Did we ever see a sculpture that would be silent for so long?")
dialogStr("Haben wir je eine Skulptur gesehen, die so lange ruhig war?")


dialogId("sec-m-situace", "font_small", "I think it`s only waiting for the best opportunity.")
dialogStr("Ich denke, sie wartet nur auf die beste Gelegenheit.")
