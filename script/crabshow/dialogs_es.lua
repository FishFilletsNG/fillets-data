...
dialogStr("Sus ojos se mueven en concordancia el uno del otro. Como si ellos fueran controlados por alguna superconciencia.")
...
dialogStr("Pero por supuesto, éstos están controlados por un programa de computación. Así como la ondulación del agua y tu estúpida conversación.")


dialogId("sec-v-socha", "font_big", "Did we ever see a sculpture that would be silent for so long?")
dialogStr("¿Alguna vez vimos una escultura que estuviera silenciosa por tanto tiempo?")


dialogId("sec-m-situace", "font_small", "I think it`s only waiting for the best opportunity.")
dialogStr("Yo pienso que solo está esperando la mejor oportunidad.")
