...
dialogStr("Ik zit hier opgesloten.")


dialogId("sec-v-ven1", "font_big", "I want to get out.")
dialogStr("Ik wil hier uit.")
...
dialogStr("Kijk, nu ben je eruit.")
...
dialogStr("Ik zit in een kamer zonder deuren!")
...
dialogStr("Welke bedoel je?")


dialogId("sec-m-dole0", "font_small", "The upper one, of course.")
dialogStr("De bovenste, natuurlijk.")
...
dialogStr("Deze stad ziet er verdacht goed bewaard uit...")
...
dialogStr("Jij en je gevoel ook altijd... bedenk liever een manier om hier uit te komen.")


dialogId("sec-v-pockej", "font_big", "No, wait, watch all these crabs for a moment... look into their eyes...")
dialogStr("Nee, wacht, let eens goed op deze krabben... kijk naar hun ogen...")
...
dialogStr("Hun ogen bewegen steeds op dezelfde manier. Het lijkt wel alsof ze door een groter gemeenschappelijk bewustzijn worden bestuurd.")
