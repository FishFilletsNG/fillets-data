...
dialogStr("Deras ögon rör sig i takt. Precis som om de kontrollerades av ett gemensamt övermedvetande.")
...
dialogStr("Men självklar, de kontrolleras av ett datorprogram. Precis som vattenrörelserna och dina fåniga repliker.")


dialogId("sec-v-socha", "font_big", "Did we ever see a sculpture that would be silent for so long?")
dialogStr("Har vi någonstans sett en skulptur som varit tyst så länge?")


dialogId("sec-m-situace", "font_small", "I think it`s only waiting for the best opportunity.")
dialogStr("Jag tror att den bara väntar på bättre tider.")
