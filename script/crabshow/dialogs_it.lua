...
dialogStr("Quale dici?")

dialogId("sec-m-dole0", "font_small", "The upper one, of course.")
dialogStr("Quello in alto, ovviamente.")
...
dialogStr("I loro occhi si muovono in accordo tra di loro. Come se fossero controllati da qualche coscienza superiore.")
...
dialogStr("E invece sono controllati da un programma per compute. Proprio come l'acqua che ondeggia e le stupidaggini che dici.")
