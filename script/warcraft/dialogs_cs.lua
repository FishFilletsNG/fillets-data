...
dialogStr("Když na tomhle počítači běží Word nebo jiná zbytečnost, my, postavičky z počítačových her, se scházíme v adresáři C:\\WINDOWS\\CONFIG a povídáme si.")
...
dialogStr("Když nemáme do čeho píchnout, hrajeme si na schovávanou v registrační databázi. Proto ti občas přestanou fungovat Windows, když dlouho nehraješ žádnou hru.")
...
dialogStr("To jsi neměla prozrazovat. Já jsem chtěl jenom říct, že to tam vypadá skoro stejně jako tady. Spousta postaviček z her.")


dialogId("war-m-aznato", "font_small", "But it`s not so difficult to get out of there.")
dialogStr("Až na to, že odtamtud není tak těžké se dostat.")
...
dialogStr("Tvůrci této hry by rádi vyjádřili svůj obdiv firmě Blizzard Entertainment a popřáli jí mnoho dalších úspěchů.")


dialogId("war-m-hodiny", "font_small", "And they would also like to thank them for so many hours of neatly killed time.")
dialogStr("A také jí poděkovali za nespočet hodin příjemně zabitého času.")
