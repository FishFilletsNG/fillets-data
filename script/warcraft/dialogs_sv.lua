...
dialogStr("Jag är fängslad under borgen.")
...
dialogStr("Jag tror att det är högst osannolikt.")


dialogId("war-m-kam", "font_small", "Where did we get us, again?")
dialogStr("Var var det vi hamnade, nu igen?")


dialogId("war-v-povedome", "font_big", "I find it oddly familiar here.")
dialogStr("Det känns märkligt familiärt här.")
...
dialogStr("Skaparna av det här spelet vill framföra sin beundran för Blizzard Entertainment och önskar dem många framgångsrika spel.")


dialogId("war-m-hodiny", "font_small", "And they would also like to thank them for so many hours of neatly killed time.")
dialogStr("Och de vill också tacka dem för så många timmar av trevligt ihjälslagen tid.")
