...
dialogStr("Quando Word ho un'altra applicazione noiosa è in esecuzione su questa macchina, noi, con i personaggi degli altri giochi, andiamo insieme nella cartella C:\\WINDOWS\\CONFIG a conversare.")
...
dialogStr("Quando non sappiamo cosa fare, giochiamo a nascondino nel registro di configurazione. Ecco perché ogni tanto il tuo Windows si impalla se non giochi per troppo tempo.")
...
dialogStr("Non dovevi dirlo. Io volevo solo dire che è molto simile a questo livello. Con così tanti personaggi.")

dialogId("war-m-aznato", "font_small", "But it`s not so difficult to get out of there.")
dialogStr("Ma non è tanto difficile uscire di là.")
...
dialogStr("I creatori di questo gioco vorrebbero esprimere la loro ammirazione per la Blizzard Entertainment e augurar loro molti altri giochi di successo.")

dialogId("war-m-hodiny", "font_small", "And they would also like to thank them for so many hours of neatly killed time.")
dialogStr("E vorrebbero anche ringraziare per tante ore di tempo passate piacevolmente.")
