...
dialogStr("Estoy prisionero en el castillo.")
...
dialogStr("Lo considero altamente improbable.")


dialogId("war-m-kam", "font_small", "Where did we get us, again?")
dialogStr("¿Hasta donde llegamos, de nuevo?")


dialogId("war-v-povedome", "font_big", "I find it oddly familiar here.")
dialogStr("Encuentro a este lugar extrañamente familiar.")
...
dialogStr("A los autores de este juego les gustaría expresar su admiración por la compañía Blizzard Entertainment y les desean muchos juegos exitosos.")


dialogId("war-m-hodiny", "font_small", "And they would also like to thank them for so many hours of neatly killed time.")
dialogStr("Y ellos también quisieran agradecerles por tantas horas matando el tiempo netamente.")
