...
dialogStr("Das sind keine Bauern sondern Tagelöhner.")
...
dialogStr("Das halte ich für sehr unwahrscheinlich.")
...
dialogStr("Wenn wir nicht wissen, was wir machen sollen, spielen wir Verstecken in der Registry. Darum stürzt Windows immer ab, wenn man nicht ab und zu ein Spiel spielt.")
...
dialogStr("Die Ersteller dieses Spiels möchten ihre Bewunderung für Blizzard Entertainment ausdrücken und wünschen ihnen viele erfolgreiche Spiele.")


dialogId("war-m-hodiny", "font_small", "And they would also like to thank them for so many hours of neatly killed time.")
dialogStr("Und sie möchten sich auch für die vielen Stunden wunderbar totgeschlagener Zeit bedanken.")
