...
dialogStr("Certamente. Se ne lasciami qui uno, chissà che idea pazza potrebbe venirgli. Potrebbe mettersi a giocare a golf, per esempio.")
...
dialogStr("Difficilmente, con questa mazza. Dovremmo ritenerci soddisfatti se ne prendiamo anche solo uno. Allora l'altro sarà innocuo.")

dialogId("lod-v-koho", "font_big", "Well. Which one?")
dialogStr("Bene. Quale?")

dialogId("lod-m-zluty", "font_small", "The yellow one.")
dialogStr("Quello giallo.")

dialogId("lod-m-modry", "font_small", "The blue one.")
dialogStr("Quello blu.")
...
dialogStr("Tra l'altro, hai notato che la vera pallina da golf si trova nell'angolo in alto a sinistra, mentre quella nell'angolo inferiore destro è una pallina da cricket?")

dialogId("lod-m-vyznam", "font_small", "Is there some hidden symbolism?")
dialogStr("Ci sarà qualche sorta di simbolismo in ciò?")
...
dialogStr("Questa volta il nostro obiettivo è portare fuori una di queste divinità.")
...
dialogStr("Vyhrál jsem, saláte!!!")

dialogId("b1-zacinam", "font_yellow", "I start!")
dialogStr("Comincio io!")
...
dialogStr("È stato uno sbaglio, forse...")
...
dialogStr("Ah ah ah ah... ho vinto!")
