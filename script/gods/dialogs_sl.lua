...
dialogStr("Seveda. Če pustiva enega od njiju tukaj, se mu lahko porodi kakšna nora ideja. Na primer, lahko bi začel igrati golf.")
...
dialogStr("Težko s to palico. Mislim da bi morala biti srečna, če nama uspe dobiti enega. Drug bo potem neškodljiv.")

dialogId("lod-v-koho", "font_big", "Well. Which one?")
dialogStr("No. Katerega?")
...
dialogStr("Mimogrede, ali si opazila da je prava žogica za golf v zgornjem levem kotu, medtem ko je ta stvar v spodnjem desnem kotu žogica za kriket?")

dialogId("lod-m-vyznam", "font_small", "Is there some hidden symbolism?")
dialogStr("Je to skrita simbolika?")
...
dialogStr("Tokrat je naš cilj pobrati enega od tistih bogov.")
...
dialogStr("Zmagal sem, ti mevža!!!")

dialogId("b1-zacinam", "font_yellow", "I start!")
dialogStr("Jaz začnem!")
...
dialogStr("Verjetno je bila napaka...")
...
dialogStr("Bova spet poskusila?")

dialogId("b2-rikal1", "font_cyan", "You already tried this!")
dialogStr("To si že poskusil!")
