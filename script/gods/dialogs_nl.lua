...
dialogStr("Ik heb het idee dat we zodadelijk iets vreselijks gaan ontdekken.")


dialogId("lod-v-silenost1", "font_big", "I always knew that: the gods must be mad.")
dialogStr("Ik heb het altijd al geweten: de goden zijn gek.")
...
dialogStr("Hoe zullen we dat dan aanpakken?")
...
dialogStr("Natuurlijk. Als we er hier ook maar eentje achterlaten kan hij allemaal rare dingen gaan doen. Hij zou golf kunnen gaan spelen, bij voorbeeld.")
...
dialogStr("Niet met deze club. Ik denk dat we blij moeten zijn als we er eentje kunnen afvoeren. De andere wordt dan vast veel minder gevaarlijk.")


dialogId("lod-v-koho", "font_big", "Well. Which one?")
dialogStr("Zo. Welke dan?")
...
dialogStr("Is het je trouwens opgevallen dat de echte golfbal linksboven ligt en dat dat ding rechtsonder een cricketbal is?")


dialogId("lod-m-vyznam", "font_small", "Is there some hidden symbolism?")
dialogStr("Is dat verborgen symboliek?")


dialogId("lod-v-kdovi", "font_big", "Who knows.")
dialogStr("Weet ik veel.")
...
dialogStr("Deze keer is het ons doel om een van die goden hier weg te krijgen.")
...
dialogStr("Ik heb gewonnen, sukkel.")
...
dialogStr("Het was vast een foutje...")
...
dialogStr("Ha, ha, ha... ik heb gewonnen!")
...
dialogStr("Zullen we het nog een keertje proberen?")


dialogId("b2-rikal1", "font_cyan", "You already tried this!")
dialogStr("Je hebt dit al een keertje geprobeerd!")
