...
dialogStr("Разбира се. Ако оставим единия от тях тук, може да му хрумнат всякакви луди идеи. Може да започне да играе голф, например.")
...
dialogStr("С този стик — едва ли. Мисля, че дори да вземем само единия, пак ще е от полза. Другият ще е съвсем безобиден сам.")

dialogId("lod-v-koho", "font_big", "Well. Which one?")
dialogStr("Добре. Кой да бъде?")
...
dialogStr("Между другото, забеляза ли, че истинската топка за голф е в горния ляв ъгъл, докато онова в долния десен ъгъл е топка за крикет?")

dialogId("lod-m-vyznam", "font_small", "Is there some hidden symbolism?")
dialogStr("Дали има скрит символизъм?")
...
dialogStr("Този път целта ни е да се отървем от някой от боговете.")
...
dialogStr("Това май беше грешка...")
