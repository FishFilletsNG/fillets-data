...
dialogStr("Delo ujetnika, ki ti ga pošiljamo, je biti morski bog. Poleg izginjanja letal in ladij (t.i. primer Morska Bitka) je odgovoren tudi za ostale zločine, premikanje celin (kodno ime Teci, celina, teci) in meteorit v Tunguski (kodno ime Cepetavček) sta med njimi.")
...
dialogStr("Uspelo nam je posredovati, ravno še pravi trenutek: našli smo odprto čisto novo škatlo z namizno igro VOJNA ZVEZD v ujetnikovi hiši.")

dialogId("dlg-x-poster3", "font_poster", "You can find the records of his sea battles in the attachement.")
dialogStr("V prilogi lahko najdeš zapise njegovih morskih bitk.")
