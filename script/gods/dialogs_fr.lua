...
dialogStr("Bien sûr. Si nous en laissons un ici, il pourrait avoir n'importe qu'elle idée folle. Il pourrait commencer à jouer au golf par exemple.")
...
dialogStr("Difficilement avec ce club. Je pense que nous serons contents d'en attraper un. L'autre deviendra alors inoffensif.")


dialogId("lod-v-koho", "font_big", "Well. Which one?")
dialogStr("Bien. Et lequel ?")
...
dialogStr("A propos, tu as noté que la véritable balle de golf est dans le coin supérieur gauche, tandis que dans le coin inférieur droit se trouve une balle de cricket ?")


dialogId("lod-m-vyznam", "font_small", "Is there some hidden symbolism?")
dialogStr("Y aurait-il un symbolisme caché ?")
...
dialogStr("Je pense que c'est une balle de ping-pong là haut.")


dialogId("lod-v-rozliseni", "font_big", "It`s hard to say with this screen resolution.")
dialogStr("Difficile à dire avec un écran à cette résolution.")


dialogId("lod-m-bohove", "font_small", "This time our goal is to get out one of those gods.")
dialogStr("Cette fois, notre but est de faire sortir un de ces dieux.")
...
dialogStr("J'ai gagné !!!")


dialogId("b1-zacinam", "font_yellow", "I start!")
dialogStr("Je commence !")
...
dialogStr("Faisons-nous une autre partie ?")


dialogId("b1-nepodvadim", "font_yellow", "I don`t cheat.")
dialogStr("Je ne triche pas.")
