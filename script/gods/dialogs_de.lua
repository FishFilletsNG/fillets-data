...
dialogStr("Ich habe die Vermutung, dass wir gerade etwas Schreckliches entdecken.")
...
dialogStr("Natürlich. Wenn wir einen hierlassen, fällt ihm vielleicht eine verrückte Idee ein. Er könnte zum Beispiel anfangen, Golf zu spielen.")
...
dialogStr("Hast du übrigens bemerkt, dass der echte Golfball in der Ecke oben links und das Ding in der Ecke unten rechts der Kricktball ist?")


dialogId("lod-m-vyznam", "font_small", "Is there some hidden symbolism?")
dialogStr("Ist das ein verstecktes Zeichen?")
...
dialogStr("Diesmal ist unser Ziel, einen der Götter herauszubekommen.")
...
dialogStr("Ich habe gewonnen, du Muttersöhnchen")


dialogId("b1-zacinam", "font_yellow", "I start!")
dialogStr("Ich fange an!")
...
dialogStr("Es war wahrscheinlich ein Fehler...")
...
dialogStr("Ha, ha, ha... ich habe gewonnen!")
...
dialogStr("Wollen wir noch eins versuchen?")


dialogId("b2-rikal1", "font_cyan", "You already tried this!")
dialogStr("Das hast du schon versucht!")
