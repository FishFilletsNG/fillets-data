...
dialogStr("Samozřejmě. Kdyby tu jeden zůstal, kdo ví, co by ho napadlo. Třeba by chtěl začít hrát golf.")
...
dialogStr("S touhle holí těžko. Myslím, že budeme rádi, když dostaneme jednoho. Ten druhý už nebude nebezpečný.")


dialogId("lod-v-koho", "font_big", "Well. Which one?")
dialogStr("Tak dobře. A koho?")


dialogId("lod-m-zluty", "font_small", "The yellow one.")
dialogStr("Toho žlutého.")


dialogId("lod-m-modry", "font_small", "The blue one.")
dialogStr("Toho modrého.")
...
dialogStr("Podívej se na tu hůl: té se stalo něco strašného.")


dialogId("lod-m-ozizlana", "font_small", "A pld probably sucked upon it.")
dialogStr("Asi ji ožižlával pld.")
...
dialogStr("Všimla sis mimochodem, že skutečný golfový míček je vlevo nahoře, zatímco vpravo dole je míček na kriket?")


dialogId("lod-m-vyznam", "font_small", "Is there some hidden symbolism?")
dialogStr("Myslíš, že to má nějaký skrytý význam?")
...
dialogStr("Naším úkolem je tentokrát dostat ven z místnosti kteréhokoliv z těch bohů.")
...
dialogStr("Cha cha cha cha chá... vyhrál jsem!")
...
dialogStr("Zkusíme to ještě jednou?")


dialogId("b2-rikal1", "font_cyan", "You already tried this!")
dialogStr("To jsi už zkoušel!")
