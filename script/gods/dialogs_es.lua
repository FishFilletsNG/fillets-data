...
dialogStr("¿Qué tenemos que hacer?")


dialogId("lod-v-cvok", "font_big", "Put them into the mad... I mean into the detainment facility of FDTO.")
dialogStr("Meterlos en el manico... Quiero decir en las instalaciones de detención de la FDTO.")


dialogId("lod-m-oba", "font_small", "You are right. Shall we take both of them?")
dialogStr("Tienes razón. ¿Nos llevamos a los dos?")
...
dialogStr("Por supuesto. Si dejamos a uno de ellos aquí, cualquier idea loca se le podría ocurrir. El podría tratar de jugar golf, por ejemplo.")
...
dialogStr("Difícil con este club. Creo que seríamos felices si consiguiéramos uno. El otro será inofensivo entonces.")
...
dialogStr("Por cierto, ¿Notaste que la verdadera bola de golf está en la esquina superior izquierda mientras que esa cosa en la esquina inferior derecha es una bola de cricket?")


dialogId("lod-m-vyznam", "font_small", "Is there some hidden symbolism?")
dialogStr("¿Hay algún simbolismo escondido?")
...
dialogStr("En esta ocasión nuestra meta es sacar a uno de esos dioses.")
...
dialogStr("Fué un error, probablemente...")
...
dialogStr("¿Lo intentamos de nuevo?")


dialogId("b2-rikal1", "font_cyan", "You already tried this!")
dialogStr("¡Ya lo has intentado!")
