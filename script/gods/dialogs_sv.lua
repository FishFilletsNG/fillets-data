...
dialogStr("Självklart. Om vi lämnar någon av dem skulle han kunna få vilken galen idé som helst. Han skulle kunna börja spela golf till exempel.")
...
dialogStr("Knappast med den klubban. Jag tror vi borde vara glada över att få tag på en av dem. Den andre kommer att vara harmlös sen.")


dialogId("lod-v-koho", "font_big", "Well. Which one?")
dialogStr("OK. Vilken av dem?")
...
dialogStr("För resten, har du märkt att den riktiga golfbollen är i det övre vänstra hörnet medans det nere till höger är en kricketboll?")


dialogId("lod-m-vyznam", "font_small", "Is there some hidden symbolism?")
dialogStr("Finns det någon dold symbolik där?")
...
dialogStr("Den här gången är vårt mål att få ut en av gudarna.")
...
dialogStr("Jag vann din mes")


dialogId("b1-zacinam", "font_yellow", "I start!")
dialogStr("Jag börjar!")
...
dialogStr("Det var ett misstag, antagligen...")
...
dialogStr("Du har redan försökt där!")
