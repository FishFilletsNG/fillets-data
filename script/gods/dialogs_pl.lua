...
dialogStr("Zamknąć w waria... znaczy w zakładzie poprawczym FDTO.")


dialogId("lod-m-oba", "font_small", "You are right. Shall we take both of them?")
dialogStr("Masz rację. Bierzemy ich obu?")
...
dialogStr("Oczywiście. Jeśli zostawimy tu jednego, różne rzeczy mogą mu przyjść do głowy. Mógłby, na ten przykład, zacząć grać w golfa.")
...
dialogStr("Ciężko by mu było tym kijkiem. Myślę, że zadowolimy się jednym. Ten drugi już nie będzie niebezpieczny.")


dialogId("lod-v-koho", "font_big", "Well. Which one?")
dialogStr("Dobra. To którego?")


dialogId("lod-m-zluty", "font_small", "The yellow one.")
dialogStr("Tego żółtego.")


dialogId("lod-m-modry", "font_small", "The blue one.")
dialogStr("Tego niebieskiego.")
...
dialogStr("Niech gracz zdecyduje.")
...
dialogStr("Tak na marginesie, zauważyłaś, że prawdziwa piłka golfowa jest na górze po lewej, a ta piłka po prawej na dole jest do krykieta?")


dialogId("lod-m-vyznam", "font_small", "Is there some hidden symbolism?")
dialogStr("Myślisz, że to ma jakieś ukryte znaczenie?")
...
dialogStr("Myślałam, że ta na górze po prawej to piłka do ping-ponga.")


dialogId("lod-v-rozliseni", "font_big", "It`s hard to say with this screen resolution.")
dialogStr("Trudno powiedzieć przy tej rozdzielczości.")


dialogId("lod-m-bohove", "font_small", "This time our goal is to get out one of those gods.")
dialogStr("Tym razem naszym zadaniem jest wydostanie stąd jednego z tych bogów.")
...
dialogStr("Wygrałem, cieniasie!!!")


dialogId("b1-zacinam", "font_yellow", "I start!")
dialogStr("Ja zaczynam!")
