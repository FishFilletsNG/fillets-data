...
dialogStr("Maar wat moeten wij ermee?")
...
dialogStr("Nou ja, misschien heb je wel gelijk.")
...
dialogStr("Als ze nou niet zo in de weg stonden.")


dialogId("bar-v-kdyby1", "font_big", "If only they were where we need them.")
dialogStr("Als ze nou daar waren waar we ze nodig hebben.")


dialogId("bar-v-sbirka", "font_big", "Such a lovely collection of monstrosities. I’ll be sorry to leave.")
dialogStr("Wat een mooie verzameling monsterlijkheden. Ik ga het straks nog jammer vinden om ze achter te laten.")
...
dialogStr("Ja. Het heeft het bijna vermoord met dat stalen ding daar.")


dialogId("bar-m-rybka", "font_small", "This fish looks familiar to me.")
dialogStr("Deze vis ziet er vagelijk bekend uit.")
...
dialogStr("Niemand is helemaal alleen als hij een klein geel badeendje heeft. Zelfs een vis niet.")
