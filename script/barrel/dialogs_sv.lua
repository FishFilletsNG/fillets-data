...
dialogStr("Vad ska vi göra med det här?")
...
dialogStr("Vi måste utrota dem alla. Någon så avskyvärd borde inte få andas vår luft... öh, vårt vatten.")


dialogId("bar-v-priciny", "font_big", "I think we have to eliminate the cause and not the results.")
dialogStr("Jag tror att vi måste ta bort orsaken och inte resultatet.")


dialogId("bar-m-no", "font_small", "Well, you may be right.")
dialogStr("Tja, du kanske har rätt.")
...
dialogStr("Du kommer att få gott om tid att lära känna dem.")
...
dialogStr("Men vi måste lämna all kreatur här. De får inte skada genpolen hos den friska populationen.")
