...
dialogStr("Les habitants des îles alentours devraient voir ça.")


dialogId("bar-v-co", "font_big", "What are we supposed to do with it?")
dialogStr("Qu'est-ce que nous allons faire ?")
...
dialogStr("Et bien, tu dois avoir raison.")


dialogId("bar-v-sud", "font_big", "And the cause is doubtless this giant barrel. We have to get it out somehow.")
dialogStr("Et la cause est sans aucun doute ce tonneau géant. Nous devons le faire sortir d'ici.")
...
dialogStr("Je commence à aimer ça.")
...
dialogStr("Vous savez, j'ai finalement réalisé que même les mutants ont une âme.")


dialogId("bar-v-ufouni", "font_big", "Maybe even UFOs can have a soul.")
dialogStr("Peut-être même les extra-terrestres peuvent avoir une âme.")
...
dialogStr("Ce pied n'est pas que repoussant, il ne doit pas avoir honte. Regarde.")


dialogId("bar-v-pld", "font_big", "Look at that pld. It looks the same and still it grows more and more repulsive.")
dialogStr("Jette un oeil à la chose. Il semble identique, et plus il grandit plus il est repoussant.")


dialogId("bar-m-pudy", "font_small", "But even it harbors some motherly instincts. Look how it cares about the little one.")
dialogStr("Mais même s'il fait preuve d'instincts maternelle, regarde comme il prend soin du petit.")
...
dialogStr("Pauvre crabe. Tant de pinces et pas de tête. Après tout... peut-être qu'il est meilleur que nous.")


dialogId("bar-m-kachna", "font_small", "No man is alone with a little yellow duck. Not even fish.")
dialogStr("Aucun homme se sent seul avec un petit canard jaune. Pas même les poissons.")


dialogId("bar-m-barel", "font_small", "This time, our goal is to push out the barrel with that filth.")
dialogStr("Cette fois, notre but est de faire sortir le tonneau.")
