...
dialog_addDialog("bar-v-kdyby0", "fr", "", "font_big", "Si seulement ils n'étaient pas tant sur notre chemin."à
...
dialog_addDialog("bar-v-genofond", "en", "", "font_big", "But we have to leave ere all those creatures hrere. They must not harm the genepool of the healthy population.")
