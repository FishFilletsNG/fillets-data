...
dialogStr("Поздрави за любимия шеф от боклучарника.")

dialogId("dlg-x-poster2", "font_poster", "Yours sincerely")
dialogStr("Искрено ваши")
...
dialogStr("ПП: Тук е супер. Светим си на воля и плуваме много. Имаме много нови приятели.")
