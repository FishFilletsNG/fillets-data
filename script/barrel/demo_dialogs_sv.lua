...
dialogStr("Hälsningar från skräphögen till vår älskade chef.")


dialogId("dlg-x-poster2", "font_poster", "Yours sincerely")
dialogStr("Med vänliga hälsningar")
...
dialogStr("PS: Det är toppen att vara här. Vi solar och badar i havet. Vi har mött många nya vänner.")
