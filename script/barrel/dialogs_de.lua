...
dialogStr("Das sollte mal jemand von den Castor-Leuten sehen.")


dialogId("bar-v-co", "font_big", "What are we supposed to do with it?")
dialogStr("Was sollen wir damit tun?")
...
dialogStr("Aber wir müssen alle diese Kreaturen hier lassen. Sie dürfen nicht den Genpool der gesunden Population schädigen.")
