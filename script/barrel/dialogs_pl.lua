...
dialogStr("Powinien to zobaczyć ktoś z Greenpeace.")


dialogId("bar-m-videt1", "font_small", "Somebody from Three Miles Island should see this.")
dialogStr("Powinien to zobaczyć ktoś z Klubu Gaja.")
...
dialogStr("Musimy je wszystkie wybić. Takie potwory nie mają prawa stąpać po tej samej ziemi... yyy... pływać w tej samej wodzie, co my.")


dialogId("bar-v-priciny", "font_big", "I think we have to eliminate the cause and not the results.")
dialogStr("A ja uważam, że powinniśmy zlikwidować przyczynę, a nie skutki.")


dialogId("bar-m-no", "font_small", "Well, you may be right.")
dialogStr("Może i masz rację.")
...
dialogStr("Obawiam się, że będziesz je jeszcze długo oglądać.")
...
dialogStr("Ale te kreatury musimy tu zostawić, aby nie skaziły genów zdrowej części populacji.")
