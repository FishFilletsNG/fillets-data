...
dialogStr("Musíme je všechny pobít. Takové stvůry nemají právo dýchat stejný vzduch.... é, vodu, jako my.")


dialogId("bar-v-priciny", "font_big", "I think we have to eliminate the cause and not the results.")
dialogStr("Já si myslím, že musíme odstraňovat příčiny a ne následky.")


dialogId("bar-m-no", "font_small", "Well, you may be right.")
dialogStr("No, možná máš pravdu.")
...
dialogStr("Bojím se, že ti to ještě dlouho líto být nemusí.")
...
dialogStr("A všechny tvory tu musíme nechat! Ať nezkazí genofond zdravé populace.")
