...
dialogStr("Pozdrowienia z góry śmieci dla naszego kochanego szefa.")


dialogId("dlg-x-poster2", "font_poster", "Yours sincerely")
dialogStr("Z poważaniem")
...
dialogStr("PS. Świetnie się bawimy. Kąpiemy się w promieniach i sporo pływamy. Mamy mnóstwo nowych przyjaciół.")
