...
dialogStr("Saludos desde la pila de desperdicios a nuestro amado jefe.")


dialogId("dlg-x-poster2", "font_poster", "Yours sincerely")
dialogStr("Sinceramente suyos")
...
dialogStr("PD: Es grandioso estar aquí. Nos asoleamos y nadamos mucho en el mar. Tenemos muchos amigos nuevos.")
