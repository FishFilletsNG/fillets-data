...
dialogStr("Non ci sono mica pappagalli qui!")


dialogId("smrt-m-obe", "font_small", "Shut up, you are dead.")
dialogStr("Taci, sei morta.")
...
dialogStr("Ricomincia il livello! La vita nell'aldilà è troppo noiosa.")


dialogId("smrt-m-zahrobi", "font_small", "Restart the level! This afterlife is too scary.")
dialogStr("Ricomincia il livello! L'aldilà mi spaventa.")
...
dialogStr("Non ho intenzione di continuare da solo. Non preuccoparti di ricominciare, lo farò da solo.")
