...
dialogStr("Шт, играта може да я играят деца!")

dialogId("smrt-v-1", "font_big", "Darn.")
dialogStr("По дяволите!")
...
dialogStr("За късмет можем да рестартираме нивото.")

dialogId("smrt-v-zahrobi", "font_big", "Restart the level! The afterlife is too tedious.")
dialogStr("Рестартирай нивото! Задгробният живот е твърде скучен.")

dialogId("smrt-m-zahrobi", "font_small", "Restart the level! This afterlife is too scary.")
dialogStr("Рестартирай нивото! Задгробният живот е твърде страшен.")
