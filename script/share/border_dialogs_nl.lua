...
dialogStr("Ik denk dat we hier iets te doen hebben.")
...
dialogStr("We hebben onze opdracht nog niet uitgevoerd.")
...
dialogStr("De Dienst heeft ons nodig. We moeten het halen.")
...
dialogStr("Zo dicht bij ons doel geven we het natuurlijk niet op.")
