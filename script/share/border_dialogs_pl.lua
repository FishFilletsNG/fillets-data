...
dialogStr("Mamy tu jeszcze coś do zrobienia.")
...
dialogStr("Nie wypełniliśmy jeszcze swojej misji.")
...
dialogStr("Agencja na nas polega, nie możemy jej zawieść.")
...
dialogStr("Przecież nie zawrócimy przed samym końcem...")
