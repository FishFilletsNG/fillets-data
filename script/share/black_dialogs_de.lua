...
dialogStr("Psst, hier könnten Kinder sein!")
...
dialogStr("Und jetzt bin ich allein.")
...
dialogStr("Aber hier ist kein Papagei!")


dialogId("smrt-m-obe", "font_small", "Shut up, you are dead.")
dialogStr("Ruhe! Du bist tot.")
...
dialogStr("Glücklicherweise können wir die Ebene neustarten.")


dialogId("smrt-v-zahrobi", "font_big", "Restart the level! The afterlife is too tedious.")
dialogStr("Starte die Ebene neu! Das Jenseits ist zu langweilig.")


dialogId("smrt-m-zahrobi", "font_small", "Restart the level! This afterlife is too scary.")
dialogStr("Starte die Ebene neu! Dieses Jenseits ist zu gruselig.")
