...
dialogStr("Myslím, že tu ještě máme práci.")
...
dialogStr("Ještě jsme nesplnili svoje poslání.")
...
dialogStr("Agentura se na nás spoléhá, nemůžeme ji zklamat.")
...
dialogStr("Přece neutečem těsně před koncem.")
