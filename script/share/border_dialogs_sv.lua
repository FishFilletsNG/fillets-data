...
dialogStr("Byrån litar på oss. Vi får inte misslyckas.")
...
dialogStr("Självklart kommer vi inte att fly när slutet är så nära.")


dialogId("cil-m-hlaska3", "font_small", "Certainly, we are not going to run away with the end in sight.")
dialogStr("Själklart kommer vi inte att fly när slutet är så nära.")
