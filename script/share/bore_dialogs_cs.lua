...
dialogStr("V tom bude něco neobvyklého...")
...
dialogStr("Ale ne, byl to jen takový nápad...")


dialogId("ob-v-vyzkousej", "font_big", "What if we try that...")
dialogStr("Co kdybychom vyzkoušeli támhle...")
...
dialogStr("Ale nic, to byl jen takový nápad.")
...
dialogStr("Zachovej chladnou hlavu.")
...
dialogStr("Malá přestávka nezaškodí.")


dialogId("ob-o-nebavi", "font_both", "We are tired of waiting!")
dialogStr("Už nás to čekání nebaví!")
...
dialogStr("My jsme hra, nás máš řešit.")


dialogId("ob-v-akvarium", "font_big", "Buy yourself a fish tank for observations.")
dialogStr("Na koukání si pořiď akvárium.")
