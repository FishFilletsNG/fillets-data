...
dialogStr("Tira su la testa, ci deve essere un modo.")


dialogId("ob-v-klid", "font_big", "Take it easy.")
dialogStr("Calma e gesso.")
...
dialogStr("Non saprei: lo schermo riflette troppo dal di dentro.")
...
dialogStr("Quando smetti di giocare, non spegnere il computer per favore. Se lo fai sarà tutto così buio e spaventoso.")
...
dialogStr("Tutto completamente! E lasciami sola, ti prego!")
