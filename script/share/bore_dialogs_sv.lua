...
dialogStr("Äsch, det vara bara en idé...")


dialogId("ob-v-vyzkousej", "font_big", "What if we try that...")
dialogStr("Om vi försöker det där...")
...
dialogStr("Hör du spelaren, kan du inte hämta lite att äta? Ställ det i TEMP biblioteket, vi äter det direkt.")
