...
dialogId("cil-v-hlaska0", "font_big", "I think we have a job to do here.")
dialogStr("Abbiamo un lavoro da svolgere qui.")
...
dialogStr("Non abbiamo ancora completato la nostra missione.")
...
dialogStr("L'Agenzia fa affidamento su di noi. Non dobbiamo fallire.")
...
dialogStr("Di sicuro non ce ne andremo così prossimi alla soluzione.")


dialogId("cil-m-hlaska3", "font_small", "Certainly, we are not going to run away with the end in sight.")
dialogStr("Di sicuro non ce ne andremo, così vicini alla soluzione.")
