...
dialogStr("Creo que tenemos trabajo que hacer aquí.")
...
dialogStr("No hemos completado nuestra misión todavía.")
...
dialogStr("La agencia confía en nosotros. No debemos fallar.")
...
dialogStr("Ciertamente, no vamos a arrancar con el final a la vista.")
