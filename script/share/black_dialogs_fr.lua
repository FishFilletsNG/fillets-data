...
dialogStr("Chut, des enfants peuvent jouer à ce jeu !")
...
dialogStr("Hmmm... Et maintenant je suis seul.")
...
dialogStr("Terrible fin d'un petit poisson...")
...
dialogStr("Et maintenant je suis seule.")
...
dialogStr("Heureusement, nous pouvons redémarrer le niveau.")


dialogId("smrt-v-zahrobi", "font_big", "Restart the level! The afterlife is too tedious.")
dialogStr("Relance le niveau ! L'après-vie est très ennuyeux.")
