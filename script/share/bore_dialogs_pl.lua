...
dialogStr("Nie wierzę, że nam się uda...")


dialogId("ob-m-nedosataneme", "font_small", "We aren`t going to get out of here.")
dialogStr("Nigdy się stąd nie wydostaniemy.")
...
dialogStr("Oszczędź mi swoich teorii.")
...
dialogStr("Już mnie to nie bawi.")
...
dialogStr("Dlaczego nic się nie dzieje?")
...
dialogStr("Może tam w ogóle nie ma gracza?")
...
dialogStr("Krótka przerwa nie zaszkodzi.")


dialogId("ob-o-nebavi", "font_both", "We are tired of waiting!")
dialogStr("Już nam się nie chce czekać!")
...
dialogStr("Jak chcesz poobserwować rybki, to kup sobie akwarium.")
...
dialogStr("Co, już? Ale w mojej gumie jest jeszcze sporo smaku.")


dialogId("ob-v-ostani", "font_big", "What do you think, how are the others faring?")
dialogStr("Jak, twoim zdaniem, radzą sobie inni?")
...
dialogStr("No, inni gracze. Może już rozwiązali więcej poziomów?")
