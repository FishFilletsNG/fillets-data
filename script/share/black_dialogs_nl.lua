...
dialogStr("Ssst, er zouden kinderen dit spel kunnen spelen!")


dialogId("smrt-v-1", "font_big", "Darn.")
dialogStr("Verdikkeme.")
...
dialogStr("Zou ze geweten hebben dat ze zo'n sexy skelet had?")


dialogId("smrt-v-6", "font_big", "Terrible end of the little fish...")
dialogStr("Wat een vreselijke dood voor dat kleine visje...")


dialogId("smrt-v-7", "font_big", "What can be the constant of decay of the fish skeleton?")
dialogStr("Wat is de halfwaardetijd van visgebeente?")


dialogId("smrt-m-0", "font_small", "So much for him.")
dialogStr("Dat was het dan voor hem.")
...
dialogStr("Nu ben ik helemaal alleen.")
...
dialogStr("Maar er is hier helemaal geen papegaai!")


dialogId("smrt-m-obe", "font_small", "Shut up, you are dead.")
dialogStr("Stil, je bent dood.")
...
dialogStr("Begin maar opnieuw! Het hiernamaals is veel te saai.")


dialogId("smrt-m-zahrobi", "font_small", "Restart the level! This afterlife is too scary.")
dialogStr("Begin alsjeblieft opnieuw! Dit hiernamaals is veel te eng.")
