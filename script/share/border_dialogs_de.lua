...
dialogStr("Ich denke, wir müssen hier einen Auftrag erledigen.")
...
dialogStr("Wir haben unseren Auftrag noch nicht erfüllt.")
...
dialogStr("Die Agentur verlässt sich auf uns. Wir dürfen nicht versagen.")
...
dialogStr("So kurz vorm Ziel werden wir sicher nicht aufgeben.")
