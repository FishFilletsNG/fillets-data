...
dialogStr("Ze skarbca do magazynu świeczników. To się nazywa postęp.")
...
dialogStr("To twoje tłuste cielsko zawsze nas ogranicza...")


dialogId("kni-v-padavko", "font_big", "Just leave me alone, you emaciated pollywog.")
dialogStr("Daj mi spokój, ty wynędzniała kijanko!")
...
dialogStr("Czuję się jak w magazynie ceramiki.")


dialogId("kni-v-amforstvi", "font_big", "You mean, amphory warehouse.")
dialogStr("Masz na myśli magazyn amforów.")
...
dialogStr("Wiesz, ta misja naprawdę mi pomogła.")
