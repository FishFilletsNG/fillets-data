...
dialogStr("Laat me met rust, jij uitgemergelde guppie.")
...
dialogStr("Ik heb het gevoel alsof ik in een serviesopslag ben.")
...
dialogStr("Het heet waarschijnlijk amforenopslag.")


dialogId("kni-m-mise", "font_small", "You know what? I think that this mission really helped me.")
dialogStr("Weet je wat? Ik denk dat deze missie heel goed voor me is geweest.")
