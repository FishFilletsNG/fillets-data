...
dialogStr("Jag växte och förstog att juveler och guld bara är billigt krafs.")


dialogId("kni-m-kramy", "font_small", "I can`t bear the darned stuff any longer!")
dialogStr("Jag orkar inte längre!")
