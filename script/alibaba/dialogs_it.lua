...
dialogStr("Dal tesoro al deposito candele. Questo è quello che si chiama un progresso.")
...
dialogStr("Il tuo grasso corpo. Sempre di intralcio.")

dialogId("kni-v-padavko", "font_big", "Just leave me alone, you emaciated pollywog.")
dialogStr("Lasciami stare, girino rinsecchito.")
