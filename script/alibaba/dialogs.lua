...
dialog_addDialog("kni-v-prolezt", "cs", "sound/"..codename.."/cs/kni-v-prolezt.ogg", "font_big", "Zdá se, že budu muset prolézt tím strašným bludištěm.")
dialog_addDialog("kni-v-prolezt", "fr", "", "font_big", "Apparemment je vais devoir traverser cet horrible dédale.")
dialog_addDialog("kni-v-prolezt", "de", "", "font_big", "Schein so, als ob ich durch dieses schreckliche Labyrinth muss.")

dialog_addDialog("kni-m-tloustka", "en", "", "font_small", "Your fat body. It always hinders us.")
dialog_addDialog("kni-m-tloustka", "cs", "sound/"..codename.."/cs/kni-m-tloustka.ogg", "font_small", "Ta tvoje tloušťka. Ta nás vždycky zdržuje.")
dialog_addDialog("kni-m-tloustka", "fr", "", "font_small", "Ton gros corps nous gêne toujours.")
dialog_addDialog("kni-m-tloustka", "de", "", "font_small", "Dein fetter Körper hält uns immer auf.")
...
dialog_addDialog("kni-v-proc", "fr", "", "font_big", "Et pourquoi ?")
dialog_addDialog("kni-v-proc", "de", "", "font_big", "Wieso denn?")

dialog_addDialog("kni-m-cetky", "en", "", "font_small", "I grew to understand that jewels and gold are but cheap trinkets.")
dialog_addDialog("kni-m-cetky", "cs", "sound/"..codename.."/cs/kni-m-cetky.ogg", "font_small", "Pochopila jsem, že šperky a zlato jsou jenom laciné cetky.")
dialog_addDialog("kni-m-cetky", "fr", "", "font_small", "J'ai compris que les joyaux et l'or ne sont que des babioles sans valeurs.")
dialog_addDialog("kni-m-cetky", "de", "", "font_small", "Ich habe begriffen, dass Edelsteine und Gold nur billiger Schmuck sind.")
