...
dialogStr("Я наконец-то поняла, что золото и бриллианты — всего лишь дешёвые безделушки")

dialogId("kni-m-kramy", "font_small", "I can’t bear the darned stuff any longer!")
dialogStr("Всё, перестань! Не могу больше слушать всякую чушь.")
