...
worldmap_addDesc("start", "cs", "Jak to v¹echno zaèalo", "Rybí domeèek")

worldmap_addDesc("briefcase", "en", "Briefcase Message", "Fish House")
worldmap_addDesc("briefcase", "cs", "Podivná zásilka", "Rybí domeèek")

worldmap_addDesc("cellar", "en", "Rehearsal in Cellar", "Fish House")
worldmap_addDesc("cellar", "cs", "Zkou¹ka ve sklepì", "Rybí domeèek")

worldmap_addDesc("library", "en", "Library Flotsam", "Fish House")
worldmap_addDesc("library", "cs", "Co zbylo z knihovny", "Rybí domeèek")

worldmap_addDesc("stairs", "en", "Plants on the Stairs", "Fish House")
worldmap_addDesc("stairs", "cs", "Zeleò na schodi¹ti", "Rybí domeèek")

worldmap_addDesc("broom", "en", "A Mess in the Boiler Room", "Fish House")
worldmap_addDesc("broom", "cs", "Nepoøádek v kotelnì", "Rybí domeèek")

worldmap_addDesc("reef", "en", "Under the Reef", "Fish House")
worldmap_addDesc("reef", "cs", "Pod útesem", "Rybí domeèek")
...
worldmap_addDesc("elk", "cs", "Velká vlastenecká válka", "Vrakovi¹tì")

worldmap_addDesc("wreck", "en", "The Ship of Captain Silver", "Ship Wrecks")
worldmap_addDesc("wreck", "cs", "Loï kapitána Silvera", "Vrakovi¹tì")

worldmap_addDesc("viking1", "en", "The Last Voyage", "Ship Wrecks")
worldmap_addDesc("viking1", "cs", "Poslední plavba", "Vrakovi¹tì")

worldmap_addDesc("airplane", "en", "Altitude: Minus 9111 Feet", "Ship Wrecks")
worldmap_addDesc("airplane", "cs", "Vý¹ka: -9111 stop", "Vrakovi¹tì")

worldmap_addDesc("bathyscaph", "en", "Bathyscaph", "Ship Wrecks")
worldmap_addDesc("bathyscaph", "cs", "Batyskaf", "Vrakovi¹tì")

worldmap_addDesc("tank", "en", "Amphibious Tank", "Ship Wrecks")
worldmap_addDesc("tank", "cs", "Oboj¾ivelný tank", "Vrakovi¹tì")

worldmap_addDesc("viking2", "en", "Eight Vikings in a Boat", "Ship Wrecks")
worldmap_addDesc("viking2", "cs", "Osm vikingù a pes", "Vrakovi¹tì")

worldmap_addDesc("party2", "en", "Return from the Party", "Ship Wrecks")
worldmap_addDesc("party2", "cs", "Návrat z výletu", "Vrakovi¹tì")

worldmap_addDesc("gods", "en", "The Gods Must Be Mad", "Ship Wrecks")
worldmap_addDesc("gods", "cs", "Bohové musí být ¹ílení", "Vrakovi¹tì")

worldmap_addDesc("elevator1", "en", "House with an Elevator", "City In the Deep")
worldmap_addDesc("elevator1", "cs", "Dùm s výtahem", "Mìsto v hlubinách")

worldmap_addDesc("city", "en", "Welcome To Our City", "City In the Deep")
worldmap_addDesc("city", "cs", "Vítejte ve mìstì!", "Mìsto v hlubinách")

worldmap_addDesc("ufo", "en", "Independence Day", "City In the Deep")
worldmap_addDesc("ufo", "cs", "Den nezávislosti", "Mìsto v hlubinách")

worldmap_addDesc("columns", "en", "The Columns", "City In the Deep")
worldmap_addDesc("columns", "cs", "Na kolonádì", "Mìsto v hlubinách")

worldmap_addDesc("pavement", "en", "Uneven Pavement", "City In the Deep")
worldmap_addDesc("pavement", "cs", "Nerovná dla¾ba", "Mìsto v hlubinách")

worldmap_addDesc("pyramid", "en", "Mr. Cheops` House", "City In the Deep")
worldmap_addDesc("pyramid", "cs", "Dùm pana Cheopse", "Mìsto v hlubinách")

worldmap_addDesc("music", "en", "A Bit of Music", "City In the Deep")
worldmap_addDesc("music", "cs", "Pro potì¹ení", "Mìsto v hlubinách")

worldmap_addDesc("crabshow", "en", "Crab Freak Show", "City In the Deep")
worldmap_addDesc("crabshow", "cs", "Paniptikum korý¹ù", "Mìsto v hlubinách")

worldmap_addDesc("elevator2", "en", "Another elevator", "City In the Deep")
worldmap_addDesc("elevator2", "cs", "Druhý dùm s výtahem", "Mìsto v hlubinách")

worldmap_addDesc("atlantis", "en", "And How It Was", "City In the Deep")
worldmap_addDesc("atlantis", "cs", "Tak takhle to bylo", "Mìsto v hlubinách")
...
worldmap_addDesc("labyrinth", "cs", "Bludi¹tì", "Korálový útes")

worldmap_addDesc("imprisoned", "en", "Imprisoned", "Coral reef")
worldmap_addDesc("imprisoned", "cs", "Uvìznìni", "Korálový útes")

worldmap_addDesc("society", "en", "Closed Society", "Coral reef")
worldmap_addDesc("society", "cs", "Uzavøená spoleènost", "Korálový útes")

worldmap_addDesc("creatures", "en", "Sleeping Creatures", "Coral reef")
worldmap_addDesc("creatures", "cs", "Spící tvoreèkové", "Korálový útes")
...
worldmap_addDesc("pearls", "cs", "Je¹tì jednu perlièku!", "Korálový útes")
...
worldmap_addDesc("computer", "cs", "Hlubinný server", "Smeti¹tì")

worldmap_addDesc("noground", "en", "Almost No Wall", "Dump")
worldmap_addDesc("noground", "cs", "Skoro ¾ádná zeï", "Smeti¹tì")

worldmap_addDesc("bathroom", "en", "Plumbman`s Refuse", "Dump")
worldmap_addDesc("bathroom", "cs", "Instalatérský odpad", "Smeti¹tì")

worldmap_addDesc("duckie", "en", "Adventure with Pink Duckie", "Dump")
worldmap_addDesc("duckie", "cs", "Dobrodru¾ství s kachnièkou", "Smeti¹tì")

worldmap_addDesc("puzzle", "en", "Shredded Stickman", "Dump")
worldmap_addDesc("puzzle", "cs", "Rozstøíhaná èmáranice", "Smeti¹tì")

worldmap_addDesc("dump", "en", "Real Chaos", "Dump")
worldmap_addDesc("dump", "cs", "Opravdový chaos", "Smeti¹tì")

worldmap_addDesc("barrel", "en", "Outraged Greenpeace", "Dump")
worldmap_addDesc("barrel", "cs", "Greenpeace by zuøili", "Smeti¹tì")

worldmap_addDesc("cabin1", "en", "The First Mate`s Cabin", "Silver's Ship")
worldmap_addDesc("cabin1", "cs", "Kajuta prvního dùstojníka", "Silverova loï")

worldmap_addDesc("snowman", "en", "The Winter Mess Hall", "Silver's Ship")
worldmap_addDesc("snowman", "cs", "Zimní jídelna", "Silverova loï")

worldmap_addDesc("cannons", "en", "Fire!", "Silver's Ship")
worldmap_addDesc("cannons", "cs", "Pal!", "Silverova loï")

worldmap_addDesc("kitchen", "en", "Ship Kitchen", "Silver's Ship")
worldmap_addDesc("kitchen", "cs", "Lodní kuchynì", "Silverova loï")

worldmap_addDesc("cabin2", "en", "Second Mate`s Cabin", "Silver's Ship")
worldmap_addDesc("cabin2", "cs", "Kajuta druhého dùstojníka", "Silverova loï")

worldmap_addDesc("captain", "en", "Captain`s Cabin", "Silver's Ship")
worldmap_addDesc("captain", "cs", "Kapitánova kajuta", "Silverova loï")

worldmap_addDesc("map", "en", "Silver`s Hideout", "Silver's Ship")
worldmap_addDesc("map", "cs", "Silverova tajná skrý¹", "Silverova loï")
...
worldmap_addDesc("corridor", "cs", "Pøísnì støe¾ená chodba", "Ztroskotané UFO")
...
worldmap_addDesc("propulsion", "cs", "Skuteèný pohon", "Ztroskotané UFO")

worldmap_addDesc("aztec", "en", "Aztec Art Hall", "Treasure Cave")
worldmap_addDesc("aztec", "cs", "Sál aztéckého umìní", "Jeskynì pokladù")

worldmap_addDesc("gems", "en", "Shiny Cave-in", "Treasure Cave")
worldmap_addDesc("gems", "cs", "Blýskavý zával", "Jeskynì pokladù")

worldmap_addDesc("chest", "en", "Giant`s Chest", "Treasure Cave")
worldmap_addDesc("chest", "cs", "Truhlièka obra Kolodìje", "Jeskynì pokladù")

worldmap_addDesc("alibaba", "en", "The Hall of Ali-baba", "Treasure Cave")
worldmap_addDesc("alibaba", "cs", "Alibabùv sál", "Jeskynì pokladù")

worldmap_addDesc("cave", "en", "The Deepest Cave", "Treasure Cave")
worldmap_addDesc("cave", "cs", "Nejhlub¹í jeskynì", "Jeskynì pokladù")

worldmap_addDesc("grail", "en", "What Would King Arthur Say?", "Treasure Cave")
worldmap_addDesc("grail", "cs", "Artu¹ by se divil", "Jeskynì pokladù")

worldmap_addDesc("tetris", "en", "TETRIS", "Secret Computer")
worldmap_addDesc("tetris", "cs", "TETRIS", "Tajný poèítaè")

worldmap_addDesc("emulator", "en", "Emulator", "Secret Computer")
worldmap_addDesc("emulator", "cs", "Emulátor", "Tajný poèítaè")

worldmap_addDesc("warcraft", "en", "Garden of War", "Secret Computer")
worldmap_addDesc("warcraft", "cs", "Garden of War", "Tajný poèítaè")

worldmap_addDesc("windoze", "en", "Favorites", "Secret Computer")
worldmap_addDesc("windoze", "cs", "Oblíbené polo¾ky", "Tajný poèítaè")

worldmap_addDesc("hardware", "en", "A Hardware Problem", "Secret Computer")
worldmap_addDesc("hardware", "cs", "Hardwarový problém", "Tajný poèítaè")

worldmap_addDesc("floppy", "en", "Read Only", "Secret Computer")
worldmap_addDesc("floppy", "cs", "Read only", "Tajný poèítaè")

worldmap_addDesc("ending", "en", "At Home", "")
worldmap_addDesc("ending", "cs", "Doma", "")
