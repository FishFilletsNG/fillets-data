...
dialogStr("Не обращай внимания, пусть себе говорит.")
...
dialogStr("Какая досада, что у меня нет ушей. Я мог бы заткнуть их.")

dialogId("dir-v-rada4", "font_big", "I am fed up to my gills with its nonsense.")
dialogStr("Я сыт по жабры этой бессмыслицой.")
...
dialogStr("Тебе поможет, если ты")
