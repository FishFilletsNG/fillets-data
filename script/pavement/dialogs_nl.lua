...
dialogStr("Hou je advies voor je!")


dialogId("dir-m-rada1", "font_small", "We know that very well.")
dialogStr("Dat weten wij ook wel!")
...
dialogStr("Ik ben die onzin zo ongeloofelijk zat!")


dialogId("dir-hs-uvod0", "font_statue", "It would be easiest if you")
dialogStr("Het zou het handigst zijn als jullie")
...
dialogStr("Het zou helpen als jullie")
...
dialogStr("een paar muren omver zouden duwen.")


dialogId("dir-hs-konec1", "font_statue", "break off a few stones from the wall and plug the holes with them.")
dialogStr("een paar stenen van die muur daar af zouden breken en daar de kuilen mee zouden opvullen.")


dialogId("dir-hs-konec2", "font_statue", "plug those holes with something so that that hooked steel wouldn’t get stuck there.")
dialogStr("deze gaten zouden opvullen met iets, zodat dat hoekige stuk staal niet vast komt te zitten.")
...
dialogStr("een stuk van dat hoekige stalen ding af zouden zagen.")
...
dialogStr("er heel erg hard over na zouden denken.")


dialogId("dir-hs-konec8", "font_statue", "swim out through that hole on the left.")
dialogStr("door dat gat links naarbuiten zouden zwemmen.")
