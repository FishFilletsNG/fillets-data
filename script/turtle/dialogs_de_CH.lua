...
dialogStr("Naja, ich weiss nicht. Nach den Fotos zu urteilen, könnte sie es sein.")


dialogId("zel-m-nevim0", "font_small", "I don`t know...")
dialogStr("Ich weiss nicht...")


dialogId("zel-v-nevim0", "font_big", "I don`t know what`s happening to me...")
dialogStr("Ich weiss nicht, was mit mir passiert...")


dialogId("zel-v-stacit1", "font_big", "Are you enjoying yourself?")
dialogStr("Macht dir das Spass?")
