...
dialogStr("La vedi? Quella dev'essere quella tartaruga telepatica.")
...
dialogStr("Non ne sono sicura... e quei poteri telepatici?")
...
dialogStr("Dev'essere la tartaruga!")
