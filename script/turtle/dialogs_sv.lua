...
dialogStr("Ser du den? Det måste vara den telepatiska sköldpaddan.")
...
dialogStr("Jag är inte säker... hur är det med de telepatiska krafterna?")
...
dialogStr("Vad kan det betyda?")


dialogId("zel-m-tazelva", "font_small", "This must be that turtle!")
dialogStr("Det måste vara sköldpaddan!")
