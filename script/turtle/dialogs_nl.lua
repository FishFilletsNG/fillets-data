...
dialogStr("Ja, dat is hem, de telepatische schildpad.")
...
dialogStr("Er is geen twijfel mogelijk - dit is hem, de schildpad waar we naar op zoek zijn!")


dialogId("zel-v-pochyby", "font_big", "Doubtless, this is the turtle we are looking for!")
dialogStr("Dit is absoluut de schildpad waar we naar op zoek zijn!")


dialogId("zel-m-potvora0", "font_small", "That beast!")
dialogStr("Dat monster!")
...
dialogStr("Deze koralen zijn een wonder van Moeder Natuur.")


dialogId("zel-v-tvary", "font_big", "Where do so many bizarre shapes come from?")
dialogStr("Waar komen zo veel bizarre vormen vandaan?")
...
dialogStr("Dat ligt voor de hand - de ontwikkelaars hebben moeilijke puzzels bedacht en laten het tekenen over aan de tekenaars.")


dialogId("zel-v-ukol", "font_big", "Our goal in this room is to get out that turtle.")
dialogStr("Ons doel in deze kamer is om die schildpad eruit te krijgen.")
