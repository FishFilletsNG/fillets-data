...
dialogStr("Det är alltså så här!")
...
dialogStr("Vårt uppdrag var tydligt - principen och konstruktionen av intergalaktisk drivkraft. Inte ett enda ord om kontakt.")


dialogId("poh-v-pomoct", "font_big", "Well. But they could at least help us.")
dialogStr("Nej. Men de kunde väl åtminstone hjälpa oss.")


dialogId("poh-m-dobryden0", "font_small", "Good afternoon, excuse me, please, couldn`t I loot your drive?")
dialogStr("God eftermiddag, ursäkta mig, snälla, kan vi sno eran motor?")
...
dialogStr("Humm, god eftermiddag herrn, skulle ni kunna hjälpa oss att montera ner er drivenhet, snälla?")


dialogId("poh-v-ukol", "font_big", "Our goal in this level is to get out the cage with that animal.")
dialogStr("Vårt mål på den här nivån är att få ut lådan med djuret.")


dialogId("poh-m-pohadali", "font_small", "I have a feeling there was an argument between these two.")
dialogStr("Jag har en känsla av att de där två är oense.")


dialogId("poh-v-setkani", "font_big", "I never imagined that meeting aliens would look this way.")
dialogStr("Jag trodde aldrig att det skulle vara så här att möta en utomjording.")


dialogId("poh-m-sestra", "font_small", "And what did you expect? That they will kidnap your sister?")
dialogStr("Och vad hade du förväntat dig? Att de skulle kidnappa din syster?")
