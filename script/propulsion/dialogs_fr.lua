...
dialogStr("Alors c'est comme ça!")
...
dialogStr("Si je ne me trompe pas, il se compose de six parties.")


dialogId("poh-v-klec", "font_big", "The cage in the middle is probably the most important.")
dialogStr("La cage du milieu est sans doute la plus importante.")
...
dialogStr("Bien. Mais ils pourraient au moins nous aider.")
