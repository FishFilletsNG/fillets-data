...
dialogStr("Наша миссия была ясна - принципы и постройка межзвездного толчка. Ни одного слова о контакте.")

dialogId("poh-v-pomoct", "font_big", "Well. But they could at least help us.")
dialogStr("Ладно. Но они могли бы, во всяком случае, помочь нам.")

dialogId("poh-m-dobryden0", "font_small", "Good afternoon, excuse me, please, couldn’t I loot your drive?")
dialogStr("Добрый день. Извините, пожалуйста, не мог бы я украсть Ваш мотор?")
