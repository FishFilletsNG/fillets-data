...
dialogStr("Unser Auftrag war eindeutig - Prinzipen und Konstruktion des interstellaren Antriebs. Kein einziges Wort über Kontaktaufnahme")


dialogId("poh-v-pomoct", "font_big", "Well. But they could at least help us.")
dialogStr("Na gut. Aber die könnten uns wenigsten ein bisschen helfen.")


dialogId("poh-m-dobryden0", "font_small", "Good afternoon, excuse me, please, couldn`t I loot your drive?")
dialogStr("Guten Tag, entschuldigen sie bitte, könnte ich ihr Fahrzeug plündern?")
...
dialogStr("Hmm, Guten Tag der Herr, wären sie so freundlich, uns beim Zerlegen ihrer Antriebseinheit zu helfen?")


dialogId("poh-v-ukol", "font_big", "Our goal in this level is to get out the cage with that animal.")
dialogStr("In dieser Ebene ist unser Ziel, den Käfig mit diesem Tier hier rauszubekommen.")


dialogId("poh-m-pohadali", "font_small", "I have a feeling there was an argument between these two.")
dialogStr("Ich habe das Gefühl, die beiden hatten eine Auseinandersetzung.")


dialogId("poh-v-setkani", "font_big", "I never imagined that meeting aliens would look this way.")
dialogStr("Ich hätte nie gedacht, dass ein Treffen mit Außerirdischen so aussieht.")


dialogId("poh-m-sestra", "font_small", "And what did you expect? That they will kidnap your sister?")
dialogStr("Und was hast du erwartet? Dass sie deine Schwester entführen?")
