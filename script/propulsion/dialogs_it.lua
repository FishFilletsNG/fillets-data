...
dialogStr("Bioenergia. Avremmo già dovuto capirlo. Ne avevamo tutti gli indizi.")
...
dialogStr("La nostra missione è chiara - principi e costruzione della propoulsione interstellare. Niente riguardo a contatti.")
...
dialogStr("Ehm, buongiorno, potrei chiederle di aiutarci a smantellare il suo propulsore, per piacere?")

dialogId("poh-v-ukol", "font_big", "Our goal in this level is to get out the cage with that animal.")
dialogStr("Il nostro obiettivo in questo livello è far uscire la gabbia con l'animale.")

dialogId("poh-m-pohadali", "font_small", "I have a feeling there was an argument between these two.")
dialogStr("Mi sembra che ci sia stata una discussione fra questi due.")

dialogId("poh-v-setkani", "font_big", "I never imagined that meeting aliens would look this way.")
dialogStr("Non avrei mai immaginato che incontrare degli alieni sarebbe stato così.")

dialogId("poh-m-sestra", "font_small", "And what did you expect? That they will kidnap your sister?")
dialogStr("E osa ti aspettavi? Che rapissero tua sorella?")
