...
dialogStr("Bio-energie. Dat hadden we kunnen weten. We hadden zo veel aanwijzingen.")


dialogId("poh-m-reaktor", "font_small", "And what was that nuclear power plant for?")
dialogStr("En waar was die kernreactor dan voor?")


dialogId("poh-v-automat", "font_big", "Can’t you see? It powers that Coca-Cola vending machine over there.")
dialogStr("Is dat niet duidelijk? Die drijft die Coca-Cola automaat daar aan.")


dialogId("poh-m-motor", "font_small", "And what about that motor?")
dialogStr("En hoe zit het dan met die motor?")


dialogId("poh-v-tocit", "font_big", "It makes the level run around the display.")
dialogStr("Die zorgt dat het veld over het beeldscherm heen beweegt.")
...
dialogStr("Misschien toch wel. VDTO werkt op het moment aan een project met bio-energie.")


dialogId("poh-v-zarizeni", "font_big", "We have to get out this device.")
dialogStr("We moeten dit apparaat mee zien te nemen.")


dialogId("poh-m-sest", "font_small", "If I can see it correctly, it is composed of six parts.")
dialogStr("Als ik het goed zie bestaat het uit zes onderdelen.")


dialogId("poh-v-klec", "font_big", "The cage in the middle is probably the most important.")
dialogStr("De kooi in het midden is waarschijnlijk het belangrijkste onderdeel.")


dialogId("poh-m-dobre", "font_small", "Okay, we shall take this one.")
dialogStr("Goed, die nemen we mee.")
...
dialogStr("Nou ja. Maar ze kunnen ons op z'n minst helpen.")


dialogId("poh-m-dobryden0", "font_small", "Good afternoon, excuse me, please, couldn’t I loot your drive?")
dialogStr("Hallo, pardon, mag ik even de aandrijving van dit schip stelen?")
...
dialogStr("Hmm, hallo, meneer, zou u me alstublieft kunnen helpen de aandrijving van dit schip uitelkaar te halen?")


dialogId("poh-v-ukol", "font_big", "Our goal in this level is to get out the cage with that animal.")
dialogStr("In dit veld is ons doel om die kooi met dat beest eruit te krijgen.")
...
dialogStr("Ik had me iets heel anders voorgesteld bij buitenaardse wezens.")


dialogId("poh-m-sestra", "font_small", "And what did you expect? That they will kidnap your sister?")
dialogStr("Wat had je dan verwacht? Dat ze je zus zouden ontvoeren?")
