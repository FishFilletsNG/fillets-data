...
dialogStr("Napęd biologiczny. Powinniśmy byli wpaść na to wcześniej. Wszystko na to wskazywało.")
...
dialogStr("Nasze rozkazy są jasne - zdobyć informacje o zasadach funkcjonowania i konstrukcji napędu międzygwiezdnego. Nic o nawiązywaniu kontaktu.")
...
dialogStr("Ehm, dzień dobry, czy mogłabym państwa prosić o pomoc w rozebraniu na części waszego silnika?")


dialogId("poh-v-ukol", "font_big", "Our goal in this level is to get out the cage with that animal.")
dialogStr("Tym razem naszym zadaniem jest wydostanie stąd klatki z tym zwierzęciem.")


dialogId("poh-m-pohadali", "font_small", "I have a feeling there was an argument between these two.")
dialogStr("Coś mi się zdaje, że tych dwoje się pokłóciło.")


dialogId("poh-v-setkani", "font_big", "I never imagined that meeting aliens would look this way.")
dialogStr("Nigdy bym nie pomyślał, że mój kontakt z obcymi odbędzie się w takich okolicznościach.")


dialogId("poh-m-sestra", "font_small", "And what did you expect? That they will kidnap your sister?")
dialogStr("A czego oczekiwałeś? Że ci porwą siostrę?")
