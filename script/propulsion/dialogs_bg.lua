...
dialogStr("Биологична енергия. Трябваше да се досетим по-рано. Всичко води към нея.")
...
dialogStr("Задачата ни е съвсем ясна - принципи и устройство на междъзвесдната тяга. И нито дума за контакт.")
...
dialogStr("Хм, добър ден, господине, мога ли да ви помоля да ни помогнете да демонтираме устройството за междузвездна тяга, моля?")

dialogId("poh-v-ukol", "font_big", "Our goal in this level is to get out the cage with that animal.")
dialogStr("Задачата ни в това ниво е да се измъкнем от клетката с животното.")

dialogId("poh-m-pohadali", "font_small", "I have a feeling there was an argument between these two.")
dialogStr("Имам чувството, че между тези двамата е имало спор.")

dialogId("poh-v-setkani", "font_big", "I never imagined that meeting aliens would look this way.")
dialogStr("Не съм си представял, че срещата с извънземни ще изглежда така.")

dialogId("poh-m-sestra", "font_small", "And what did you expect? That they will kidnap your sister?")
dialogStr("Ти какво очакваш? Да отвлекат сестра ти?")
