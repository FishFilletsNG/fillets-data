...
dialog_addDialog("dlg-x-poster1", "cs", "", "font_poster", "Veverka - to je pojem, který se ode dneška po několik příštích let bude skloňovat ve všech pádech v souvislosti s mezihvězdným pohonem. To je také možný důvod návštěvy Země ufem.")
...
dialog_addDialog("dlg-x-poster2", "cs", "", "font_poster", "Ano, za posledních 5 let bylo hlášeno, obzvláště z Arizony, Utahu a Jižní Moravy několik případů únosu veverek, ale nikdo jim nevěnoval patřičnou pozornost. Teď známe celou otřesnou pravdu. Technický popis přiložen.")
