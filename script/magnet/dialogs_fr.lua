...
dialogStr("Peut-être que je pourrais apprendre à porter ces tubes d'acier.")
...
dialogStr("Je me sens un peu à l'étroit ici.")


dialogId("pap-m-mraz", "font_small", "These magnets are giving me the creeps.")
dialogStr("Ces aimants me hérissent les écailles.")


dialogId("pap-v-pole", "font_big", "This magnetic field probably has some invigorating effects.")
dialogStr("Ce champs magnétique à probablement des effets fortifiants.")
