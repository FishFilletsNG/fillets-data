...
createRoom(40, 30, "images/alibaba/pozadi.png")
...
addItemAnim(wall, "images/alibaba/knihovna-zed1.png")

universal = addModel("item_light", 25, 4,
[[
XX
]])
addItemAnim(universal, "images/alibaba/drahokam_00.png")
...
addItemAnim(item_light, "images/alibaba/koruna_00.png")
...
addItemAnim(item_light, "images/alibaba/svicen.png")
...
addItemAnim(item_heavy, "images/alibaba/3-ocel.png")
...
addItemAnim(item_heavy, "images/alibaba/7-ocel.png")

pc2 = addModel("item_light", 31, 17,
[[
XXX
]])
addItemAnim(pc2, "images/alibaba/prsten-_00.png")
...
addItemAnim(switcher, "images/alibaba/vazav.png")

pf2 = addModel("item_light", 25, 5,
[[
XXX
]])
addItemAnim(pf2, "images/alibaba/prsten-_00.png")
...
addItemAnim(item_light, "images/alibaba/vazav.png")

item_light = addModel("item_light", 4, 6,
[[
XXX
]])
addItemAnim(item_light, "images/alibaba/vazav1.png")

db1 = addModel("item_light", 4, 5,
[[
XXX
]])
addItemAnim(db1, "images/alibaba/drahokam_b_00.png")
...
addItemAnim(pf1, "images/alibaba/prsten-_00.png")
-- extsize=1; first="prsten-5.BMP"
...
addItemAnim(db2, "images/alibaba/drahokam_b_00.png")
...
addItemAnim(pazur, "images/alibaba/prsten-4.png")

pc1 = addModel("item_light", 20, 4,
[[
XXX
]])
addItemAnim(pc1, "images/alibaba/prsten-_00.png")
...
addItemAnim(item_light, "images/alibaba/amfora_cervena-a.png")
...
addItemAnim(item_light, "images/alibaba/pohar.png")
...
addItemAnim(item_light, "images/alibaba/amfora_zelena-a.png")
...
addItemAnim(item_light, "images/alibaba/amfora-a.png")
...
addItemAnim(item_light, "images/alibaba/vaza_cervena-a.png")

item_light = addModel("item_light", 4, 4,
[[
XX
]])
addItemAnim(item_light, "images/alibaba/pohar-a.png")

item_light = addModel("item_light", 20, 5,
[[
XX
]])
addItemAnim(item_light, "images/alibaba/amfora.png")

item_light = addModel("item_light", 21, 7,
[[
XX
]])
addItemAnim(item_light, "images/alibaba/vaza_cervena.png")

item_light = addModel("item_light", 24, 6,
[[
XX
]])
addItemAnim(item_light, "images/alibaba/amfora_zelena.png")

krystal = addModel("item_light", 12, 25,
[[
X
]])
addItemAnim(krystal, "images/alibaba/krystal_00.png")
...
addItemAnim(item_light, "images/alibaba/krystal_00.png")
-- extsize=27; first="krystal0.BMP"
