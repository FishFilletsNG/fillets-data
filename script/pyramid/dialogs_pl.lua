...
dialogStr("Przecież tego nie widzisz, to jest po drugiej stronie muru!")


dialogId("pyr-m-nudi", "font_small", "Look, the woman is bored!")
dialogStr("Ta kobieta się chyba nudzi...")
...
dialogStr("Z bogiem i dzięki za ryby.")
