...
dialogStr("Åj, det här var just ett snyggt kök!")


dialogId("kuch-m-objev1", "font_small", "Yeah, we discovered the ship kitchen.")
dialogStr("Ja, vi hittade skeppsköket.")
...
dialogStr("Men det är inte vårt problem.")


dialogId("kuch-m-noproblem", "font_small", "There are not many problems here. I can swim out at once.")
dialogStr("Det finns inte många problem här. Jag kan simma ut direkt.")
...
dialogStr("De här borden är i vägen.")
