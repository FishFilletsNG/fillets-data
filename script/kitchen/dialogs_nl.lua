...
dialogStr("Ja hoor, we hebben de kombuis gevonden.")
...
dialogStr("Maar dat is niet ons probleem.")


dialogId("kuch-m-noproblem", "font_small", "There are not many problems here. I can swim out at once.")
dialogStr("Dit is eenvoudig, ik kan hier zo uit zwemmen.")
...
dialogStr("Deze tafels staan in de weg.")
...
dialogStr("Iedereen wil wel eens even zitten.")
...
dialogStr("Dat is massaproductie, joh.")


dialogId("kuch-m-pekne", "font_small", "But they are nice. We should order a few too.")
dialogStr("Maar ik vind ze wel mooi. Misschien moeten we er een paar bestellen.")
...
dialogStr("Het lijkt erop dat dit schip een aantal lastige hindernissen bevat.")


dialogId("kuch-v-mec", "font_big", "Why is that sword here?")
dialogStr("Wat doet dit zwaard hier?")
...
dialogStr("Gelukkig is de kok er niet. Hij zou ons misschien wel willen klaarmaken!")


dialogId("kuch-v-svitek0", "font_big", "There must be some recipe on that parchment.")
dialogStr("Op dat stuk perkament staat vast een recept.")
...
dialogStr("Waarschijnlijk staat er hoe je vis moet klaarmaken.")
