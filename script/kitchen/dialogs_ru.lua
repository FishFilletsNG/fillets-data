...
dialogStr("Я не думаю, что он готовил себе сам.")


dialogId("kuch-v-problem", "font_big", "But this is not our problem.")
dialogStr("Но это не наша проблема.")
...
dialogStr("Но только взгляни на меня.")
...
dialogStr("Этот горшок даже не мыли.")


dialogId("kuch-m-hrnec2", "font_small", "Nobody washes the dishes here.")
dialogStr("Никто не мыл здесь посуду.")
...
dialogStr("Каждый хочет отдохнуть иногда.")
...
dialogStr("Ты знаешь, они выпускаются серийно.")


dialogId("kuch-m-pekne", "font_small", "But they are nice. We should order a few too.")
dialogStr("Они прелестны. Мы должны заказать несколько.")
