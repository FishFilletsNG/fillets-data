...
dialogStr("Ce doit être une sorte de laboratoire.")


dialogId("bank-m-labolator2", "font_small", "It seems that even UFOs can be equipped with an on-board lab.")
dialogStr("Apparemment, même les ovnis sont équipés de labo.")
...
dialogStr("Il y a un nombre incroyable de créatures différentes ici !")


dialogId("bank-v-mnozeni", "font_big", "My goodness, look at those things reproduce!")
dialogStr("Bonté divine, regarde ces choses se reproduisent !")


dialogId("bank-m-nesetkala", "font_small", "I`ve never seen this kind of organism before.")
dialogStr("Je n'avais jamais vu ce genre d'organisme avant.")


dialogId("bank-m-kouka", "font_small", "Help! It`s looking at me!")
dialogStr("Au secours ! Il m'observe !")
...
dialogStr("Cette main me donne des frissons...")


dialogId("bank-m-zkumavka", "font_small", "There`s a strange odor coming from this test-tube...")
dialogStr("Il y a une drôle d'odeur qui sort de ce tube à essai...")
...
dialogStr("L'odeur de cette bouteille me rend malade.")


dialogId("bank-m-rozbila", "font_small", "Ooops, it broke...")
dialogStr("Oups, ça casse...")
...
dialogStr("Là c'est vraiment trop !")


dialogId("bank-m-prehnal2", "font_small", "How morbid!")
dialogStr("Que c'est morbide !")
