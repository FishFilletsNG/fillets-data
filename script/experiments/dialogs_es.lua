...
dialogStr("Este debe ser alguna clase de laboratorio.")


dialogId("bank-m-labolator2", "font_small", "It seems that even UFOs can be equipped with an on-board lab.")
dialogStr("Parece que incluso los OVNIs pueden ser equipados con un laboratorio a bordo.")


dialogId("bank-m-labolator3", "font_small", "This looks like a laboratory.")
dialogStr("Esto luce como un laboratorio.")
...
dialogStr("¡Hay un número increíble de criaturas distintas aquí!")
