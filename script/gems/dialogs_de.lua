...
dialogStr("Nimm bitte zur Kenntnis, dass in dieser Ebene einhundertneun Gegenstände sind.")
...
dialogStr("Du hast Recht. Der Grüne war mit Sicherheit da drüben!")
...
dialogStr("Schau, unser Spieler hat seinen Farbendurst offensichtlich gestillt.")


dialogId("zav-v-zachranit", "font_big", "Maybe he could try to save us instead now.")
dialogStr("Vielleicht könnte er uns stattdessen retten?")
