...
dialogStr(
"Он будет ждать моей помощи в следующей комнате. Начни это заново прямо сейчас!")
...
dialogStr("Я не брошу маленький кусок ни на один больше.")

dialogId("v-kopie", "font_big",
"Somebody could think this room is only a copy of one room from fish fillets 2.")
dialogStr(
"Кто бы мог подумать, что этот зал является лишь копией одной комнаты из fish fillets 2.")

dialogId("m-inspiroval", "font_small",
"But in fact the author was only inspired by the hardware problem room.")
dialogStr("Но, фактически, автор был вдохновлен аппаратной проблемой комнаты.")
...
dialogStr("Он может смотреть вперед для следующих комнат.")

dialogId("v-budou", "font_big", "He doesn't know, what they are like.")
dialogStr("Он не знает, что они хотели.")

dialogId("m-vyhecoval", "font_small", "Possibly somebody psyched him up.")
dialogStr("Возможно, кто-то напугал его.")
...
dialogStr("Конечно, тебя не развлекает, когда ты почти не помогаешь мне.")

dialogId("m-trikrat", "font_small", "You said it already three times.")
dialogStr("Ты сказал это уже три раза.")
...
dialogStr("Возможно, сейчас диск игрока может расположить больше данных, чем в прошлом.")

dialogId("v-plny", "font_big",
"I think what ever size the disc is, it's always full.")
dialogStr("Я думаю, что когда измеряют диск, он всегда полный.")

dialogId("m-citovat", "font_small", "Be ashamed, cheater.")
dialogStr("Стыдись, мошенник.")

dialogId("v-pochvalil", "font_big",
"Finally I praise the player, that he solved it by the longer way.")
dialogStr(
"Итак я хвалю игрока за то, что он решил это длинным путем.")
