...
dialogStr("Det är inte doktorns order.")
...
dialogStr("Men författaren vara bara inspirerad av rummet med hårdvaruproblemet.")
...
dialogStr("Hur kan spelaren finna nöje i det här?")

dialogId("m-tesise", "font_small", "He may look foward for next rooms.")
dialogStr("Han kanske ser fram mot nästa rum.")

dialogId("v-budou", "font_big", "He doesn't know, what they are like.")
dialogStr("Han vet inte hur de ser ut.")
...
dialogStr("Självklart så känner du dig inte road om du nästan inte hjälper mig alls.")

dialogId("m-trikrat", "font_small", "You said it already three times.")
dialogStr("Du har redan sagt det tre gånger.")

dialogId("v-jineho", "font_big",
"If I should say always something different then we fill player's disc up.")
dialogStr("Om jag alltid skulle säga något annat skulle vi fylla upp spelarens disk")
