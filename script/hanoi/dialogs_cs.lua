...
dialogStr(
"Jak si to představuješ? Pustíš ven toho obra a mne tady necháš? Pohne ocelí, no a?")
...
dialogStr(
"Proč to všechno musím skládat já, když by to zvládl jednoduchý rekurzivní prográmek?")

dialogId("v-bavit", "font_big", "How can the player find a pleasure in this?")
dialogStr("Jak to toho hráče může jestě bavit?")
...
dialogStr("Styď se, takhle čítovat.")

dialogId("v-pochvalil", "font_big",
"Finally I praise the player, that he solved it by the longer way.")
dialogStr(
"Nakonec bych hráče pochválil, že to řešil tím zdlouhavějším způsobem.")
