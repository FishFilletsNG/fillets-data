...
dialogStr("Как мислиш? Освобождаваш великана и ме оставяш тук. Той може да мести железа, но какво от това?")

dialogId("m-restartuj", "font_small",
"He will be wating for my help in the next room. Restart it, right now!")
dialogStr("Ще чака да му помогна в следващата зала. Рестартирай я веднага!")

dialogId("v-nenifer", "font_big",
"It isn't fair, my way was free. I only pushed to the steel the wrong way.")
dialogStr("Не е честно, пътят ми беше свободен. Само преместих желязото в неправилна посока.")
...
dialogStr("Малките рибки се губят в огромния океан. Няма да отиде далеч без мен. Трябва да рестартираш незабавно.")

dialogId("v-orechove", "font_big", "It isn't what the doctor ordered.")
dialogStr("Докторът поръча друго.")

dialogId("m-hazet", "font_small",
"I should not throw the smaller piece onto the bigger one.")
dialogStr("Не трябва да поставям малкото парче върху голямото.")
