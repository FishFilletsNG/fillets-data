...
dialogStr("Quell'oggetto là dev'essere il Sacro Graal!")
...
dialogStr("L'aureola non vuol dire niente. Il Graal potrebbe essere uguale a tutti gli altri.")

dialogId("gr-v-nic1", "font_big", "All that glitters is not gold. No one ever said that Holy Grail must glow.")
dialogStr("Quel luccichio non è oro. E nessuno ha mai detto che il Graal debba brillare.")

dialogId("gr-v-nic2", "font_big", "Hmm... Placing a plain Grail in a conspicuous place will not turn it into a Holy one.")
dialogStr("Mmm... mettere un calice qualsiasi in bella vista non lo rende sacro.")

dialogId("gr-v-tuseni", "font_big", "I feel it will not be as it seems.")
dialogStr("Sento che non sarà come sembra.")
