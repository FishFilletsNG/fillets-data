...
dialogStr("Онова нещо там трябва да е Светият Граал!")
...
dialogStr("Ореолът не означава нищо. Светият Граал може да изглежда доста обикновен.")

dialogId("gr-v-nic1", "font_big", "All that glitters is not gold. No one ever said that Holy Grail must glow.")
dialogStr("Не всякое злато сияе. Не е казано, че Светият Граал трябва да свети.")

dialogId("gr-v-nic2", "font_big", "Hmm... Placing a plain Grail in a conspicuous place will not turn it into a Holy one.")
dialogStr("Хм... Поставянето на Граал на очевидно място не го прави Светия Граал.")

dialogId("gr-v-tuseni", "font_big", "I feel it will not be as it seems.")
dialogStr("Чувствам, че няма да е каквото изглежда.")
