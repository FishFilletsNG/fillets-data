...
dialog_addDialog("dlg-x-poster2", "de", "", "font_poster", "Durch Bombardieren einiger der Grale mit ultraschmutzigen Wörtern maßen wir manchmal sogar drei Weihnachtsmänner. Einige widerstanden dem Umgebungsdruck von 0,8 Aufgaben in einer Minute!")
dialog_addDialog("dlg-x-poster2", "de_CH", "", "font_poster", "Durch Bombardieren einiger der Grale mit ultraschmutzigen Wörtern massen wir manchmal sogar drei Weihnachtsmänner. Einige widerstanden dem Umgebungsdruck von 0,8 Aufgaben in einer Minute!")
...
dialog_addDialog("dlg-x-poster3", "de", "", "font_poster", "Es ist auch möglich, dass wir auf den ganzen Heiligen Gottesdienst gestoßen sind.")
dialog_addDialog("dlg-x-poster3", "de_CH", "", "font_poster", "Es ist auch möglich, dass wir auf den ganzen Heiligen Gottesdienst gestossen sind.")
