...
dialog_addDialog("dlg-x-poster1", "cs", "", "font_poster", "Zaslaný materiál doporučujeme podrobit důkladným testům svatosti. Díky nedostatku vybavení jsme provedli jen základní testy a výsledky jsou více než slibné.")
...
dialog_addDialog("dlg-x-poster2", "cs", "", "font_poster", "Při bombardování ultrasprostými slovy jsme u některých grálů naměřili až tři mikuláše, jiné vydržely po dobu jedné minuty tlak okolností téměř 0,8 jobu!")

dialog_addDialog("dlg-x-poster3", "en", "", "font_poster", "It is also possible that we have encountered the whole Holy Service.")
dialog_addDialog("dlg-x-poster3", "cs", "", "font_poster", "Je dokonce možné, že se jedná o celý Svatý Servis.")
