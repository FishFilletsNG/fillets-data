...
dialogStr("Támhle to uprostřed, to je nepochybně Svatý grál!")
...
dialogStr("Svatozář nic neznamená. Svatý grál může vypadat i úplně obyčejně.")


dialogId("gr-v-nic1", "font_big", "All that glitters is not gold. No one ever said that Holy Grail must glow.")
dialogStr("Není všechno zlato, co se třpytí. Nikde není psáno, že Svatý grál musí zářit.")


dialogId("gr-v-nic2", "font_big", "Hmm... Placing a plain Grail in a conspicuous place will not turn it into a Holy one.")
dialogStr("Hmmm... když dá někdo obyčejný grál na vyvýšené místo, nestane z něj přece svatý.")


dialogId("gr-v-tuseni", "font_big", "I feel it will not be as it seems.")
dialogStr("Mám takové tušení, že to bude jinak, než se zdá.")
