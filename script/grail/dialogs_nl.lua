...
dialogStr("Dat ding daar is vast de Heilige Graal!")
...
dialogStr("Een aureool zegt helemaal niks. De Heilige Graal zou er ook heel eenvoudig uit kunnen zien.")
...
dialogStr("Hmm... Een eevoudige graal op een opvallende plek neer zetten maakt hem nog niet Heilig.")


dialogId("gr-v-tuseni", "font_big", "I feel it will not be as it seems.")
dialogStr("Ik heb het gevoel dat het niet allemaal zo is als het lijkt.")
