...
dialogStr("Cet objet là bas doit être le saint Graal.")
...
dialogStr("Hum... Placer un Graal ordinaire ostensiblement ne va pas le transformer en saint Graal.")


dialogId("gr-v-tuseni", "font_big", "I feel it will not be as it seems.")
dialogStr("J'ai l'impression qu'il ne sera pas ce qu'il semble être.")
...
dialogStr("Hum... Se pourrait-il que tu aies raison ? Nous allons tous les prendre.")


dialogId("gr-m-svaty1", "font_small", "Our goal in this level is to push out the Holy Grail.")
dialogStr("Notre but dans ce niveau est de faire sortir le saint Graal.")
...
dialogStr("Le saint Graal seulement.")
...
dialogStr("Presque tous sont sortis, maintenant !")
