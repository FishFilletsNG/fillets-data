...
dialogStr("Någonting trillade ner här igen.")


dialogId("sch-v-lastura", "font_big", "It’s some kind of shell. We’ll probably have to push it upstairs again.")
dialogStr("Det är någon sorts snäcka. Vi måste antagligen knuffa den upp för trappan igen.")
...
dialogStr("Jag kan se det: \"Snäcka möter blomkruka\". Det är ju som om ett strykjärn och en symaskin möts på ett operationsbord.")


dialogId("sch-m-moc0", "font_small", "I’m sorry, I got a bit carried away.")
dialogStr("Förlåt mig, jag råkade vandra bort i tankarna.")


dialogId("sch-m-moc1", "font_small", "Sorry, I was momentarily distracted.")
dialogStr("Ursäkta, jag blev distraherad.")


dialogId("sch-m-moc2", "font_small", "Where I am going with this shell?")
dialogStr("Vart är jag på väg med den här snäckan?")
