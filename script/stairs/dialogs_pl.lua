...
dialogStr("Znów nam coś tu spadło.")


dialogId("sch-v-lastura", "font_big", "It’s some kind of shell. We’ll probably have to push it upstairs again.")
dialogStr("To jakaś muszelka. Chyba będziemy musieli ją wnieść z powrotem.")
...
dialogStr("Spotkanie muszelki z doniczką. To prawie jak spotkanie żelazka z maszyną do szycia na stole operacyjnym.")


dialogId("sch-m-moc0", "font_small", "I’m sorry, I got a bit carried away.")
dialogStr("Przepraszam, poniosło mnie.")


dialogId("sch-m-moc1", "font_small", "Sorry, I was momentarily distracted.")
dialogStr("Wybacz, zamyśliłam się.")


dialogId("sch-m-moc2", "font_small", "Where I am going with this shell?")
dialogStr("Dokąd ja taszczę tę muszlę?")
