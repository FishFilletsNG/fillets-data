...
dialog_addDialog("sch-v-lastura", "cs", "sound/"..codename.."/cs/sch-v-lastura.ogg", "font_big", "Nìjaká lastura. Asi ji budem muset vystrkat nahoru.")
...
dialog_addDialog("sch-v-setkani", "cs", "sound/"..codename.."/cs/sch-v-setkani.ogg", "font_big", "Setkání lastury s kvìtináèem. To je skoro jako setkání ¾ehlièky s ¹icím strojem na operaèním stole.")

dialog_addDialog("sch-m-moc0", "en", "", "font_small", "I`m sorry, I got a bit carried away.")
dialog_addDialog("sch-m-moc0", "cs", "sound/"..codename.."/cs/sch-m-moc0.ogg", "font_small", "Nìjak jsem se do toho moc zabrala.")
...
dialog_addDialog("sch-m-moc2", "cs", "sound/"..codename.."/cs/sch-m-moc2.ogg", "font_small", "Kam to vlastnì strkám?")
