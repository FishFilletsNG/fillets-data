...
dialogStr("Опять сюда что-то свалилось.")
...
dialogStr("Так и вижу: 'Ракушка встречает цветочный горшок'. Это почти как встреча утюга и швейной машинки на операционном столе.")

dialogId("sch-m-moc0", "font_small", "I’m sorry, I got a bit carried away.")
dialogStr("Извиняюсь, я что-то потеряла нить.")

dialogId("sch-m-moc1", "font_small", "Sorry, I was momentarily distracted.")
dialogStr("Прости, я отвлеклась.")

dialogId("sch-m-moc2", "font_small", "Where I am going with this shell?")
dialogStr("И куда мне плыть с этой ракушкой?")
