...
dialogStr("Jetzt müssen wir nur noch herausfinden, warum sie versunken ist und wir sind fertig.")


dialogId("sl-m-trvat", "font_small", "But it may take us a little while.")
dialogStr("Dafür brauchen wir aber ein Weilchen.")


dialogId("sl-v-nechme", "font_big", "Leave me alone. I adore the classic beauty of this temple.")
dialogStr("Lass mich in Ruhe. Ich bewundere die klassische Schönheit dieses Tempels.")
