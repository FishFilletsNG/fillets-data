...
dialogStr("Myslím, že jsme skutečně na stopě tomu tajemnému městu.")


dialogId("sl-m-velkolepe", "font_small", "It looks magnificent.")
dialogStr("Vypadá to velkolepě.")
