...
dialogStr("Май най-сетне сме по след на този мистериозен град.")
...
dialogStr("Сега само остава да разберем защо е потънал и сме готови.")
...
dialogStr("Остави ме намира. Възхищавам се на класическата красота на този храм.")
