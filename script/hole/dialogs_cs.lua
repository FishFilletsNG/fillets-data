...
dialogStr("Dejte to sem, ta indiánská čelenka je moje!")

dialogId("l-dejte1", "font_lightgrey", "Put it back immediately, it is mine!")
dialogStr("Dejte to sem, to je moje!")
...
dialogStr("Kam mě to strkáte? Já jsem slavný Vinnetou!")

dialogId("m-nedame0", "font_small",
         "Sorry, we need it necessarily.")
dialogStr("Promiň, ale my ji teď nutně potřebujeme.")
...
dialogStr("To bude možná sluchátko Macha a Šebestové.")

dialogId("v-zkus", "font_big", "Try it.")
dialogStr("Tak to zkus.")

dialogId("m-zmizet", "font_small",
         "Hello, I wish to disappear the steel near exit?")
dialogStr("Haló, mohla by ta ocel u východu na chvíli zmizet?")

dialogId("v-vratte", "font_big",
         "Put it back, it should be solved by player, not by ourself.")
dialogStr("Vraťte ji zpátky, aby to musel vyřešit hráč a ne my.")
