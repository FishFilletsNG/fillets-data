...
dialogStr("Ten nietoperz musi być strasznie silny.")
...
dialogStr("Ten czerwony stwór jest nieco dziwny.")
...
dialogStr("Za wąsko dla mnie. Musisz sama odwalić robotę tam na dole.")
...
dialogStr("Chyba będziemy musieli gdzie indziej poszukać Graala...")
...
dialogStr("A cóż to za opalizujący potwór?")


dialogId("jes-m-potvora1", "font_small", "This is an abomination.")
dialogStr("To jest odrażające.")
...
dialogStr("Może to rzeźba nietoperza.")
...
dialogStr("Chyba będziesz potrzebować tego 'potwora’.")
