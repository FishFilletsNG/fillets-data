...
dialogStr("Deze vleermuis moet wel heel sterk zijn.")
...
dialogStr("Vis? Ik dacht dat het een steen was.")
...
dialogStr("Ik weet het niet zo zeker.")


dialogId("jes-m-takvidis", "font_small", "See? You are here.")
dialogStr("Kijk, je bent er.")
...
dialogStr("Dat is de flitsende hamerkop.")
