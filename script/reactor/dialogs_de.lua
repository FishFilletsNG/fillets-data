...
dialogStr("Naja, wie viele fliegenden Untertassen haben deiner Meinung nach einen Schießstand an Bord? Und wie viele haben einen Reaktor?")
...
dialogStr("Ich hoffe, wir starten keine unangenehme Reaktion.")


dialogId("rea-v-nemudruj", "font_big", "Don`t think. Just push the rods.")
dialogStr("Denk nicht! Schieb einfach die Stäbe!.")
