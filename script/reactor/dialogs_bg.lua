...
dialogStr("Нямам представа, но е отвратително.")

dialogId("rea-m-comyslis", "font_small", "What do you think about these rods?")
dialogStr("Какво мислиш за тези пръти?")
...
dialogStr("Ами според теб колко летящи чинии имат стрелбище на борда си? И колко имат енергиен източник?")

dialogId("rea-v-takvidis", "font_big", "You see?")
dialogStr("Виждаш ли?")

dialogId("rea-m-doufam", "font_small", "I hope we don`t start some unpleasant reaction.")
dialogStr("Надявам се да не предизвикаме някоя неприятна реакция.")

dialogId("rea-v-nemudruj", "font_big", "Don`t think. Just push the rods.")
dialogStr("Не мисли. Просто бутай прътите.")
