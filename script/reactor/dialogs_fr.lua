...
dialogStr("Mon dieu, peux-tu voir cette chose rose ?")


dialogId("rea-v-coto", "font_big", "What could it be?")
dialogStr("Qu'est-ce que ça peut être ?")
...
dialogStr("A moins que bien sûr, ce réacteur fonctionne sur un principe complètement différent.")


dialogId("rea-m-mohl", "font_small", "It could, of course, be a nucleo-particle megadisruptor with ultramezon colliders.")
dialogStr("Il pourrait bien sûr être un surgénérateur d'explosions de particules nucléaires à hautes vélocités.")


dialogId("rea-v-tozni", "font_big", "That sounds reasonable...")
dialogStr("Ca semble raisonnable...")


dialogId("rea-m-anebo", "font_small", "Then again, maybe this isn`t a nuclear reactor.")
dialogStr("Alors, ce n'est peut-être pas un réacteur nucléaire.")


dialogId("rea-v-acoby", "font_big", "So what is it, then?")
dialogStr("Donc, qu'est-ce que c'est ?")
...
dialogStr("Mais comment reconnais-tu une explication rationnelle de ce qui n'en est pas ?")
...
dialogStr("Et bien, d'après toi, combien de soucoupe volante ont à bord un stand de tir? Et combien un générateur électrique ?")
...
dialogStr("J'espère que nous n'avons pas déclencher de réaction.")
