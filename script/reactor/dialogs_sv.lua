...
dialogStr("Tja, hur många flygande tefat, tror du, har en skyttebana ombord? Och hur många tror du har ett kraftverk?")
...
dialogStr("Jag hoppas att vi inte startar någon otrevlig reaktion.")


dialogId("rea-v-nemudruj", "font_big", "Don`t think. Just push the rods.")
dialogStr("Tänkt inte. Skjut bara på stavarna!.")
