...
dialogStr("Они выглядят несколько заряженными, или, может быть, регулирующими ядерный реактор.")

dialogId("rea-v-ledaze", "font_big", "Unless, of course, this reactor works on some completely different principle.")
dialogStr("Конечно, этот реактор работает совсем по другому принципу.")

dialogId("rea-m-mohl", "font_small", "It could, of course, be a nucleo-particle megadisruptor with ultramezon colliders.")
dialogStr("Это должно быть, конечно, ядерный мегаускоритель частиц с ультромезонинными магнитами.")
...
dialogStr("Я предпочитаю более рациональное объяснение.")
