...
dialogStr("О боже, ты видишь ту розовую штуку?")
...
dialogStr("Опять-таки, может это вообще не ядерный ректор.")
...
dialogStr("Откуда я знаю? Прожектор? Детская игрушка? Стрельбище?")

dialogId("rea-v-radeji", "font_big", "I’d rather stick to a more rational explanation.")
dialogStr("Я предпочитаю придерживаться более рационального объяснения.")

dialogId("rea-m-jakmuzes", "font_small", "But how do you know what’s a rational explanation and what isn’t?")
dialogStr("Но откуда ты знаешь, какое объяснение рациональное, а какое нет?")
...
dialogStr("Хорошо, сколько, как ты думаешь, летающих тарелок имеют на борту стрельбище? А сколько электростанции?")
...
dialogStr("Я надеюсь, что мы не запустим какую-нибудь неприятную реакцию.")

dialogId("rea-v-nemudruj", "font_big", "Don’t think. Just push the rods.")
dialogStr("Не думай. Просто двигай стержни.")
