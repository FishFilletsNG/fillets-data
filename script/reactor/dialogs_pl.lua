...
dialogStr("Według ciebie ile latających spodków ma na pokładzie strzelnicę, a ile - reaktor?")


dialogId("rea-v-takvidis", "font_big", "You see?")
dialogStr("Sama widzisz.")


dialogId("rea-m-doufam", "font_small", "I hope we don`t start some unpleasant reaction.")
dialogStr("Mam nadzieję, że nie wywołamy jakiejś reakcji łańcuchowej.")


dialogId("rea-v-nemudruj", "font_big", "Don`t think. Just push the rods.")
dialogStr("Nie mędrkuj, popychaj ogniwa.")
