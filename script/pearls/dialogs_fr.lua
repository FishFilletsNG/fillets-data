...
dialogStr("Nous ne sommes pas pêcheurs de perles.")


dialogId("jed-v-poslani2", "font_big", "Remember! We have a mission to complete.")
dialogStr("Secoue-toi ! Nous avons une mission à accomplir.")
...
dialogStr("Tu n'as pas dis que tu aimais les perles ?")
...
dialogStr("J'ai besoin d'une perle de plus.")
...
dialogStr("Encore une perle, s'il te plaît.")


dialogId("jed-m-perlorodka2", "font_small", "My dearest friend, couldn`t you possibly lend me just one little pearl?")
dialogStr("Mon plus cher ami, ne pourrais-tu pas me prêter juste une petite perle ?")
...
dialogStr("La rumeur affirme que Cléopatre dissolvait les perles dans le vinaigre.")


dialogId("jed-m-moc", "font_small", "Do you think we have too many of them?")
dialogStr("Penses-tu que nous en avons trop ?")


dialogId("jed-v-vzdelat", "font_big", "Well, I just wanted to educate you a little.")
dialogStr("Et bien, je voulais simplement apporter un peu de culture.")
