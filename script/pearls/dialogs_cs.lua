...
dialogStr("Tady se mi líbí.")


dialogId("jed-m-perly0", "font_small", "So many pearls.")
dialogStr("Takových perel.")
...
dialogStr("Potřebuju ještě jednu perlu.")
