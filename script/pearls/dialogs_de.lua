...
dialogStr("Ist das hübsch hier.")


dialogId("jed-m-perly0", "font_small", "So many pearls.")
dialogStr("So viele Perlen.")
...
dialogStr("Wir sind keine Perlentaucher.")


dialogId("jed-v-poslani2", "font_big", "Remember! We have a mission to complete.")
dialogStr("Denk dran! Wir müssen eine Aufgabe erfüllen.")
...
dialogStr("Ich brauche noch eine Perle.")
...
dialogStr("Kleopatra hat angeblich Perlen in Essig aufgelöst.")


dialogId("jed-m-moc", "font_small", "Do you think we have too many of them?")
dialogStr("Denkst du, wir haben welche zuviel?")


dialogId("jed-v-vzdelat", "font_big", "Well, I just wanted to educate you a little.")
dialogStr("Schon gut, ich wollte dir nur etwas beibringen.")
