...
dialogStr("We zijn geen parelduikers.")
...
dialogStr("Jij hangt daar maar een beetje en ik moet al het werk in mijn eentje doen!")


dialogId("jed-v-uzivat0", "font_big", "Didn’t you say that you like the pearls?")
dialogStr("Zei je niet dat je van parels hield?")


dialogId("jed-v-uzivat1", "font_big", "Aren’t you happy with so many pearls?")
dialogStr("Ben je niet blij met zo veel parels?")
...
dialogStr("Alsjeblieft, nog één parel!")
...
dialogStr("Heb je toevallig nog een knikker bij je?")
