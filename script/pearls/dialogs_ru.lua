...
dialogStr("Как красиво здесь.")

dialogId("jed-m-perly0", "font_small", "So many pearls.")
dialogStr("Так много жемчужин.")
...
dialogStr("Тебе не кажется, что у нас его слишком много?")

dialogId("jed-v-vzdelat", "font_big", "Well, I just wanted to educate you a little.")
dialogStr("Ну, я просто хотел немного просветить тебя.")
