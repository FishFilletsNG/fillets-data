...
dialogStr("Włączając morderstwo Johna Lennona i Meteoryt Tunguski.")
...
dialogStr("To ja już wiem, o co chodzi w tej grze.")


dialogId("ch-m-vubec", "font_small", "And also the meaning of life, the universe and everything.")
dialogStr("A także sens życia, wszechświata i w ogóle.")
