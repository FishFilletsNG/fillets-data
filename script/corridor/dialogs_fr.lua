...
dialogStr("Regarde ! Ce doit être... ROBOCHIEN !")
...
dialogStr("Et bien, maintenant je comprends tout.")
...
dialogStr("Et aussi le sens de la vie, de l'univers et du reste.")
...
dialogStr("Ne les écoute pas, joueur. Ils se moquent de toi.")


dialogId("ch-r-nevsimej1", "font_robodog", "Don`t listen to them, player. They are trying to be funny.")
dialogStr("Ne les écoute pas, joueur. Ils essaient d'être drôles.")
...
dialogStr("Et je n'ai visité Cuba qu'une seule fois.")


dialogId("ch-r-anavic1", "font_robodog", "And everybody knows somebody else murdered him, they can`t prove anything.")
dialogStr("Et tout le monde sait que quelqu'un d'autre l'a tué, ils ne peuvent pas tout prouver.")


dialogId("ch-r-anavic2", "font_robodog", "And who cares about a few soldiers.")
dialogStr("Et qui se soucie de quelques soldats.")
