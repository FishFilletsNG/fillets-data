...
dialogStr("Wydaje mi się idiotyczna.")


dialogId("odp-m-zda1", "font_small", "I think it looks inflatable.")
dialogStr("Wygląda na dmuchaną.")
...
dialogStr("U, nie ma tu żadnych animowanych przedmiotów.")
