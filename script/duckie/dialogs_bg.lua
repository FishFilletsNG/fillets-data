...
dialogStr("Това пате не ти ли изглежда подозрително?")

dialogId("odp-m-zda0", "font_small", "I think it looks dumb.")
dialogStr("Мисля, че изглежда глупаво.")
