...
dialogStr("Et soigneusement rangés au même endroit : le trésor et le Graal.")
...
dialogStr("Je pense que si c'était vraiment notre but, le jeu le ferait savoir au joueur (à la joueuse).")


dialogId("tru-v-stacit", "font_big", "But I have let them know. That could be enough.")
dialogStr("Mais je lui ai dit. Ça doit suffire.")


dialogId("tru-m-zpochybnit", "font_small", "But I have casted doubts on it. This could confuse them.")
dialogStr("Mais j'ai émis des doutes à ce propos. Ça pourrait le(la) perturber.")


dialogId("tru-v-nejspis", "font_big", "Well, all right. PROBABLY this is not what we are looking for.")
dialogStr("Et bien, d'accord. PROBABLEMENT que ce n'est pas ce que nous cherchons.")
...
dialogStr("Et si nous essayions de fermer ce coffre ?")
...
dialogStr("Essaie de pousser le couvercle.")
...
dialogStr("Nous pourrons nous réjouir si nous arrivons à nous en sortir nous-mêmes.")
...
dialogStr("Le trésor nous encombrerait.")


dialogId("tru-v-zrak", "font_big", "All this glinting is a sight for the eyes.")
dialogStr("Tout ces miroitements sont un régal pour les yeux.")


dialogId("tru-m-trpyt", "font_small", "Everything here gleams so. It makes me dizzy.")
dialogStr("Tout brille tant ici. Ça me fait tourner la tête.")
