...
dialogStr("Haben wir ihn endlich gefunden.")
...
dialogStr("Ich denke, wenn das wirklich unser Ziel wäre, würde das Programm es den Spieler wissen lassen.")


dialogId("tru-v-stacit", "font_big", "But I have let them know. That could be enough.")
dialogStr("Aber ich habe es ihn wissen lassen. Das könnte reichen.")


dialogId("tru-m-zpochybnit", "font_small", "But I have casted doubts on it. This could confuse them.")
dialogStr("Aber ich habe es angezweifelt. Das könnte ihn durcheinanderbringen.")
