...
dialogStr("De schat van kapitein Silver, natuurlijk.")


dialogId("tru-v-gral", "font_big", "The Holy Grail, of course.")
dialogStr("De Heilige Graal, natuurlijk!")


dialogId("tru-v-vkupe", "font_big", "It`s neatly in one place: the treasure and the Grail.")
dialogStr("Alles lekker makkelijk op één plek. De schat en de Graal.")
...
dialogStr("Ik denk dat als dit echt ons doel was, dat het spel dat aan de speler zou laten weten.")


dialogId("tru-v-stacit", "font_big", "But I have let them know. That could be enough.")
dialogStr("Maar, ik heb het aan de speler laten weten. Misschien is dat wel genoeg.")


dialogId("tru-m-zpochybnit", "font_small", "But I have casted doubts on it. This could confuse them.")
dialogStr("Maar ik heb twijfel gezaaid. Dat zou verwarrend kunnen zijn.")
...
dialogStr("We moeten blij zijn als we hier zelf uit zien te komen.")
...
dialogStr("Een schat meeslepen zou toch alleen maar onhandig zijn.")


dialogId("tru-v-zrak", "font_big", "All this glinting is a sight for the eyes.")
dialogStr("Al dit geglinster is wel prachtig, zeg.")
