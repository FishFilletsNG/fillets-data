...
dialogStr("Теперь Вы знаете правила и можете попрактиковаться. Время от времени мы будем давать подсказки.")

dialogId("pra-v-klesnout", "font_big", "I must not swim down now. And I cannot go up, either.")
dialogStr("Я не могу плыть вниз. Тем не менее, плыть вверх я тоже не могу.")

dialogId("pra-v-nahore", "font_big", "Hey, arrange it up there somehow. But be careful!")
dialogStr("Эй, размести её как-нибудь там. Только аккуратнее!")

dialogId("pra-m-nepohnu", "font_small", "I can’t move this. This is steel.")
dialogStr("Я не могу подвинуть это. Этот предмет сделан из стали.")

dialogId("pra-m-zpatky", "font_small", "Come back, you can’t go further!")
dialogStr("Возвращайся назад, ты не можешь плыть дальше!")
...
dialogStr("Просто помните, что мы можем двигать предметы, лежащие на спине напарника, при условии, что они сразу же упадут вниз или окажутся на твёрдой опоре.")

dialogId("pra-v-objet", "font_big", "What if I go the upper way?")
dialogStr("Что, если я пойду поверху?")

dialogId("pra-m-neradit", "font_small", "Shhhh. That’s too many hints.")
dialogStr("Тссс. Довольно подсказок.")

dialogId("pra-m-stava", "font_small", "Things like that happen sometimes.")
dialogStr("Порой случаются такие вещи.")

dialogId("pra-v-dopredu", "font_big", "Sometimes you have to think faaar ahead.")
dialogStr("Иногда необходимо думать далекооо наперёд.")

dialogId("pra-m-restart", "font_small", "And often you have to restart the level then.")
dialogStr("И часто приходится начинать уровень сначала.")

dialogId("pra-v-schvalne", "font_big", "We admit that we did this on purpose.")
dialogStr("Мы признаём, что сделали это специально.")

dialogId("pra-m-znovu", "font_small", "So that you could try it again - this time without any hints.")
dialogStr("Так что Вы можете попытаться пройти всё сначала. Только на этот раз без каких-либо подсказок.")
