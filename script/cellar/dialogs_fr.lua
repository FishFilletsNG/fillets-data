...
dialogStr("Tu connais déjà les règles. Maintenant tu peux t'exercer. Nous te donnerons quelques astuces de temps en temps.")


dialogId("pra-v-klesnout", "font_big", "I must not swim down now. And I cannot go up, either.")
dialogStr("Je ne dois pas nager vers le bas. Et je ne peux pas plus monter.")


dialogId("pra-v-nahore", "font_big", "Hey, arrange it up there somehow. But be careful!")
dialogStr("Hé, range les objets correctement. Fais attention !")


dialogId("pra-m-nepohnu", "font_small", "I can`t move this. This is steel.")
dialogStr("Je ne peux pas bouger ça. C'est en acier")


dialogId("pra-m-zpatky", "font_small", "Come back, you can`t go further!")
dialogStr("Reviens, tu ne peux pas aller plus loin !")
...
dialogStr("Un petit rappel, si nous ne pouvons pas pousser des objets que nous portons, nous pouvons néanmoins les faire tomber ou les pousser sur une structure solide.")


dialogId("pra-v-objet", "font_big", "What if I go the upper way?")
dialogStr("Et si je passais par le haut ?")


dialogId("pra-m-neradit", "font_small", "Shhhh. That`s too many hints.")
dialogStr("Chut. N'en dis pas trop.")


dialogId("pra-m-stava", "font_small", "Things like that happen sometimes.")
dialogStr("Ces situations arrivent parfois.")


dialogId("pra-v-dopredu", "font_big", "Sometimes you have to think faaar ahead.")
dialogStr("De temps à autre, tu devras prévoir de (très?) nombreux mouvements à l'avance.")


dialogId("pra-m-restart", "font_small", "And often you have to restart the level then.")
dialogStr("Et souvent tu devras tout recommencer.")


dialogId("pra-v-schvalne", "font_big", "We admit that we did this on purpose.")
dialogStr("Soyons honnêtes : nous l'avons fait exprès.")


dialogId("pra-m-znovu", "font_small", "So that you could try it again - this time without any hints.")
dialogStr("Allez, recommence le niveau - Sans aide cette fois.")
