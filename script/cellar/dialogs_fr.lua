...
dialogStr("Hum... C'est un piège. Si nous poussons le miel, nous serons écrasés par la canette de jus d'abricot.")


dialogId("pra-m-vyrazit", "font_small", "Couldn`t we push it aside with that axe?")
dialogStr("Ne pouvons nous pas utiliser cette hache ?")
...
dialogStr("Maintenant je ne peux pas prendre la hache, et la cannette nous bloque toujours.")
...
dialogStr("Si tu peux pousser cette boite jusqu'à moi, je ferai glisser la hache dessus et tout sera bon.")
...
dialogStr("Ca sent mauvais. Tu vas devoir tout recommencer.")


dialogId("pra-m-pustis", "font_small", "If you drop that and I stay here, I will never get out.")
dialogStr("Si tu le lâche et que je reste ici, je ne pourrais jamais sortir.")
...
dialogStr("Ici ? J'ai un peu peur. pourrais-je sortir ?")
...
dialogStr("Un petit rappel, nous ne pouvons pas pousser des objets que nous portons, nous pouvons les faire tomber ou les pousser sur une structure solide.")
...
dialogStr("De temps à autre, tu devras prévoir de nombreux mouvements à l'avance.")
...
dialogStr("D'accord, nous l'avons fait exprès.")
