...
dialogStr("Pravila že poznaš. Sedaj jih lahko vadiš. Vsake toliko časa ti bova kaj namignila.")

dialogId("pra-v-klesnout", "font_big", "I must not swim down now. And I cannot go up, either.")
dialogStr("Ne smem zaplavati niže. In višje tudi ne morem.")

dialogId("pra-v-nahore", "font_big", "Hey, arrange it up there somehow. But be careful!")
dialogStr("Hej, postavite ga nekam. Ampak bodite previdni!")

dialogId("pra-m-nepohnu", "font_small", "I can`t move this. This is steel.")
dialogStr("Tega ne morem premakniti. To je jeklo.")

dialogId("pra-m-zpatky", "font_small", "Come back, you can`t go further!")
dialogStr("Pridi nazaj, saj ne moreš več naprej!")
...
dialogStr("Samo zapomni si, da čeprav ne moreva potiskati predmetov drug drugemu na hrbet, jih lahko potisneva na kakšno trdno površino.")

dialogId("pra-v-objet", "font_big", "What if I go the upper way?")
dialogStr("Kaj pa če se premaknem višje?")

dialogId("pra-m-neradit", "font_small", "Shhhh. That`s too many hints.")
dialogStr("Šššššššš. To je preveč nasvetov.")

dialogId("pra-m-stava", "font_small", "Things like that happen sometimes.")
dialogStr("Takšne stvari se zgodijo od časa do časa.")

dialogId("pra-v-dopredu", "font_big", "Sometimes you have to think faaar ahead.")
dialogStr("Včasih moraš razmišljati daaaaaaaleč v prihodnost.")

dialogId("pra-m-restart", "font_small", "And often you have to restart the level then.")
dialogStr("In večkrat moraš potem ponovno začeti stopnjo.")

dialogId("pra-v-schvalne", "font_big", "We admit that we did this on purpose.")
dialogStr("Priznava, da sva to naredila namenoma.")

dialogId("pra-m-znovu", "font_small", "So that you could try it again - this time without any hints.")
dialogStr("Tako, da lahko začneš znova - tokrat brez kakršnihkoli nasvetov.")
