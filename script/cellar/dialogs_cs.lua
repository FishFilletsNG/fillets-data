...
dialogStr("Pravidla už znáš. Teď si je můžeš vyzkoušet v praxi. Budeme ti trochu radit.")


dialogId("pra-v-klesnout", "font_big", "I must not swim down now. And I cannot go up, either.")
dialogStr("Já například teď nesmím podklesnout dolů. A nahoru to také moc nejde.")
...
dialogStr("Když vyřešíš nějaký ucelený problém, můžeš si pozici uložit.")


dialogId("pra-m-reseni", "font_small", "But only if you are sure of your solution.")
dialogStr("Ale jen pokud jsi přesvědčen, že řešení je správné.")
...
dialogStr("Tohle vypadá špatně. Asi budeš muset místnost restartovat.")


dialogId("pra-m-pustis", "font_small", "If you drop that and I stay here, I will never get out.")
dialogStr("Jestli to pustíš a já zůstanu tady, nedostanu se už nikdy ven.")
