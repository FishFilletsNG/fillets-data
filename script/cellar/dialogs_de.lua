...
dialogStr("Du kennst die Regeln bereits. Jetzt kannst du sie üben. Wir werden dir gelegentlich Tipps geben.")


dialogId("pra-v-klesnout", "font_big", "I must not swim down now. And I cannot go up, either.")
dialogStr("Ich darf nicht nach unten schwimmen. Ich kann auch nicht nach oben.")


dialogId("pra-v-nahore", "font_big", "Hey, arrange it up there somehow. But be careful!")
dialogStr("He, Räum da oben mal ein bisschen auf. Aber sei vorsichtig!")


dialogId("pra-m-nepohnu", "font_small", "I can`t move this. This is steel.")
dialogStr("Das kann ich nicht bewegen. Das ist Stahl.")


dialogId("pra-m-zpatky", "font_small", "Come back, you can`t go further!")
dialogStr("Komm zurück, du kannst nicht weiter!")
...
dialogStr("Erinnere dich: Wir können uns zwar keine Gegenstände über den Rücken schieben, aber wir können Sie runter oder auf eine feste Oberfläche schubsen.")


dialogId("pra-v-objet", "font_big", "What if I go the upper way?")
dialogStr("Und was, wenn ich den oberen Weg nehme?")


dialogId("pra-m-neradit", "font_small", "Shhhh. That`s too many hints.")
dialogStr("Pssst. Das sind zu viele Tipps.")


dialogId("pra-m-stava", "font_small", "Things like that happen sometimes.")
dialogStr("Sowas passiert manchmal.")


dialogId("pra-v-dopredu", "font_big", "Sometimes you have to think faaar ahead.")
dialogStr("Manchmal musst du seeehr weit vorausdenken.")


dialogId("pra-m-restart", "font_small", "And often you have to restart the level then.")
dialogStr("Und häufig musst du dann die Ebene neustarten.")


dialogId("pra-v-schvalne", "font_big", "We admit that we did this on purpose.")
dialogStr("Wir geben zu, dass wir das mit Absicht getan haben.")


dialogId("pra-m-znovu", "font_small", "So that you could try it again - this time without any hints.")
dialogStr("So dass du nochmal versuchen kannst - ohne Tipps.")
