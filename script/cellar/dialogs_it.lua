...
dialogStr("Conosci già le regole. Ora puoi impratichirti. Ti daremo qualche suggerimento ogni tanto.")


dialogId("pra-v-klesnout", "font_big", "I must not swim down now. And I cannot go up, either.")
dialogStr("Adesso non posso spostarmi in giù. E neanche andare su.")
...
dialogStr("Se risolvi qualche parte specfica puoi salvare la partita in quella posizione.")


dialogId("pra-m-reseni", "font_small", "But only if you are sure of your solution.")
dialogStr("Ma solo se sei sicuro della tua soluzione.")
...
dialogStr("Brutto affare. Dovrai ricominciare il livello.")


dialogId("pra-m-pustis", "font_small", "If you drop that and I stay here, I will never get out.")
dialogStr("Se lo fai cadere e io me ne resto qui, non riuscirò mai ad uscire.")
