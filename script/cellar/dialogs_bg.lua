...
dialogStr("Вече знаете правилата. Сега можете да ги упражните. От време на време ще Ви даваме съвети.")

dialogId("pra-v-klesnout", "font_big", "I must not swim down now. And I cannot go up, either.")
dialogStr("Сега не трябва да плувам надолу. А и нагоре не мога.")

dialogId("pra-v-nahore", "font_big", "Hey, arrange it up there somehow. But be careful!")
dialogStr("Ей, подреди ги малко там горе. И внимавай!")

dialogId("pra-m-nepohnu", "font_small", "I can`t move this. This is steel.")
dialogStr("Това не мога да го преместя. Стоманено е.")
...
dialogStr("Само помнете: въпреки, че не можем да плъзгаме обекти по гърба на другия, можем да ги избутваме да паднат или да ги плъзгаме по някакъв друг обект или структура.")

dialogId("pra-v-objet", "font_big", "What if I go the upper way?")
dialogStr("Дали да мина отгоре?")

dialogId("pra-m-neradit", "font_small", "Shhhh. That`s too many hints.")
dialogStr("Шшшт. Много съвети станаха.")
...
dialogStr("Признаваме, че го направихме нарочно.")

dialogId("pra-m-znovu", "font_small", "So that you could try it again - this time without any hints.")
dialogStr("За да можете да опитате отново - този път без съвети.")
