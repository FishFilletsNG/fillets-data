...
dialogStr("Tu ya conoces las reglas. Ahora puedes ponerlas en práctica. Te daremos algunas pistas ocasionalmente.")


dialogId("pra-v-klesnout", "font_big", "I must not swim down now. And I cannot go up, either.")
dialogStr("No debo nadar hacia abajo ahora. Y tampoco puedo ir hacia arriba.")


dialogId("pra-v-nahore", "font_big", "Hey, arrange it up there somehow. But be careful!")
dialogStr("Hey, ordena un poco ahi de alguna forma. ¡Pero sé cuidadoso!")


dialogId("pra-m-nepohnu", "font_small", "I can`t move this. This is steel.")
dialogStr("No puedo mover esto. Esto es acero.")


dialogId("pra-m-zpatky", "font_small", "Come back, you can`t go further!")
dialogStr("Regresa, ¡No puedes ir más lejos!")
...
dialogStr("Sólo recuerda que aunque no podemos empujar objetos a lo largo de nuestras espaldas, podemos empujarlas para que caigan o en alguna estructura sólida.")


dialogId("pra-v-objet", "font_big", "What if I go the upper way?")
dialogStr("¿Qué pasa si voy por arriba?")


dialogId("pra-m-neradit", "font_small", "Shhhh. That`s too many hints.")
dialogStr("Shhht. Esas son muchas pistas.")


dialogId("pra-m-stava", "font_small", "Things like that happen sometimes.")
dialogStr("Cosas como esa algunas veces ocurren.")


dialogId("pra-v-dopredu", "font_big", "Sometimes you have to think faaar ahead.")
dialogStr("Algunas veces tienes que pensar muuuy hacia adelante.")


dialogId("pra-m-restart", "font_small", "And often you have to restart the level then.")
dialogStr("Y entonces tienes que reiniciar el nivel frecuentemente.")


dialogId("pra-v-schvalne", "font_big", "We admit that we did this on purpose.")
dialogStr("Admitimos que hicimos esto a propósito.")


dialogId("pra-m-znovu", "font_small", "So that you could try it again - this time without any hints.")
dialogStr("Así que podrías intentarlo nuevamente - esta vez sin ninguna pista.")
