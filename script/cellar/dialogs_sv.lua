...
dialogStr("Du känner redan till reglerna. Nu kan du prova på dem. Vi kommer att ge tips lite då och då.")


dialogId("pra-v-klesnout", "font_big", "I must not swim down now. And I cannot go up, either.")
dialogStr("Jag får inte simma nedåt nu. Och jag kan inte simma uppåt heller.")
...
dialogStr("Om du har löst någon del så kan du spara det läget.")


dialogId("pra-m-reseni", "font_small", "But only if you are sure of your solution.")
dialogStr("Men bara om du är säker på din sak.")
...
dialogStr("Det ser mycket dåligt ut. Du måste starta om.")


dialogId("pra-m-pustis", "font_small", "If you drop that and I stay here, I will never get out.")
dialogStr("Om du släpper den när jag är här så kommer jag aldrig ut.")
