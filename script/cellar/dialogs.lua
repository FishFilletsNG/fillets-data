...
dialog_addDialog("pra-v-klesnout", "cs", "sound/"..codename.."/cs/pra-v-klesnout.ogg", "font_big", "Já napøíklad teï nesmím podklesnout dolù. A nahoru to také moc nejde.")

dialog_addDialog("pra-v-nahore", "en", "", "font_big", "Hey, arrange it up there somehow. But be careful!")
dialog_addDialog("pra-v-nahore", "cs", "sound/"..codename.."/cs/pra-v-nahore.ogg", "font_big", "Hej, urovnej mi to tam nahoøe nìjak. Ale opatrnì!")
...
dialog_addDialog("pra-m-zpatky", "cs", "sound/"..codename.."/cs/pra-m-zpatky.ogg", "font_small", "Pojeï zpátky, dál nemù¾e¹!")
...
dialog_addDialog("pra-v-zapeklita", "cs", "sound/"..codename.."/cs/pra-v-zapeklita.ogg", "font_big", "Hmmm... zapeklitá vìc. Jakmile odstrèíme med, spadne na nás meruòková marmeláda.")
...
dialog_addDialog("pra-m-chytit", "cs", "sound/"..codename.."/cs/pra-m-chytit.ogg", "font_small", "Teï u¾ tu sekeru nemù¾u chytit, kdy¾ jsme tam dali sklenici.")

dialog_addDialog("pra-v-vzit", "en", "", "font_big", "You mustn`t push the axe!")
dialog_addDialog("pra-v-vzit", "cs", "sound/"..codename.."/cs/pra-v-vzit.ogg", "font_big", "Tu sekeru nemù¾e¹ vzít!")
...
dialog_addDialog("pra-m-prisun", "cs", "sound/"..codename.."/cs/pra-m-prisun.ogg", "font_small", "Kdy¾ mi sem pøisune¹ sklenici, hodím ji na ni, to bude v pohodì.")

dialog_addDialog("pra-v-problem", "en", "", "font_big", "If you solve some specific part you can save the position.")
dialog_addDialog("pra-v-problem", "cs", "sound/"..codename.."/cs/pra-v-problem.ogg", "font_big", "Kdy¾ vyøe¹í¹ nìjaký ucelený problém, mù¾e¹ si pozici ulo¾it.")

dialog_addDialog("pra-m-reseni", "en", "", "font_small", "But only if you are sure of your solution.")
dialog_addDialog("pra-m-reseni", "cs", "sound/"..codename.."/cs/pra-m-reseni.ogg", "font_small", "Ale jen pokud jsi pøesvìdèen, ¾e øe¹ení je správné.")

dialog_addDialog("pra-v-ukladani", "en", "", "font_big", "Remember what we have said about saving positions.")
dialog_addDialog("pra-v-ukladani", "cs", "sound/"..codename.."/cs/pra-v-ukladani.ogg", "font_big", "Nezapomeò, co jsme ti øíkali o ukládání pozice.")

dialog_addDialog("pra-m-uvazovat", "en", "", "font_small", "I shouldn`t be thinking about this.")
dialog_addDialog("pra-m-uvazovat", "cs", "sound/"..codename.."/cs/pra-m-uvazovat.ogg", "font_small", "O tomhle bych ani nemìla uva¾ovat.")

dialog_addDialog("pra-v-spatne", "en", "", "font_big", "This looks real bad. You are going to have to restart the level.")
dialog_addDialog("pra-v-spatne", "cs", "sound/"..codename.."/cs/pra-v-spatne.ogg", "font_big", "Tohle vypadá ¹patnì. Asi bude¹ muset místnost restartovat.")

dialog_addDialog("pra-m-pustis", "en", "", "font_small", "If you drop this and I`ll stay here, I will never get out.")
dialog_addDialog("pra-m-pustis", "cs", "sound/"..codename.."/cs/pra-m-pustis.ogg", "font_small", "Jestli to pustí¹ a já zùstanu tady, nedostanu se u¾ nikdy ven.")

dialog_addDialog("pra-v-zavazis", "en", "", "font_big", "You stand in my way there. Try to hide somewhere else.")
dialog_addDialog("pra-v-zavazis", "cs", "sound/"..codename.."/cs/pra-v-zavazis.ogg", "font_big", "Tam mi zavazí¹, zkus se schovat jinde.")
...
dialog_addDialog("pra-v-prekvapit", "cs", "sound/"..codename.."/cs/pra-v-prekvapit.ogg", "font_big", "Nech se pøekvapit.")

dialog_addDialog("pra-m-kniha", "en", "", "font_small", "We will give you a hint here, player. You have to put that book over there left.")
dialog_addDialog("pra-m-kniha", "cs", "sound/"..codename.."/cs/pra-m-kniha.ogg", "font_small", "Tady ti, hráèi, poradíme - tu knihu musí¹ dostat támhle vlevo.")

dialog_addDialog("pra-v-valec", "en", "", "font_big", "So that it will catch that steel cylinder when I push it.")
dialog_addDialog("pra-v-valec", "cs", "sound/"..codename.."/cs/pra-v-valec.ogg", "font_big", "Aby se na ní zachytil ten ocelový válec, a¾ do nìj strèím.")

dialog_addDialog("pra-m-jakudelat", "en", "", "font_small", "But we will not tell you how to do it.")
dialog_addDialog("pra-m-jakudelat", "cs", "sound/"..codename.."/cs/pra-m-jakudelat.ogg", "font_small", "Ale jak to udìlat, v tom ti nebudeme radit.")
...
dialog_addDialog("pra-v-nezapomen", "cs", "sound/"..codename.."/cs/pra-v-nezapomen.ogg", "font_big", "Jen nezapomeò, ¾e i kdy¾ po sobì nemù¾eme pøedmìty posouvat, mù¾eme je na nìco nasouvat a nebo je ze sebe shazovat.")
...
dialog_addDialog("pra-m-neradit", "cs", "sound/"..codename.."/cs/pra-m-neradit.ogg", "font_small", "Pssst. Øekli jsme neradit.")

dialog_addDialog("pra-m-stava", "en", "", "font_small", "Things like that happen sometimes.")
dialog_addDialog("pra-m-stava", "cs", "sound/"..codename.."/cs/pra-m-stava.ogg", "font_small", "To se tak nìkdy stává.")

dialog_addDialog("pra-v-dopredu", "en", "", "font_big", "Sometimes you have to think faaar ahead.")
dialog_addDialog("pra-v-dopredu", "cs", "sound/"..codename.."/cs/pra-v-dopredu.ogg", "font_big", "V téhle høe je potøeba myslet móc daleko dopøedu.")

dialog_addDialog("pra-m-restart", "en", "", "font_small", "And often you have to restart the level then.")
dialog_addDialog("pra-m-restart", "cs", "sound/"..codename.."/cs/pra-m-restart.ogg", "font_small", "Èasto se pak stává, ¾e musí¹ místnost restartovat.")

dialog_addDialog("pra-v-schvalne", "en", "", "font_big", "We admit that we did this on purpose.")
dialog_addDialog("pra-v-schvalne", "cs", "sound/"..codename.."/cs/pra-v-schvalne.ogg", "font_big", "Pøiznáváme, tohle jsme na tebe narafièili schválnì.")

dialog_addDialog("pra-m-znovu", "en", "", "font_small", "So that you could try it again - this time without any hints.")
dialog_addDialog("pra-m-znovu", "cs", "sound/"..codename.."/cs/pra-m-znovu.ogg", "font_small", "Aby sis to zkusil znovu - a tentokrát u¾ bez na¹ich rad.")
