...
dialogStr("Warte, die Ampel ist doch Rot!")
 
dialogId("budova-m", "font_small", "This is the building of Fish Detective Training Organization.")
dialogStr("Dies ist das Gebäude der Fisch Detektiv Trainingsorganisation.")

dialogId("rozkladaci-v", "font_big", "I think we can take it to pieces.")
dialogStr("Ich glaube, wir können es in Einzelteile zerlegen.")
...
dialogStr("Was machst du mit diesen kleinen Bällen, wenn die Antenne hier ist?")
...
dialogStr("Warum zerstören wir dieses Gebäude, wenn es klar ist, dass wir dem Seepferdchen einen Ball geben müssen?")

dialogId("rozbil-v", "font_big", "What? The traffic light is broken.")
dialogStr("Was? Die Ampel ist kaputt.")
