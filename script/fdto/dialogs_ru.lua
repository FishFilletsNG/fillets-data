...
dialogStr("Подожди, не видишь красный свет?")
...
dialogStr("Я думаю, мы можем разобрать его на части.")
...
dialogStr("Да, мы их самые выдающиеся агенты...")

dialogId("podvodou-v", "font_big", "...underwater.")
dialogStr("...под водой.")

dialogId("mene-m", "font_small", "You may be less able.")
dialogStr("Ты, должно быть, менее квалифицированный.")
...
dialogStr("Почему мы уничтожаем здание, когда очевидно, что шар нужно положить на эту лошадь?")

dialogId("rozbil-v", "font_big", "What? The traffic light is broken.")
dialogStr("Что? Светофор сломался.")
