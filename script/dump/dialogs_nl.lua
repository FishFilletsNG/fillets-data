...
dialogStr("We kruipen nu al zes velden lang door een vuilnisbelt.")


dialogId("sm-v-jine0", "font_big", "This one looks really very waste-like.")
dialogStr("Dit veld ziet er heel erg afval-achtig uit.")


dialogId("sm-v-jine1", "font_big", "But no, I think that there is something strange about it.")
dialogStr("Maar wacht, er is hier iets raars aan de hand.")
...
dialogStr("Gaat het wel een beetje?")


dialogId("sm-m-kramy0", "font_small", "This is a pile of garbage.")
dialogStr("Dat is een berg afval.")
...
dialogStr("Er is hier zo veel rotzooi.")


dialogId("sm-v-lod", "font_big", "Can you see that boat?")
dialogStr("Zie je die boot?")
...
dialogStr("Lijkentransport leverde niet meer genoeg geld op en dus zijn ze maar een recyclebedrijfje begonnen.")
...
dialogStr("Ik jog om af te vallen, sukkels!")
