...
dialogStr("Тук има толкова много мръсотия.")

dialogId("sm-v-lod", "font_big", "Can you see that boat?")
dialogStr("Виждаш ли онази лодка?")
...
dialogStr("Мъртвите вече не са печеливши и са започнали бизнес с рециклиране на отпадъци.")
...
dialogStr("Виж тези купища безполезни и странни останки... Всички те са били полезни вещи, изработени внимателно и с умение.")

dialogId("sm-m-namaloval", "font_small", "Or painted.")
dialogStr("Или изрисувани.")

dialogId("sm-v-marnost", "font_big", "Everything is in vain, like that medusa over there.")
dialogStr("Всичко е безполезно, например онази медуза ей там.")
...
dialogStr("Тренирам за отслабване, глупаци такива!")
