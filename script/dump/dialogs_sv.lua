...
dialogStr("Vi har krälat igen soptippar i sex nivåer nu.")


dialogId("sm-v-jine0", "font_big", "This one looks really very waste-like.")
dialogStr("Den här ser riktigt sopig ut.")


dialogId("sm-v-jine1", "font_big", "But no, I think that there is something strange about it.")
dialogStr("Men nej, jag tycker att det är något konstigt med den.")
...
dialogStr("Mår du bra?")


dialogId("sm-m-kramy0", "font_small", "This is a pile of garbage.")
dialogStr("Det här är en hög med skräp.")
...
dialogStr("Det finns så mycket skräp här.")


dialogId("sm-v-lod", "font_big", "Can you see that boat?")
dialogStr("Ser du båten?")
...
dialogStr("Liken gav inte längre avkastning så de startade ett återvinningsföretag.")
...
dialogStr("Kan du se samlingen av oanvändbara saker, konstiga grejer och avfall... Allt var användbara saker, noggrant och skickligt tillverkade.")


dialogId("sm-m-namaloval", "font_small", "Or painted.")
dialogStr("Eller målade.")


dialogId("sm-v-marnost", "font_big", "Everything is in vain, like that medusa over there.")
dialogStr("Allt är vansinnigt, som medusan där borta.")
...
dialogStr("Jag joggar för att gå ner i vikt, era dårar!")
