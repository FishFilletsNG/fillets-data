...
dialogStr("Ty jesteś normalny?")


dialogId("sm-m-kramy0", "font_small", "This is a pile of garbage.")
dialogStr("To tylko góra śmieci.")
...
dialogStr("Ależ tu brudno!")


dialogId("sm-v-lod", "font_big", "Can you see that boat?")
dialogStr("Widzisz tę łódkę?")
...
dialogStr("Wożenie trupów przestało się opłacać i założył z synem Komunalnik.")
...
dialogStr("Spójrz na ten zbiór gratów, dziwów i odpadków... kiedyś to wszystko były użyteczne rzeczy, precyzyjnie i z namaszczeniem wytworzone.")


dialogId("sm-m-namaloval", "font_small", "Or painted.")
dialogStr("Albo namalowane.")


dialogId("sm-v-marnost", "font_big", "Everything is in vain, like that medusa over there.")
dialogStr("Wszystko to na nic, jako ta meduza.")
...
dialogStr("Biegam, żeby schudnąć, głupku!")
