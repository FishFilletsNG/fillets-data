...
dialogStr("Siehst du diese Sammlung von nutzlosem Zeug, seltsamen Gegenständen und Abfall... All das waren mal nützliche Dinge, sorgfältig und kunstvoll hergestellt.")


dialogId("sm-m-namaloval", "font_small", "Or painted.")
dialogStr("Oder gemalt.")


dialogId("sm-v-marnost", "font_big", "Everything is in vain, like that medusa over there.")
dialogStr("Das ist alles sinnlos, wie diese Qualle da drüben.")
...
dialogStr("Schau sie dir doch mal an. Sie rennt auf der Stelle. Ist das nicht das passendste Beispiel für Sinnlosigkeit?")


dialogId("sm-x-meduza", "font_magenta", "I am jogging to lose weight, you fools!")
dialogStr("Ich jogge um abzunehmen, Ihr Deppen!")
