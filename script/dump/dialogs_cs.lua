...
dialogStr("Vidíš tu sbírku neužitečností, podivností a odpadků... Všechno to kdysi byly užitečné věci, které někdo pracně vyrobil.")


dialogId("sm-m-namaloval", "font_small", "Or painted.")
dialogStr("Nebo namaloval.")


dialogId("sm-v-marnost", "font_big", "Everything is in vain, like that medusa over there.")
dialogStr("Je to všechno marnost, jako ta medúza.")
...
dialogStr("Podívej se na ni. Běží stále vpřed a zůstává na místě. Není to snad nejkrásnější příklad toho, o čem jsem mluvil?")


dialogId("sm-x-meduza", "font_magenta", "I am jogging to lose weight, you fools!")
dialogStr("Běhám, abych zhubla, vy troubové!")
