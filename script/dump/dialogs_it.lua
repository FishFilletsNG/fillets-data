...
dialogStr("Vedi quella collezione di roba inutile, strani oggetti e rifiuti... Erano tutte cose utili, prodotte con cura e a abilità.")
...
dialogStr("Tutto è vano, come quella medusa lassù.")
...
dialogStr("Guardala. Continua a correre in una direzione ma resta sempre lì. Non è forse l'esempio più calzante di quello che stavo dicendo?")

dialogId("sm-x-meduza", "font_magenta", "I am jogging to lose weight, you fools!")
dialogStr("Corro per perdere peso, sciocchi!")
