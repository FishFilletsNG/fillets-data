...
dialogStr("Nous nageons à travers des décharges depuis six niveaux maintenant.")
...
dialogStr("Mais non, je pense qu'il y a quelque chose qui ne va pas.")
...
dialogStr("Tu te sens bien ?")


dialogId("sm-m-kramy0", "font_small", "This is a pile of garbage.")
dialogStr("C'est un tas d'ordures.")
...
dialogStr("Les corps n'étaient pas rentables et il a donc démarré une entreprise de recyclage.")
...
dialogStr("tu vois cette collection de camelote inutile, d'objets curieux et discordants... Tous ont été utiles, patiemment et habilement fabriqués.")
...
dialogStr("Tout en vain, comme cette méduse là-bas.")
...
dialogStr("Je fais du jogging pour perdre du poids, idiots !")
