...
dialogStr("Знаешь, что некоторые твои вопросы, в OGG формате, могут переполнить ОЗУ на ПК Дубна.")

dialogId("zx-m-necodosebe", "font_small", "But still, these games had something to them, didn’t they?")
dialogStr("Спокойно, эта игра немного другая, не считаешь?")
...
dialogStr("Одно большое преимущество в этой комнате в том, что в ней нет стали.")
