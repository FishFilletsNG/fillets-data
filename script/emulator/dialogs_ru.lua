...
dialogStr("Да, мне нравится, я чувствую веяние восьмибитной истории.")
...
dialogStr("О чем ты думаешь сейчас?")
...
dialogStr("Ну, я только что понял, что одна анимация нас двоих заполнит всю оперативную память ПК Дубна.")
...
dialogStr("Знаешь, что некоторые твои вопросы в OGG формате могут переполнить ОЗУ на ПК Дубна? И представь, сколько подобных звуков в этой игре.")

dialogId("zx-m-necodosebe", "font_small", "But still, these games had something to them, didn’t they?")
dialogStr("Но и в этих играх что-то было, не считаешь?")

dialogId("zx-m-knight", "font_small", "Can you see that Knight Lorer?")
dialogStr("Это \"Knight Lorer\"?")
...
dialogStr("Даже не знаю, смогу ли я сложить \"Jetpack\" снова.")

dialogId("zx-v-roboti", "font_big", "This line of robots looks familiar.")
dialogStr("Эта линия из роботов выглядит знакомо.")

dialogId("zx-m-highway", "font_small", "Oh sure, they are from the Highway Encounter.")
dialogStr("Конечно, это же из \"Highway Encounter\".")
...
dialogStr("Самое большое преимущество этой комнаты заключается в том, что в ней нет стали.")
