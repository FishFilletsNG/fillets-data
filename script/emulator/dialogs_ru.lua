...
dialogStr("Ты видишь эти пискли вокруг нас? Ты должен признать, ты чувствуешь ностальгию.")

dialogId("zx-v-hry", "font_big", "This is an opportunity to play the merry old games of ZX Spectrum.")
dialogStr("Это хорошая возможность радоваться старой игре на ZX Spectrum.")

dialogId("zx-m-premyslis", "font_small", "What are you thinking about now?")
dialogStr("Что ты думаешь об этом(сейчас)?")
...
dialogStr("Я пытаюсь реализовать анимацию в двух отдельных местах оперативной памяти на ПК Дубна.")
