...
dialogStr("Das ist die Gelegenheit, alte ZX-Spectrum-Spiele zu zocken.")


dialogId("zx-m-premyslis", "font_small", "What are you thinking about now?")
dialogStr("Worüber denkst du gerade nach?")
...
dialogStr("Nunja, mir ist gerade klar geworden, dass allein unsere Animation den Arbeitsspeicher des ZX Spectrum gefüllt hätte.")
