...
dialogStr("Nouja, ik realiseer me net dat de animaties van ons tweeën alleen al al het werkgeheugen van een ZX Spectrum zouden opeten.")
...
dialogStr("Weet je dat jouw vraag alleen al in WAV formaat het werkgeheugen zouden opmaken? En stel je eens voor hoeveel van dat soort geluiden er in dit spel zitten.")
...
dialogStr("Zie je die Knight Lorer?")
