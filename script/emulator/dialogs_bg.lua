...
dialogStr("Това е възможност да си припомним старите забавни игри за ZX Spectrum.")

dialogId("zx-m-premyslis", "font_small", "What are you thinking about now?")
dialogStr("За какво си мислиш?")
...
dialogStr("Ами, току-що осъзнах, че само нашите две анимации ще задръстят паметта на ZX Spectrum.")
...
dialogStr("Единственото предимство на това ниво е, че няма стоманени тръби.")
