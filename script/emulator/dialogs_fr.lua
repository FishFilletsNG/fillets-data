...
dialogStr("Ouais, Je me sens comme si je pouvais embrasser l'histoire du huit bits.")


dialogId("zx-m-pixel", "font_small", "Can you see that pixel graphic all around us? I must confess I feel nostalgic.")
dialogStr("Peux-tu voir ces graphiques pixélisés tout autour de nous ? Je dois avouer que ça me rend nostalgique.")
...
dialogStr("Et bien, je viens de réaliser que nos animations seules pourraient remplir la RAM du ZX Spectrum.")
...
dialogStr("Tu peux voir ce Knight Lorer ?")


dialogId("zx-v-manicminer", "font_big", "And that must be the Manic Miner.")
dialogStr("Et là ce doit être le Manic Miner.")
...
dialogStr("Bien sûr, ils viennent de Highway Encounter.")
