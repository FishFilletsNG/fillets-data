...
dialogStr("Tu peux nous contrôler avec les flèches, et utiliser la barre espace pour changer de poisson.")


dialogId("1st-m-navod4", "font_small", "Or you can control us with the mouse -- left-click somewhere and...")
dialogStr("Ou tu peux nous contrôler à la souris -- Clique quelque part et ...")
...
dialogStr("Ton but est de nous faire sortir tous les deux.")
...
dialogStr("Ouah, Tu le déplaces ! Je ne pourrais jamais faire ça !")
...
dialogStr("Peux-tu pousser un petit peu la chaise sur la gauche ?")
...
dialogStr("Tu dois appuyer sur la longue flèche du clavier.")
...
dialogStr("Oui, c'est bien plus marrant en Tchèque.")


dialogId("1st-v-najit", "font_big", "The restart option is also located on the control panel.")
dialogStr("L'option redémarrage se trouve aussi dans le panneau de contrôle.")
