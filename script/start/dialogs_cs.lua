...
dialogStr("Můžeš nás ovládat kurzorovými šipkami a mezerníkem mezi námi přepínat.")


dialogId("1st-m-navod4", "font_small", "Or you can control us with the mouse -- left-click somewhere and...")
dialogStr("A nebo myškou - někam ukaž levým tlačítkem a když tam můžeme dojet...")
...
dialogStr("No a tvým cílem by mělo být dostat nás oba ven.")
...
dialogStr("Hmmm... Pohneš s tím. To já bych nedokázala!")
