...
dialogStr("Или можете управлять при помощи мыши — щёлкните где-либо левой кнопкой, и...")
...
dialogStr("Ой! Это было ошибкой. Мы оба должны покинуть уровень, чтобы продолжить игру.")

dialogId("1st-v-nedostanu", "font_big", "There’s no way I can get out now. You’ll have to restart the level.")
dialogStr("Теперь я не смогу выбраться отсюда. Вам придётся перезапустить уровень.")
...
dialogStr("Возможность перезапуска уровня также доступна на панели управления.")
...
dialogStr("Я тяжёлый стальной цилиндр. Меня не так-то просто подвинуть. У такой маленькой рыбки, как вон та оранжевая, точно ничего не выйдет. Я без труда могу раздавить её.")
