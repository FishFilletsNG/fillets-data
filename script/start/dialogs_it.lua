...
dialogStr("Ma, se clicchi con il pulsante destro, proveremo ad andarci spostando gli oggetti in cui eventualmente incapperemo.")


dialogId("1st-m-navod8", "font_small", "Your goal should be to get both of us outside.")
dialogStr("Il tuo obiettivo dovrebbe essere di farci uscire entrambi.")


dialogId("1st-v-davej", "font_big", "And be careful not to hurt us. If you drop something on us or...")
dialogStr("Stando attento a non farci del male. Se ci fai cadere qualcosa addosso opp...")


dialogId("1st-m-nechtoho", "font_small", "Oh, stop it. We`ll tell him in the next level.")
dialogStr("Oh, smettila. Glielo diremo nel prossimo livello.")
...
dialogStr("Sono un pesante cilidro di acciao. E` difficile spostarmi. Un pesciolino esile come quello là arancione, semplicemente non ha speranza. Potrei schiacciarlo senza problemi.")
