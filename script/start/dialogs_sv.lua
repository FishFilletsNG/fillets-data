...
dialogStr("Och när du högerklickar någonstans så försöker vi att ta oss dit genom att knuffa undan allt som är i vägen.")


dialogId("1st-m-navod8", "font_small", "Your goal should be to get both of us outside.")
dialogStr("Ditt mål borde vara att få ut oss båda två.")


dialogId("1st-v-davej", "font_big", "And be careful not to hurt us. If you drop something on us or...")
dialogStr("Och var försiktig så att vi inte skadar oss. Om du tappar någonting på oss eller...")


dialogId("1st-m-nechtoho", "font_small", "Oh, stop it. We`ll tell him in the next level.")
dialogStr("Nej, sluta. Vi berättar på nästa nivå.")
...
dialogStr("Jag är en tung stålcylinder. Det är inte lätt att flytta på mig. En liten fisk, som den oranga där borta, har ingen chans. Jag kan slå sönder henne utan problem.")
