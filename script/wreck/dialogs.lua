...
dialog_addDialog("pot-m-soud", "cs", "sound/"..codename.."/cs/pot-m-soud.ogg", "font_small", "Z èeho tak soudí¹?")
...
dialog_addDialog("pot-v-slus", "cs", "sound/"..codename.."/cs/pot-v-slus.ogg", "font_big", "Moc ti to slu¹í.")

dialog_addDialog("pot-m-dik", "en", "", "font_small", "Thanks, you too.")
dialog_addDialog("pot-m-dik", "cs", "sound/"..codename.."/cs/pot-m-dik.ogg", "font_small", "Díky, tobì taky.")

dialog_addDialog("pot-v-cepic", "en", "", "font_big", "A very nice hat.")
dialog_addDialog("pot-v-cepic", "cs", "sound/"..codename.."/cs/pot-v-cepic.ogg", "font_big", "Moc slu¹ivá èepièka.")

dialog_addDialog("pot-m-klob", "en", "", "font_small", "Your stetson is quite good, too.")
dialog_addDialog("pot-m-klob", "cs", "sound/"..codename.."/cs/pot-m-klob.ogg", "font_small", "Tvùj klobouk taky ujde.")

dialog_addDialog("pot-v-hlave", "en", "", "font_big", "What is that on your head?")
dialog_addDialog("pot-v-hlave", "cs", "sound/"..codename.."/cs/pot-v-hlave.ogg", "font_big", "Co to má¹ na hlavì?")

dialog_addDialog("pot-m-zima", "en", "", "font_small", "My ears were freezing.")
dialog_addDialog("pot-m-zima", "cs", "sound/"..codename.."/cs/pot-m-zima.ogg", "font_small", "Byla mi zima na u¹i...")

dialog_addDialog("pot-m-pujc", "en", "", "font_small", "That`s some hat! Can I borrow it?")
dialog_addDialog("pot-m-pujc", "cs", "sound/"..codename.."/cs/pot-m-pujc.ogg", "font_small", "Ty má¹ ale klobouk! Pùjèí¹ mi ho?")

dialog_addDialog("pot-v-leda", "en", "", "font_big", "If you lend me yours.")
dialog_addDialog("pot-v-leda", "cs", "sound/"..codename.."/cs/pot-v-leda.ogg", "font_big", "Leda za èepièku.")
...
dialog_addDialog("pot-m-nezb", "cs", "sound/"..codename.."/cs/pot-m-nezb.ogg", "font_small", "Asi nám nezbude ne¾ vlézt do té lodi.")

dialog_addDialog("pot-m-dovn", "en", "", "font_small", "It looks like we have to go inside.")
dialog_addDialog("pot-m-dovn", "cs", "sound/"..codename.."/cs/pot-m-dovn.ogg", "font_small", "Asi budeme muset dovnitø.")
...
dialog_addDialog("pot-v-nikdo", "cs", "sound/"..codename.."/cs/pot-v-nikdo.ogg", "font_big", "Zdá se, ¾e tu nikdo není.")
...
dialog_addDialog("pot-v-ponur", "cs", "sound/"..codename.."/cs/pot-v-ponur.ogg", "font_big", "Cítí¹ tu ponurou atmosféru zániku a pomíjivosti?")
...
dialog_addDialog("pot-m-vidis", "cs", "sound/"..codename.."/cs/pot-m-vidis.ogg", "font_small", "Co tam vidí¹?")

dialog_addDialog("pot-v-vidim", "en", "", "font_big", "I can see many interesting levels which we`ll have to solve.")
dialog_addDialog("pot-v-vidim", "cs", "sound/"..codename.."/cs/pot-v-vidim.ogg", "font_big", "Vidím spoustu zajímavých místností, které budeme muset øe¹it.")
