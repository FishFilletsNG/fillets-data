...
dialogStr("Om du lånar ut din.")


dialogId("pot-m-velik", "font_small", "This sure is a big stetson.")
dialogStr("Det här en riktigt stor stetson.")
...
dialogStr("Det ser ut som om vi måste ta oss inåt.")
...
dialogStr("Håll tyst och simma. Gamla skeppsinredingar är högst intressanta.")


dialogId("pot-v-ponur", "font_big", "Can you sense that atmosphere of doom and decay?")
dialogStr("Kan du känna atmosfären av undergång och förruttnelse?")


dialogId("pot-m-hnil", "font_small", "No, just the mold.")
dialogStr("Nej, bara dy.")
