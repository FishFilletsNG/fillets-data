...
dialogStr("Дали това е корабът на капитан Силвър?")
...
dialogStr("Благодаря, и на теб.")

dialogId("pot-v-cepic", "font_big", "A very nice hat.")
dialogStr("Много хубава шапка.")
