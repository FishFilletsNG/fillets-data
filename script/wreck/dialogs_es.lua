...
dialogStr("¿Qué te hace pensar eso?")


dialogId("pot-v-jmeno", "font_big", "The title of this level.")
dialogStr("El título de este nivel.")
...
dialogStr("Si me dejas el tuyo.")


dialogId("pot-m-velik", "font_small", "This sure is a big stetson.")
dialogStr("Este seguro que es un gran sombrero stetson.")
...
dialogStr("Parece que tenemos que ir adentro.")
...
dialogStr("Deja de hablar y nada. Los interiores de las naves antiguas son lugares muy interesantes.")


dialogId("pot-v-ponur", "font_big", "Can you sense that atmosphere of doom and decay?")
dialogStr("¿Puedes sentir esa atmósfera de perdición y decadencia?")


dialogId("pot-m-hnil", "font_small", "No, just the mold.")
dialogStr("No, sólo el moho.")
