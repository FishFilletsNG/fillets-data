...
dialog_addDialog("let-v-oko", "cs", "sound/"..codename.."/cs/let-v-oko.ogg", "font_big", "Vidí¹ to oko? Nìmý svìdek tragédie... Nìkdo v dùvìøe usedl do letadla - a zùstalo z nìho jen sklenìné oko.")

dialog_addDialog("let-m-oko", "en", "", "font_small", "This is not a glass eye but gyroscope. At least in this level.")
dialog_addDialog("let-m-oko", "cs", "sound/"..codename.."/cs/let-m-oko.ogg", "font_small", "To není sklenìné oko, ale gyroskop. Aspoò v této místnosti.")

dialog_addDialog("let-m-sedadlo", "en", "", "font_small", "Seats. Why is there so many seats here?")
dialog_addDialog("let-m-sedadlo", "cs", "sound/"..codename.."/cs/let-m-sedadlo.ogg", "font_small", "Sedadla. Proè jsou tu v¹ude sedadla?")

dialog_addDialog("let-v-budrada", "en", "", "font_big", "Be thankful. Could you get out without them?")
dialog_addDialog("let-v-budrada", "cs", "sound/"..codename.."/cs/let-v-budrada.ogg", "font_big", "Buï ráda. Jak by ses jinak dostala ven?")
