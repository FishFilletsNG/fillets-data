...
dialogStr("Dobrý den, ryby. Tentokrát jde o záležitost mimořádného významu, proto se obracíme na vás jako na naše nejschopnější agenty pod vodou.")
...
dialogStr("Informátorům naší Fakt Děsně Tajné Organizace se podařilo získat několik amatérských záběrů mimozemského objektu, který se zřítil někam do vaší oblasti. Vaším úkolem, pokud ho přijmete, bude UFO najít a získat informace o principech a konstrukci mezihvězdného pohonu.")
...
dialogStr("Zároveň zkuste pohnout s našimi starými nevyřešenými případy. Především jsou to nejasnosti kolem potopení dávného mýtického města, shodou okolností v téže oblasti.")
...
dialogStr("S tím může souviset i záhada Bermudského trojúhelníku. Zjistěte, proč se v něm už po léta ztrácejí lodě a letadla.")
...
dialogStr("Navíc jedna ze ztracených lodí údajně patřila legendárnímu kapitánu Silverovi. Kolem tohoto slavného piráta je stále mnoho nejasností. Nás především zajímá mapa místa, kam zakopal své poklady.")
...
dialogStr("Jedním z nejdůležitějších úkolů je najít počítač, který v hlubinách ukryla nejmenovaná zločinná organizace. Obsahuje údaje o projektu, který by mohl změnit celý svět.")
...
dialogStr("Také je třeba zajistit tajemnou želvu, želvu korálovou, jež uprchla z nápravně výchovné laboratoře FDTO. Není ozbrojena, ale zřejmě má telepatické schopnosti.")
...
dialogStr("Byli jsme upozorněni, že jistá jaderná elektrárna se zbavuje radiaktivního odpadu nelegálním způsobem. Prověřte to.")


dialogId("kd-gral", "font_white", "And don`t forget to find the holy grail.")
dialogStr("A také nezapomeňte najít svatý grál.")
...
dialogStr("A jako vždy: Bude-li někdo z vašeho týmu uvězněn či zabit, Altar se od všeho distancuje a místnost bude restartována.")


dialogId("kd-znici", "font_white", "This disk will self-destruct in five seconds.")
dialogStr("Tento disk se zničí za pět sekund.")
