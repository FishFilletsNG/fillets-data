...
dialogStr("Buon giorno, pesci. Questo è un affare della massima importanza e per questo abbiamo scelto voi, i nostri più abili agenti subacquei.")
...
dialogStr("Dovreste anche provare a concludere alcuni dei nostri casi irrisolti. Siamo perlopiù interessati alle circostanze riguardanti l'affondamento della mitica città, che casualmente si trova nella stessa area.")
...
dialogStr("Questo caso potrebbe essere connesso al mistero del Triangolo delle Bermude. Scoprite perché così tanti velivoli e imbarcazioni sono scomparsi in quest'area negli ultimi decenni.")
...
dialogStr("Si dice che una di queste navi disperse appartenesse al leggendaro Capitan Silver. Ci sono ancora molti dubbi intorno a questo famoso pirata. Soprattutto, siamo interessati alla mappa che indica la posizione del suo tesoro nascosto.")
...
dialogStr("Uno dei vostri compiti più importanti è trovare il computer nascosto nelle profondità da una certa organizzazione criminale. Contiene dati a proposito di un progetto che potrebbe cambiare il mondo intero.")
...
dialogStr("Dovreste anche trovare e stanare la misteriosa tartaruga dei coralli, scappata delle sale interrogatorie della FDTO. Non è armata, ma sembra che possieda capacità telepatiche.")
...
dialogStr("Siamo stati informati che un certa centrale nucleare sta smaltendo illegalmente le sue scorie. Controllate.")


dialogId("kd-gral", "font_white", "And don`t forget to find the holy grail.")
dialogStr("Ah! E non dimenticate di trovare il Sacro Graal.")
...
dialogStr("E come al solito: se qualcuno di voi viene ferito o ucciso, la Altar negherà ogni coinvolgimento e il livello verrà ri-iniziato.")


dialogId("kd-znici", "font_white", "This disk will self-destruct in five seconds.")
dialogStr("Questo disco si autodistruggerà fra cinque secondi.")
