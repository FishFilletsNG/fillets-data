...
dialogStr("Het zou fijn zijn als jullie ook even kunnen kijken naar wat andere onopgeloste zaken. We zijn vooral geïnteresseerd in de omstandigheden omtrend het zinken van de legendarische stad, toevallig ook daar in de buurt.")
...
dialogStr("Deze zaak houdt wellicht verband met het mysterie van de Bermuda Driehoek. Achterhaal waarom er de afgelopen tientallen jaren zo veel schepen en vliegtuigen zijn verdwenen in deze omgeving.")
...
dialogStr("Een van jullie belangrijkste opdrachten is het vinden van de computer die door een bepaalde criminele organisatie in de diepte is verstopt. Er staat informatie op over een project dat de hele wereld zou kunnen veranderen.")
...
dialogStr("Jullie moeten ook de mysterieuze koraalschildpad zien te vinden en arresteren. Die is aan de VDTO ondervragingsafdeling ontsnapt. Hij is niet bewapend, maar is waarschijnlijk wel telepatisch.")
...
dialogStr("Dit bericht zal zichzelf over vijf seconden vernietigen.")
