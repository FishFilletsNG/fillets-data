...
dialog_addDialog("kd-uvod", "it", "", "font_white", "Buon giorno, pesci. Questo è un affare della massima importanza e per questo abbiamo scelto voi, i nostri più abili agenti subacquei.")
...
dialog_addDialog("kd-mesto", "it", "", "font_white", "Dovreste anche provare a concludere alcuni dei nostri casi irrisolti. Siamo perlopiù interessati alle circostanze riguardanti l'affondamento della mitica città, che casualmente si trova nella stessa area.")
...
dialog_addDialog("kd-bermudy", "it",  "", "font_white", "Questo caso potrebbe essere connesso al mistero del Triangolo delle Bermude. Scoprite perché così tanti velivoli e imbarcazioni sono scomparsi in quest'area negli ultimi decenni.")
...
dialog_addDialog("kd-silver", "it", "", "font_white", "Si dice che una di queste navi disperse appartenesse al leggendaro Capitan Silver. Ci sono ancora molti dubbi intorno a questo famoso pirata. Soprattutto, siamo interessati alla mappa che indica la posizione del suo tesoro nascosto.")
...
dialog_addDialog("kd-pocitac", "it", "", "font_white", "Uno dei vostri compiti più importanti è trovare il computer nascosto nelle profondità da una certa organizzazione criminale. Contiene dati a proposito di un progetto che potrebbe cambiare il mondo intero.")
...
dialog_addDialog("kd-zelva", "it", "", "font_white", "Dovreste anche trovare e stanare la misteriosa tartaruga dei coralli, scappata delle sale interrogatorie della FDTO. Non è armata, ma sembra che possieda capacità telepatiche.")
...
dialog_addDialog("kd-elektr", "it", "", "font_white", "Siamo stati informati che un certa centrale nucleare sta smaltendo illegalmente le sue scorie. Controllate.")
...
dialog_addDialog("kd-gral", "it", "", "font_white", "Ah! E non dimenticate di trovare il Sacro Graal.")
...
dialog_addDialog("kd-zaver", "it", "", "font_white", "E come al solito: se qualcuno di voi viene ferito o ucciso, la Altar negherà ogni coinvolgimento e il livello verrà ri-iniziato.")
...
dialog_addDialog("kd-znici", "it", "", "font_white", "Questo disco si autodistruggerà fra cinque secondi.")
