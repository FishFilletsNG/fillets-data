...
dialogStr("Dobro jutro, riba. To je zadeva najresnejšega pomena in zato smo izbrali tebe, našega najsposobnejšega podvodnega agenta.")
...
dialogStr("Agentje RDA - Ribja Detektivska Akademija - je uspela zbrati nekaj amaterskih posnetkov zunajzemeljskega predmeta, ki je zaletel nekje v vaši bližini. Vaša naloga je, če jo boste sprejeli, bo popravilo NLP-ja in zbiranje čimveč podatkov o načelih in načinu delovanja medzvezdnega pogona.")
...
dialogStr("Lahko tudi poskusite zaključiti, nekaj naših še nerešenih primerom. Najbolj nas zanimajo okoliščine, ki obkrožajo potopitev mističnega mesta, po naključju, v istem območju.")
...
dialogStr("Ta primer je mogoče povezan z skrivnostjo Bermudskega Trikotnika. Ugotovite zakaj je v prejšnjih desetletjih tam izginilo toliko ladij in letal.")
...
dialogStr("O eni izmed potopljenih ladij se govori, da je pripadala legendarnemu Kapitanu Srebru. Še vedno veliko neskladij obkroža tega slavnega pirata. Najbolj od vsega nas zanima zemljevid, ki prikazuje lokacijo njegovega zakopanega zaklada.")
...
dialogStr("Ena od vaših najbolj pomembnih nalog je, odkritje računalnika, ki je skrit v globinah v lasti kriminalne organizacije. Vsebuje podatke o projektu, ki bi lahko spremenil celoten svet.")
...
dialogStr("Morate tudi poiskati in pridržati skrivnostno koralno želvo. Pobegnila je iz Zasliševalnega objekta RDA. Ni oborožena, temveč domnevamo da ima telepatske sposobnosti.")
...
dialogStr("In kot ponavadi: Če je kdo iz vaše ekipe poškodovan ali ubit. Bo Altar zanikal kakršnokoli vedenje o vašem obstoju in stopnja se bo ponovno začela.")

dialogId("kd-znici", "font_white", "This disk will self-destruct in five seconds.")
dialogStr("Disk se bo samodejno uničil v petih sekundah.")
