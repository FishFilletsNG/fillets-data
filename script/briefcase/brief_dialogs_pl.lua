...
dialogStr("Dzień dobry, ryby. To jest sprawa wielkiej wagi, więc wybraliśmy was, naszych najzdolniejszych podwodnych agentów.")
...
dialogStr("Informatorom FDTO - Faktycznie Działającej Tajnej Organizacji - udało się przechwycić amatorskie zdjęcia obiektu pozaziemskiego, który rozbił się w waszej okolicy. Waszym zadaniem, jeśli się go podejmiecie, będzie odnalezienie UFO i pozyskanie wszelkich możliwych informacji o zasadach funkcjonowania i konstrukcji napędu międzygwiezdnego.")
...
dialogStr("Przy okazji możecie spróbować rozwiązać kilka z naszych starych spraw. Jesteśmy żywo zainteresowani okolicznościami zatonięcia mitycznego miasta, zbiegiem okoliczności w tej samej okolicy.")
...
dialogStr("Sprawa ta może być związana z tajemnica Trójkąta Bermudzkiego. Dowiedzcie się, dlaczego tak wiele statków i samolotów przez wieki zniknęło na tym obszarze.")
...
dialogStr("Wieść gminna niesie, że jeden z zaginionych statków należał do legendarnego kapitana Silvera. Postać tego pirata wciąż owiana jest mgiełką tajemnicy. Najbardziej interesuje nas mapa miejsca zakopania jego skarbu.")
...
dialogStr("Jednym z najważniejszych zadań stojących przed wami jest odnalezienie komputera, ukrytego w głębinach przez pewną organizację terrorystyczną. Zawiera on dane o projekcie, który może zmienić oblicze Ziemi.")
...
dialogStr("Powinniście również odnaleźć i pojmać tjemniczego żółwia koralowego, który zbiegł z pokoju przesłuchań FDTO. Nie jest uzbrojony, ale przypuszczalnie ma zdolności telepatyczne.")
...
dialogStr("Doniesiono nam, że pewna elektrownia atomowa składuje odpady radioaktywne na dnie oceanu. Sprawdźcie to.")


dialogId("kd-gral", "font_white", "And don`t forget to find the holy grail.")
dialogStr("I nie zapomnijcie odszukać Świętego Graala.")
...
dialogStr("I jak zawsze: jeśli ktoś z waszej drużyny zginie lub zostanie ranny, Altar wyprze się jakichkolwiek z wami powiązań i poziom zostanie zrestartowany.")


dialogId("kd-znici", "font_white", "This disk will self-destruct in five seconds.")
dialogStr("Ten dysk ulegnie samozniszczeniu w ciągu pięciu sekund.")
