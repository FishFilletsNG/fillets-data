...
dialogStr("Buenos días, peces. Este es un asunto de grave importancia así que los hemos escogido a ustedes, nuestros agentes submarinos más hábiles.")
...
dialogStr("Agentes de la FDTO - Federación de Detectives peces Tomando Observaciones - pudieron conseguir varias fotos aficionadas de un objeto extraterrestre que cayó en algún lugar en su vecindad. Su misión, si decide aceptarla, será recuperar el OVNI y adquirir toda la información que puedan acerca de los principios y naturaleza de la propulsión interestelar.")
...
dialogStr("También deberían de tratar de solucionar los casos aún no resueltos. Estamos muy interesados  en las circunstancias que rodean el hundimiento de una ciudad mítica, de casualidad en la misma área.")
...
dialogStr("Este caso podría estar conectado al misterio del Triángulo de las Bermudas. Encuentren la razón de porqué tantos barcos y aviones han desaparecido en esta área en varias décadas pasadas.")
...
dialogStr("Se rumorea que una de las naves perdidas perteneció al legendario Capitán Silver. Hay todavía muchas dudas que rodean a este famoso pirata. La mayoría de nosotros estamos interesados en el mapa que muestra la ubicación de su tesoro enterrado.")
...
dialogStr("Una de sus tareas más importantes es encontrar el computador escondido en las profundidades por cierta organización criminal. Este contiene datos acerca de un proyecto que podría cambiar el mundo entero.")
...
dialogStr("Deberías encontrar y detener también la misteriosa tortuga de coral. Escapó desde el lugar de interrogación de la FTDO. No está armada, pero supuestamente tiene habilidades telepáticas.")
...
dialogStr("Hemos sido notificados que una cierta planta de energía nuclear ha estado arrojando sus desechos radioactivos en forma ilegal. Revísenlo.")


dialogId("kd-gral", "font_white", "And don`t forget to find the holy grail.")
dialogStr("Y no olviden encontrar el Santo Grial.")
...
dialogStr("Y lo usual: Si cualquiera de su equipo es herido o muerto, Altar negará cualquier conocimiento de su existencia y el nivel será reiniciado.")


dialogId("kd-znici", "font_white", "This disk will self-destruct in five seconds.")
dialogStr("Este disco se autodestruirá en cinco segundos.")
