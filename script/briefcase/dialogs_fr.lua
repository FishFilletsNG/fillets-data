...
dialogStr("Oh non, ça recommence...")
...
dialogStr("Commençons par sortir de cette pièce.")
...
dialogStr("Devons-nous le regarder à nouveau ?")
...
dialogStr("Pour le moment ne touche à rien, regarde et apprends. Nous allons te montrer ce que tu peux et ne peux pas faire avec nous, ainsi que nos possibilités.")
...
dialogStr("En premier nous allons te montrer ce qui peut nous blesser.")


dialogId("help4", "font_big", "I`ll volunteer to be the dummy.")
dialogStr("Je suis volontaire pour être la victime.")
...
dialogStr("Nous ne pouvons pas nager vers le bas quand nous portons un objet, parce qu'il nous tomberait dessus.")
...
dialogStr("Nous ne pouvons pas non plus pousser des objets le long de notre dos.")
...
dialogStr("Une nouvelle fois nous chargeons la sauvegarde en appuyant sur la touche F3.")
...
dialogStr("Et contrairement à mon ami costaud, je ne peux pas bouger ou même porter des objet en acier.")
...
dialogStr("Nous chargeons notre sauvegarde pour la dernière fois. Nous allons te montrer ce que nous sommes capables de faire.")


dialogId("help15", "font_small", "We can always pick up objects and then let them fall.")
dialogStr("Nous pouvons toujours soulever des objets et les laisser tomber.")
...
dialogStr("... et même le laisser tomber sur nous dans ce cas.")


dialogId("help18", "font_small", "I can even do this alone... I can swim down under it... or put it on this ledge.")
dialogStr("Je peux le faire tout seul... Je peux nager vers le bas... ou le déposer sur cette bordure.")
...
dialogStr("Nous pouvons pousser un objet au dessus d'un autre que nous portons, mais nous ne pouvons pas bouger l'objet qui est directement sur notre dos.")


dialogId("help20", "font_big", "We can also swim freely under an object which we are supporting and pass it to the other fish.")
dialogStr("Nous pouvons nager librement sous un objet que nous supportons tous les deux et le passer à l'autre poisson.")
...
dialogStr("Voilà pour les règles. Si vous voulez en savoir plus, appuyer sur F1 et lisez l'aide.")
