...
dialogStr("Bonjour, Poisson. C'est une affaire de la plus haute importance et nous vous avons choisis, vous, nos meilleurs agents sous-marins.")
...
dialogStr("Vous devrez aussi résoudre quelques uns de nos dossiers non-classés. Nous sommes vraiment curieux de connaître dans quelles circonstances étonnantes la ville mythique a été engloutie, par chance au même endroit.")
...
dialogStr("Ce dossier est peut être lié au mystère du triangle des Bermudes. Découvrez pourquoi tant de bateaux et d'avions ont disparu là, depuis des décennies.")
...
dialogStr("La rumeur affirme qu'un des navires disparus a appartenu au légendaire capitaine Silver. Il reste beaucoup d'incertitudes à propos de ce célèbre pirate. Nous sommes particulièrement intéressés par la carte qui indique l'emplacement de son trésor.")
...
dialogStr("Une de vos principales missions est de trouver l'ordinateur caché dans les profondeurs par une certaine organisation criminelle. Il contient des données qui peuvent changer le monde entier.")
...
dialogStr("Ce message s'autodétruira dans 5 secondes.")
