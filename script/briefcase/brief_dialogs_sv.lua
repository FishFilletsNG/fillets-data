...
dialogStr("Agenter hos FDTO - FiskDetektivTräningsOrganisationen - har fått tag på flera amatörfoton av oidentifierade utomjordiska objekt som har kraschat i närheten av er. Ert uppdrag, om ni väljer att acceptera det, är att hitta UFOt och få tag i all information ni kan om principen och ursprunget till intergalaktisk drivkraft.")
...
dialogStr("Ni borde också försöka att lösa några av våra olösta fall. Vi är i första hand intresserade av händelseförloppet när den mystiska staden sjönk, av en händelse också i samma område.")
...
dialogStr("Det kan hänga ihop med mysterierna i Bermudatriangeln. Ta reda på varför så många skepp och flygplan har försvunnit där de senaste decennierna.")
...
dialogStr("Enligt rykten så ska ett av de försvunna skeppen ha tillhört kapten Silver. Det finns fortfarande många mysterier kring den ökände piraten. Framför allt är vi intresserade av kartan som visar var hans skatter är nergrävda.")
...
dialogStr("En av våra viktigaste uppgifter är att hitta datorn som är gömd i djupet av en kriminell organisation. Den innehåller data om projekt som skulle kunna förändra hela världen.")
...
dialogStr("Ni borde också hitta och ta fast den mystiska korallsköldpaddan. Den rymde från FDTOs förhörskomplex. Den är inte beväpnad men den tros ha telepatiska förmågor.")
...
dialogStr("Vi har blivit underrättade om ett visst kärnkraftverk som har dumpat sitt radioaktiva avfall illegalt. Kontrollera det.")


dialogId("kd-gral", "font_white", "And don`t forget to find the holy grail.")
dialogStr("Och glöm inte att leta efter den heliga gralen.")
...
dialogStr("Och som vanligt: Om någon i ert team skulle bli skadade eller dödade, kommer Altar att förneka all kännedom om er existens och nivån kommer att startas om.")


dialogId("kd-znici", "font_white", "This disk will self-destruct in five seconds.")
dialogStr("Den här disken kommer att utplåna sig själv om fem sekunder.")
