...
dialogStr("Pojď, vezmeme hráče do dílny a ukážeme mu pravidla bezpečnosti práce.")
...
dialogStr("Některé předměty mají takový tvar, že bych je mohla zároveň držet i posouvat - ale to také nesmím.")


dialogId("help11", "font_big", "Again, we load a saved game by pressing the F3 key.")
dialogStr("Znovu nahrajeme pozici klávesou F3.")


dialogId("help12", "font_small", "We also can`t drop additional objects on a pile that one of us is carrying.")
dialogStr("Nesmíme ani přihazovat předměty na hromádku, kterou někdo z nás drží.")


dialogId("help13", "font_small", "And unlike my bigger partner, I can`t move or even carry steel objects.")
dialogStr("A já, na rozdíl od většího kamaráda, nejen že nepohnu s ocelovými předměty, ale nesmím je ani držet.")
...
dialogStr("Naposledy jsme nahráli pozici. Teď ti ukážeme, co dělat umíme.")


dialogId("help15", "font_small", "We can always pick up objects and then let them fall.")
dialogStr("Předmět můžeme vždy zvedat a zase pouštět.")
...
dialogStr("Pokud se těsně před tím, než by nás měl zamáčknout, někde zachytí, můžeme ho i posouvat jedna po druhé...")


dialogId("help17", "font_small", "... and even let it drop on each other in this case.")
dialogStr("... a dokonce ho na sebe pouštět.")


dialogId("help18", "font_small", "I can even do this alone... I can swim down under it... or put it on this ledge.")
dialogStr("To mohu udělat i sama... podklesnu pod ním... a nebo jej nasunu támhle na tu polici.")
...
dialogStr("Já bych to ještě shrnula. Předměty můžeme beztrestně pouze zvedat, pouštět, posouvat po pevné podložce, na něco je nasouvat nebo je ze sebe shazovat.")
