...
dialogStr("Ich glaube, hier können wir ein paar Informationen über den intergalaktischen Antrieb bekommen.")


dialogId("mot-v-konvencni", "font_big", "This looks more like conventional propulsion for the landing craft.")
dialogStr("Das sieht eher wie ein gewöhnlicher Antrieb für das Landungsschiff aus.")
...
dialogStr("Ich bin ziemlich froh, dass wir hier nichts anschalten können.")
...
dialogStr("Was für eine Erleichterung.")
