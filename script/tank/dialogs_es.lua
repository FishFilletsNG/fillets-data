...
dialogStr("¿Un tanque anfibio? Solo imagina: En la noche sin luna, los defensores sin comprender miran el bosque de periscopios en forma confusa emergiendo desde la marea, buscando en vano la lancha de desembarque...")


dialogId("sv-v-proc", "font_big", "So why are you asking, if you are so darned clever?!")
dialogStr("¡¿Y porqué preguntas, si eres tan listo?!")


dialogId("sv-v-potopena", "font_big", "Maybe there is a sunken landing craft nearby.")
dialogStr("Quizás hay una lancha de desembarque hundida cerca.")


dialogId("sv-m-pravdepodob", "font_small", "It is possible.")
dialogStr("Es posible.")


dialogId("sv-m-munice", "font_small", "Do you think that this ammunition could harm us?")
dialogStr("¿Crees que estas municiones nos podrían hacer daño?")


dialogId("sv-v-nevim", "font_big", "I don`t know, but I`ll try to keep my distance from it.")
dialogStr("No lo sé, pero trataré de mantener mi distancia de eso.")


dialogId("sv-v-zebrik", "font_big", "I think we are going to need that ladder.")
dialogStr("Creo que vamos a necesitar esa escalera.")


dialogId("sv-m-ven", "font_small", "To climb out? But we have only fins.")
dialogStr("¿Para subir? Pero solo tenemos aletas.")


dialogId("sv-v-ucpat", "font_big", "No. To plug that hole.")
dialogStr("No. Para tapar ese agujero.")
