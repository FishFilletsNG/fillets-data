...
dialogStr("Танк-амфибия? Представи си само: В безлунната нощ, неразбиращите защитници озадачено наблюдават групата водолази, излизащи на брега, напразно търсейки десантния кораб...")

dialogId("sv-v-proc", "font_big", "So why are you asking, if you are so darned clever?!")
dialogStr("Като си толкова досетлива защо питаш?!")

dialogId("sv-v-potopena", "font_big", "Maybe there is a sunken landing craft nearby.")
dialogStr("Може би наблизо има и потънал десантен кораб.")

dialogId("sv-m-pravdepodob", "font_small", "It is possible.")
dialogStr("Възможно е.")
...
dialogStr("Мисля, че тази стълба ще ни трябва.")

dialogId("sv-m-ven", "font_small", "To climb out? But we have only fins.")
dialogStr("За да се изкачим навън? Но ние имаме само перки.")

dialogId("sv-v-ucpat", "font_big", "No. To plug that hole.")
dialogStr("Не. За да запълним онази дупка.")
