...
dialogStr("Das wird ja immer besser. Vom Tauchboot in den Panzer, das ist wie von der Angel ins Netz.")


dialogId("sv-v-bezsneku", "font_big", "At least there are no oh-so-obliging snails here.")
dialogStr("Zumindest sind hier keine ach-so-diensteifrigen Schnecken.")


dialogId("sv-m-utecha", "font_small", "That is but little consolation.")
dialogStr("Das ist aber nur ein schwacher Trost.")


dialogId("sv-v-chtel", "font_big", "Thinking about it, I always wanted to see the inside of a tank.")
dialogStr("Wenn ich so drüber nachdenke, wollte ich schon immer den Panzer von innen sehen.")


dialogId("sv-m-doscasu", "font_small", "It seems you will have plenty of opportunity to look around.")
dialogStr("Es scheint so, als wenn du dazu reichlich Gelegenheit haben wirst.")


dialogId("sv-m-tank", "font_small", "I wonder how this tank got into the sea.")
dialogStr("Wie ist dieser Panzer ins Meer gekommen?")


dialogId("sv-v-obojzivelny", "font_big", "Maybe it was an amphibious tank.")
dialogStr("Vielleicht war es ein Schwimmpanzer.")
...
dialogStr("Ein Meeresschwimmpanzer? Stell dir vor: In einer mondlosen Nacht, die verdatterten Verteidiger schauen fassungslos auf den aus der Brandung auftauchenden Wald aus Schnorcheln und suchen vergeblich das Landungsboot...")


dialogId("sv-v-proc", "font_big", "So why are you asking, if you are so darned clever?!")
dialogStr("Warum fragts du eigentlich, du Besserwisser?!")


dialogId("sv-v-potopena", "font_big", "Maybe there is a sunken landing craft nearby.")
dialogStr("Vielleicht ist das gesunkene Landungsboot in der Nähe.")


dialogId("sv-m-pravdepodob", "font_small", "It is possible.")
dialogStr("Möglich ist alles.")


dialogId("sv-m-munice", "font_small", "Do you think that this ammunition could harm us?")
dialogStr("Denkst du, dass diese Munition gefährlich ist?")


dialogId("sv-v-nevim", "font_big", "I don`t know, but I`ll try to keep my distance from it.")
dialogStr("Ich weiß nicht. Aber ich versuche ganz bestimmt, Abstand zu halten.")


dialogId("sv-v-zebrik", "font_big", "I think we are going to need that ladder.")
dialogStr("Ich glaube, wir werden diese Leiter brauchen.")


dialogId("sv-m-ven", "font_small", "To climb out? But we have only fins.")
dialogStr("Um rauszuklettern? Aber wir haben doch nur Flossen!")


dialogId("sv-v-ucpat", "font_big", "No. To plug that hole.")
dialogStr("Nein. Um das Loch zu stopfen.")
