...
dialogStr("Il y a de l'amélioration. Du bathyscaphe au char, c'est comme de la ligne au filet de pêche.")


dialogId("sv-v-bezsneku", "font_big", "At least there are no oh-so-obliging snails here.")
dialogStr("Au moins il n'y a pas ces escargots si attentionnés ici.")


dialogId("sv-m-utecha", "font_small", "That is but little consolation.")
dialogStr("C'est une bien maigre consolation.")
...
dialogStr("Un blindé marin ? Imagine : une nuit sans lune, des défenseurs surpris et désorientés voient une forêt de tuba sortir des vagues, cherchant en vain l'embarcation...")


dialogId("sv-v-proc", "font_big", "So why are you asking, if you are so darned clever?!")
dialogStr("Pourquoi demandes-tu, si tu es si fichtrement savant ?!")


dialogId("sv-v-potopena", "font_big", "Maybe there is a sunken landing craft nearby.")
dialogStr("Peut-être qu'il y a une embarcation échouée pas loin.")


dialogId("sv-m-pravdepodob", "font_small", "It is possible.")
dialogStr("C'est possible.")
...
dialogStr("Je pense que nous aurons besoin de cette échelle.")
...
dialogStr("Non, pour boucher ce trou.")
