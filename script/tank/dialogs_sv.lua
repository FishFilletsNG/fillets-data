...
dialogStr("En amfibietank? Tänk dig: En månfri natt, de oförstående försvararna som ser en skog av snorklar som kommer upp över ytan, förgäves sökande efter landfordon...")


dialogId("sv-v-proc", "font_big", "So why are you asking, if you are so darned clever?!")
dialogStr("Varför frågar du, om du nu är så smart?!")


dialogId("sv-v-potopena", "font_big", "Maybe there is a sunken landing craft nearby.")
dialogStr("De kanske finns ett sjunket landfordon i närheten.")
