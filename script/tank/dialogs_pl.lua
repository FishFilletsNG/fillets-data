...
dialogStr("Czołg-amfibia? Wyobraź sobie tylko: w bezksiężycową noc skonsternowani obrońcy nabrzeża bezskutecznie wypatrują wśród piany fal rozbijających się o brzeg łodzi, która wysadziła te wszystkie czołgi...")


dialogId("sv-v-proc", "font_big", "So why are you asking, if you are so darned clever?!")
dialogStr("To po co pytasz, skoro jesteś taka mądra?!")


dialogId("sv-v-potopena", "font_big", "Maybe there is a sunken landing craft nearby.")
dialogStr("Może gdzieś w pobliżu jest zatopiona łódź desantowa.")


dialogId("sv-m-pravdepodob", "font_small", "It is possible.")
dialogStr("To możliwe.")


dialogId("sv-m-munice", "font_small", "Do you think that this ammunition could harm us?")
dialogStr("Myślisz, że ta amunicja jeszcze może wybuchnąć?")


dialogId("sv-v-nevim", "font_big", "I don`t know, but I`ll try to keep my distance from it.")
dialogStr("Nie wiem. Ale postaram się zachować dystans.")


dialogId("sv-v-zebrik", "font_big", "I think we are going to need that ladder.")
dialogStr("Chyba będziemy potrzebować tej drabiny.")


dialogId("sv-m-ven", "font_small", "To climb out? But we have only fins.")
dialogStr("Żeby się po niej wspiąć? Ale my mamy tylko płetwy!")


dialogId("sv-v-ucpat", "font_big", "No. To plug that hole.")
dialogStr("Aby zatkać tę dziurę.")
