...
dialog_addDialog("sv-v-obojzivelny", "cs", "sound/"..codename.."/cs/sv-v-obojzivelny.ogg", "font_big", "Mo¾ná to byl oboj¾ivelný tank.")
...
dialog_addDialog("sv-m-kecy", "cs", "sound/"..codename.."/cs/sv-m-kecy.ogg", "font_small", "Moøský oboj¾ivelný tank? Úplnì to vidím pøed sebou: za bezmìsíèné noci se k pobøe¾í omývanému vlnami ¹írého oceánu blí¾í les ¹norchlù... a na píseèné plá¾e vyjí¾dìjí první obrnìnci... konsternovaní obránci nechápavì hledají loï, která je tu vysadila...")
...
dialog_addDialog("sv-v-potopena", "cs", "sound/"..codename.."/cs/sv-v-potopena.ogg", "font_big", "Mo¾ná je tu potopená výsadková loï.")
