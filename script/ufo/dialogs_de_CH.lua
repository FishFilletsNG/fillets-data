...
dialogStr("Weisst du, am meisten frage ich mich, warum sie genau hier abgestürzt sind.")


dialogId("ufo-m-nevim", "font_small", "I don`t know why the UFOs keep crashing at our house, either.")
dialogStr("Ich weiss auch nicht, warum die UFOs weiter auf unser Haus abstürzen.")
