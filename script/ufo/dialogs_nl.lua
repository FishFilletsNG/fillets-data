...
dialogStr("We moeten wel dicht het doel van deze missie zijn. Dit is vast de vliegende schotel die ons huis heeft platgewalst.")


dialogId("ufo-m-osmy", "font_small", "Are you sure? This is only the eighth level.")
dialogStr("Weet je het zeker? Dit is pas het achtste veld.")


dialogId("ufo-m-valce", "font_small", "These steel cylinders are pretty obnoxious.")
dialogStr("Deze stalen cylinders zijn behoorlijk vervelend.")


dialogId("ufo-m-moc", "font_small", "There is just too much steel here.")
dialogStr("Het stikt hier van het staal.")


dialogId("ufo-v-hur", "font_big", "It could be worse. I for one can imagine myself a room where there is nothing but steel.")
dialogStr("Het had erger gekund. Ik zou me in een kamer voorstellen waar alleen maar staal is.")
...
dialogStr("Het is wel interessant dat al staal onze de toegang tot de vliegende schotel effectiever ontzegt dan elk beveiligingssysteem.")


dialogId("ufo-v-rikam", "font_big", "I keep telling you that our life is controlled by some higher, strange consciousness.")
dialogStr("Ik zeg je toch steeds dat ons leven wordt gestuurd door een vreemd, hoger bewustzijn.")


dialogId("ufo-m-vidim", "font_small", "I can see that, too. But I am not that sure it`s higher.")
dialogStr("Dat snap ik ook wel. Maar ik ben er niet zo zeker van dat het hoger is.")


dialogId("ufo-v-dovnitr", "font_big", "What can we find inside, once we manage to get there?")
dialogStr("Wat zullen we daar binnen vinden, als het ons lukt om binnen te komen?")


dialogId("ufo-m-tajemstvi", "font_small", "Secrets of another civilization, new technologies, new sources of energy...")
dialogStr("Geheimen van andere beschavingen, nieuwe technologie, nieuwe energiebronnen...")


dialogId("ufo-v-zjistit0", "font_big", "Most importantly, we should try to find out why they came at all.")
dialogStr("Maar eerst moeten we erachter komen waarom ze hierheen zijn gekomen.")


dialogId("ufo-v-zjistit1", "font_big", "You know, most of all I wonder why they crashed just here.")
dialogStr("Weet je, ik vraag me vooral af waarom ze precies hier zijn neergestort.")


dialogId("ufo-m-tady", "font_small", "Didn`t you see it? Everything happens just here.")
dialogStr("Is het je niet opgevallen? Alles gebeurt toevallig precies hier.")
