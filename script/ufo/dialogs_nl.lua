...
dialogStr("We moeten wel dicht bij het doel van deze missie zijn. Dit is vast de vliegende schotel die ons huis heeft platgewalst.")
...
dialogStr("Er is hier gewoon te veel staal.")


dialogId("ufo-v-hur", "font_big", "It could be worse. I for one can imagine myself a room where there is nothing but steel.")
dialogStr("Het had erger kunnen zijn. Ik zou me in een kamer voorstellen waar alleen maar staal is.")
...
dialogStr("Het is wel interessant dat al dat staal ons de toegang tot de vliegende schotel effectiever ontzegt dan elk beveiligingssysteem.")
...
dialogStr("Dat zou kunnen. Maar ik ben er niet zo zeker van dat het hoger is.")
