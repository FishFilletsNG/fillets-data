...
dialogStr("I co my tam znajdziemy, gdy już dostaniemy się do środka?")


dialogId("ufo-m-tajemstvi", "font_small", "Secrets of another civilization, new technologies, new sources of energy...")
dialogStr("Tajemnice obcych cywilizacji, nowe technologie, nowe źródła energii...")


dialogId("ufo-v-zjistit0", "font_big", "Most importantly, we should try to find out why they came at all.")
dialogStr("Przede wszystkim musimy się dowiedzieć, po co oni w ogóle przylecieli.")
