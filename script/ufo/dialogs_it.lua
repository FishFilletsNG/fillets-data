...
dialogStr("Ci stiamo avvicinando alla fine della nostra missione. Questo dev'essere l'UFO che ci ha distrutto casa.")


dialogId("ufo-m-osmy", "font_small", "Are you sure? This is only the eighth level.")
dialogStr("Sicuro? Questo è appena l'ottavo livello.")


dialogId("ufo-m-valce", "font_small", "These steel cylinders are pretty obnoxious.")
dialogStr("Questi cilindri di acciaio sono piuttosto fastidiosi.")


dialogId("ufo-m-moc", "font_small", "There is just too much steel here.")
dialogStr("C'è troppo acciaio qui.")


dialogId("ufo-v-hur", "font_big", "It could be worse. I for one can imagine myself a room where there is nothing but steel.")
dialogStr("Poteva andare peggio. Prova a immaginare una stanza dove non c'è nient'altro che acciaio.")


dialogId("ufo-m-ne", "font_small", "My goodness! What should I do in such a level?")
dialogStr("Buon dio! Cosa potrei fare in un tale livello?")
