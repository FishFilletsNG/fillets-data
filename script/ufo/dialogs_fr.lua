...
dialogStr("Ces cylindres en acier sont odieux.")


dialogId("ufo-m-moc", "font_small", "There is just too much steel here.")
dialogStr("Il y a seulement trop d'acier ici.")


dialogId("ufo-v-hur", "font_big", "It could be worse. I for one can imagine myself a room where there is nothing but steel.")
dialogStr("Ca pourrait être pire. Pour ma part je peux très bien imaginer une pièce où il n'y aurait que de l'acier.")
...
dialogStr("Tu devras me laisser passer devant pour une fois.")
...
dialogStr("Je vois. Mais je ne suis pas sûr qu'elle soit supérieure.")
...
dialogStr("Tu sais, je me demande juste pourquoi ils se sont écrasés ici.")


dialogId("ufo-m-tady", "font_small", "Didn`t you see it? Everything happens just here.")
dialogStr("Tu n'as pas remarqué ? Simplement Tout se passe ici.")


dialogId("ufo-m-nevim", "font_small", "I don`t know why the UFOs keep crashing at our house, either.")
dialogStr("Je ne sais toujours pas pourquoi l'OVNI s'est écrasé sur notre maison.")
