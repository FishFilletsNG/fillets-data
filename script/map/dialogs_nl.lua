...
dialogStr("Mooi. De kaart is hier.")
...
dialogStr("Ja. Het zou te makkelijk zijn als we gewoon weg konden zwemmen.")


dialogId("map-m-neplacej", "font_small", "Don’t talk nonsense and try to think instead.")
dialogStr("Klep niet zo en denk na over ons probleem.")
...
dialogStr("Wat zou er op die kaart staan?")
...
dialogStr("We hebben nog meer van dit soort slakjes nodig.")


dialogId("map-x-hlemyzdi", "font_yellow", "You mean Escargots, don’t you?")
dialogStr("Je bedoelt Escargots, toch?")


dialogId("map-v-oci", "font_big", "We’d need more glass eyes.")
dialogStr("We hebben meer glazen ogen nodig.")
