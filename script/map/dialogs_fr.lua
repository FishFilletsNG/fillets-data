...
dialogStr("Notre but est clairement d'emporter cette carte.")
...
dialogStr("Ne dis pas n'importe quoi et essaie de réfléchir à la place.")


dialogId("map-v-ukol", "font_big", "Our goal is to get out that map somehow.")
dialogStr("Notre but est de trouver un moyen de faire sortir cette carte.")


dialogId("map-v-cojetam", "font_big", "What can be on that map?")
dialogStr("Qu'est-ce qu'il peut y avoir sur cette carte ?")


dialogId("map-v-poklady", "font_big", "Do you think that it really shows Silver`s treasure?")
dialogStr("Est-ce que tu penses qu'elle indique vraiment l'emplacement du trésor du Capitaine Silver ?")


dialogId("map-m-uvidime", "font_small", "We shall see when we manage to get the darned map out.")
dialogStr("Nous verrons quand nous réussirons à sortir cette satanée carte.")
...
dialogStr("Vous voulez dire Snails, n'est-ce pas ?")
...
dialogStr("La manière la plus simple serait de commencer de la partie supérieure du niveau. Essayons de le recommencer, peut-être que nous apparaîtrons là haut.")
...
dialogStr("Continuons sur notre lancée.")


dialogId("map-m-uz", "font_small", "Yes, it`s almost done.")
dialogStr("Oui, c'est presque fait.")
