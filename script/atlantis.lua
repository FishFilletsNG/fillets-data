...
createRoom(50, 35, "images/atlantis/spunt-p.png")
...
addItemAnim(wall, "images/atlantis/spunt-zed.png")
...
addItemAnim(spunt, "images/atlantis/spunt.png")
...
addItemAnim(item_heavy, "images/atlantis/2-ocel.png")
...
addItemAnim(item_heavy, "images/atlantis/5-ocel.png")
...
addItemAnim(item_heavy, "images/atlantis/6-ocel.png")

krab1 = addModel("item_light", 29, 1,
[[
XX
]])
addItemAnim(krab1, "images/atlantis/krab_00.png")
...
addItemAnim(item_light, "images/atlantis/sloupek_b.png")

item_light = addModel("item_light", 32, 25,
[[
XXXX
]])
addItemAnim(item_light, "images/atlantis/atikac.png")

item_heavy = addModel("item_heavy", 34, 24,
[[
X
]])
addItemAnim(item_heavy, "images/atlantis/12-ocel.png")

hlava3 = addModel("item_light", 33, 21,
[[
X
]])
addItemAnim(hlava3, "images/atlantis/hlava_m-_00.png")
...
addItemAnim(snecik1, "images/atlantis/maly_snek_00.png")
...
addItemAnim(item_heavy, "images/atlantis/15-ocel.png")
...
addItemAnim(item_heavy, "images/atlantis/19-ocel.png")

krab2 = addModel("item_light", 41, 18,
[[
XX
]])
addItemAnim(krab2, "images/atlantis/krab_00.png")
-- extsize=9; first="krab1.BMP"
...
addItemAnim(snecik2, "images/atlantis/maly_snek_00.png")
-- extsize=3; first="maly snek1.BMP"
...
addItemAnim(hlava2, "images/atlantis/hlava_m-_00.png")
-- extsize=2; first="hlava m-1.BMP"
...
addItemAnim(hlava1, "images/atlantis/hlava_m-_00.png")
-- extsize=2; first="hlava m-1.BMP"
