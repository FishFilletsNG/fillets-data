...
dialogStr("Regarde, que pouvons-nous trouver dans un tel dépotoir.")
...
dialogStr("Tu te trompes probablement. C'est un visage plutôt discret.")
...
dialogStr("Regarde cet chose. Quel monstre.")
...
dialogStr("Répugnant, glaireux, sale et sur le chemin.")
