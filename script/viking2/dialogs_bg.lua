...
dialogStr("Този кораб трябва да е потънал доста отдавна.")
...
dialogStr("Определено. Това е един от първите драккари. Съдейки по формата на носа, броя на спиралите и цвета на водата, мисля, че е принадлежал на прадядото на Червения Ерик.")

dialogId("dr1-v-olaf", "font_big", "Or to the father-in-law of Olaf the Brave.")
dialogStr("Или на тъста на Смелия Олаф.")

dialogId("dr1-v-leif", "font_big", "Or maybe to the great-uncle of Leif the Skillful.")
dialogStr("Или може би на прачичото на Умелия Лейф.")

dialogId("dr1-v-harold", "font_big", "It could also belong to the niece of Harold the Great.")
dialogStr("Може да е принадлежан и на пременницата на Великия Харолд.")

dialogId("dr1-v-snorr", "font_big", "Or possibly to the aunt of Snorr the Courageous.")
dialogStr("Или евентуално на лелята на Смелия Снор.")
...
dialogStr("Войникът трябва да вярва в командира си!")

dialogId("dr-1-achjo", "font_viking1", "Ahhh, I`m in charge of a ship full of cowards.")
dialogStr("Ах, отговарям за кораб пълен със страхливци.")
