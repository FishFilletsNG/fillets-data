...
dialogStr("Esta nave se debe de haber hundido desde hace mucho tiempo.")
...
dialogStr("Definitivamente. Es una de las drakkars más antiguas. Juzgando por la forma de la proa, el número de espirales y el color del agua pienso que perteneció al abuelo de Eric el Rojo.")


dialogId("dr1-v-olaf", "font_big", "Or to the father-in-law of Olaf the Brave.")
dialogStr("O al suegro de Olafo el Bravo.")


dialogId("dr1-v-leif", "font_big", "Or maybe to the great-uncle of Leif the Skillful.")
dialogStr("O quizás al tío abuelo de Leif el Hábil.")


dialogId("dr1-v-harold", "font_big", "It could also belong to the niece of Harold the Great.")
dialogStr("También podría pertenecer a la sobrina de Harold el Grande.")


dialogId("dr1-v-snorr", "font_big", "Or possibly to the aunt of Snorr the Courageous.")
dialogStr("O posiblemente a la tía de Snorr el Intrépido.")


dialogId("dr1-v-thorson", "font_big", "It is even possible it belonged to Thorson the Hard.")
dialogStr("Es incluso posible que perteneciera a Thorson el Duro.")
...
dialogStr("Yo siempre pensé que era el barco pesquero de Eric el Incapaz... Pero hoy supe la verdad. ¡Si, nunca es demasiado tarde para comenzar una nueva vida!")
...
dialogStr("N-no, t-t-trenzas son d-definitivamente m-m-mejor.")


dialogId("dr-3-mladez", "font_viking3", "Today’s youth - absolutely unbelievable.")
dialogStr("La juventud de hoy - absolutamente increíble.")


dialogId("dr-3-chlap", "font_viking3", "A warrior with braids. It’s unheard of.")
dialogStr("Un guerrero con trenzas. No había escuchado eso.")


dialogId("dr-3-mladi", "font_viking3", "You youngsters just think you can get away with anything today.")
dialogStr("Ustedes jóvenes nada más piensan que pueden salirse con la suya en todo hoy en día.")


dialogId("dr-4-stejne", "font_viking4", "Well, I still look cool.")
dialogStr("Bueno, yo todavía me veo bien.")
