...
dialogStr("Я всегда думала, что являюсь рыбной лодкой Ерика Неготового... Но сегодня я поняла истину. Да я никогда не опоздаю начать новую жизнь!")
...
dialogStr("Он выглядит плохо, но это не так страшно, потому что он находиться здесь около столетия.")
...
dialogStr("Вы сейчас сохранились?")
...
dialogStr("Мы уже в Валохале, вождь?")

dialogId("dr-2-uzbudeme2", "font_viking2", "When are we going to get to Valhalla?")
dialogStr("Когда мы доберёмся до Валохолы?")
...
dialogStr("Подожди, пока мы достигнем Валохалы.")

dialogId("dr-2-netrva", "font_viking2", "Isn’t this journey to Valhalla taking a bit too long?")
dialogStr("Это путешествие в Валохалу не выглядит несколько длинным?")
...
dialogStr("Клоуны, слюнявые щенки. Я думаю утоплю себя самостояетльно.")

dialogId("dr-3-spravny", "font_viking3", "Real Vikings have beards.")
dialogStr("Истинные викинги имеют бороду.")
...
dialogStr("Я просто не хочу соглашаться глупостью.")

dialogId("dr-3-radeji", "font_viking3", "You should stick to the Viking traditions instead.")
dialogStr("Ты должен быть планкой Викендских традиций.")
...
dialogStr("У в-в-великого Эрика б-б-была к-к-косичка!")
...
dialogStr("К-к-как думаешь, у меня д-д-должна быть б-б-борода и косичка?")
...
dialogStr("Н-не, к-к-косичка оп-п-пределённо г-г-готична.")
