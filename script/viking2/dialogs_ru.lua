...
dialogStr("Этот корабль, должно быть, затонул давным давно.")
...
dialogStr("Однозначно. Это один из ранних драккаров. Судя по форме головы, количеству спиралей и цвету воды, я думаю, он принадлежит деду Эрика Рыжего.")

dialogId("dr1-v-olaf", "font_big", "Or to the father-in-law of Olaf the Brave.")
dialogStr("Или тестю Олафа Храброго.")

dialogId("dr1-v-leif", "font_big", "Or maybe to the great-uncle of Leif the Skillful.")
dialogStr("Или, может быть, двоюродному дедушке Лейфа Счастливого.")

dialogId("dr1-v-harold", "font_big", "It could also belong to the niece of Harold the Great.")
dialogStr("Это также может принадлежать племяннице Харалда Прекрасноволосого.")

dialogId("dr1-v-snorr", "font_big", "Or possibly to the aunt of Snorr the Courageous.")
dialogStr("Или, возможно, тётке Снорра Смелого.")

dialogId("dr1-v-thorson", "font_big", "It is even possible it belonged to Thorson the Hard.")
dialogStr("Он даже может принадлежать Торсону Твёрдому.")
...
dialogStr("Я всегда думала, что являюсь рыбной лодкой Эрика Неготового... Но сегодня я поняла истину. Да, никогда не поздно начать новую жизнь!")
...
dialogStr("Что за детские фантазии? Косичка? С ума сойти!")
...
dialogStr("Ж-ж-журнал \"М-м-модный в-в-викинг\" р-р-рекомендует гламурную косичку и в дополнение чёрный шлем и синий щит.")

dialogId("dr-3-stakovou", "font_viking3", "I simply don’t agree with such a fad.")
dialogStr("Я просто не хочу соглашаться с таким бредом.")

dialogId("dr-3-radeji", "font_viking3", "You should stick to the Viking traditions instead.")
dialogStr("Ты должен придерживаться традиций Викингов.")

dialogId("dr-4-moderni", "font_viking4", "B-b-but I’m c-c-cool!")
dialogStr("Н-н-но я так г-г-готичен!")

dialogId("dr-4-erik", "font_viking4", "Even Erik the G-g-great Eric had a b-b-braid!")
dialogStr("Даже у в-в-великого Эрика б-б-была к-к-косичка!")
...
dialogStr("У него ещё б-б-была к-к-ккосичка.")
...
dialogStr("К-к-как думаешь, б-б-борода мне б-б-больше подойдёт?")

dialogId("dr-3-samozrejme", "font_viking3", "Definitely.")
dialogStr("Определёно.")

dialogId("dr-4-budu", "font_viking4", "I’ll th-th-think it o-over.")
dialogStr("Я д-д-думаю, это к-к-конец.")
...
dialogStr("Н-не, к-к-косичка оп-п-пределённо г-г-готичнее.")

dialogId("dr-3-mladez", "font_viking3", "Today’s youth - absolutely unbelievable.")
dialogStr("Нынешняя молодежь абсолютно невероятна.")
...
dialogStr("Вы, малолетки, просто думаете, что сегодня вам сойдет всё что угодно.")

dialogId("dr-4-stejne", "font_viking4", "Well, I still look cool.")
dialogStr("Да, я продолжаю выглядеть готично.")
