...
dialogStr("Hij ziet er heel niet slecht uit als je bedenkt dat hij hier al een paar eeuwen is.")


dialogId("dr-8-ztichni1", "font_viking8", "Shut up!")
dialogStr("Hou je bek!")
...
dialogStr("Baas, zijn we nou al in Valhalla?")
...
dialogStr("Een echte krijger heeft geduld.")


dialogId("dr-2-urcite", "font_viking2", "Are you sure this is how to get to Valhalla?")
dialogStr("Weet je zeker dat we zo bij Valhalla komen?")
...
dialogStr("T-t-tegenwoordig zijn v-vlechten weer in.")


dialogId("dr-3-cojeto", "font_viking3", "What kind of fad is that? Braids? For crying out loud.")
dialogStr("Wat is dat voor onzin? Vlechten? Laat me niet lachen!")
...
dialogStr("Z-z-zelfs Erik de G-g-grote Erik had een v-vlecht!")


dialogId("dr-3-nesmysl", "font_viking3", "Nonsense. He had a beard.")
dialogStr("Onzin. Hij had een baard.")
...
dialogStr("D-d-denk je dat een b-b-baard me b-b-beter zou staan?")
