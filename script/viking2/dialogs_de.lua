...
dialogStr("Oder dem Schwiegervater von Olaf dem Tapferen.")


dialogId("dr1-v-leif", "font_big", "Or maybe to the great-uncle of Leif the Skillful.")
dialogStr("Oder vielleicht dem Großonkel von Leif dem Geschickten.")


dialogId("dr1-v-harold", "font_big", "It could also belong to the niece of Harold the Great.")
dialogStr("Es könnte auch der Nichte von Harold dem Großen gehören.")


dialogId("dr1-v-snorr", "font_big", "Or possibly to the aunt of Snorr the Courageous.")
dialogStr("Oder möglicherweise der Tante von Snorr dem Mutigen.")
...
dialogStr("Chef, kann ich mich mal erleichtern gehen?")
...
dialogStr("Ein echter Kämpfer hat Geduld.")


dialogId("dr-2-urcite", "font_viking2", "Are you sure this is how to get to Valhalla?")
dialogStr("Bist du sicher, dass man so nach Walhalla kommt?")
...
dialogStr("Sogar Erik der G-g-große hatte ein Z-z-zopf!")


dialogId("dr-3-nesmysl", "font_viking3", "Nonsense. He had a beard.")
dialogStr("Blödsinn. Er hatte einen Bart.")
...
dialogStr("D-d-denkst du ein B-b-bart würde mir b-b-besser stehen?")
...
dialogStr("Ihr jungen Burschen denkt wohl, ihr könnt Euch alles erlauben.")


dialogId("dr-4-stejne", "font_viking4", "Well, I still look cool.")
dialogStr("Na gut, ich sehe immer noch cool aus.")
