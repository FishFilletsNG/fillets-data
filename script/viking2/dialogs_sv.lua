...
dialogStr("Det här skeppet måste ha sjunkit för länge sedan.")
...
dialogStr("Definitivt. Det är ett av de tidigaste långskeppen. Att döma av formen på huvudet, antalet spiraler och färger på vattnet skulle jag tro att det tillhörde Erik den rödes farfar.")


dialogId("dr1-v-olaf", "font_big", "Or to the father-in-law of Olaf the Brave.")
dialogStr("Eller Olaf den tappres svärfar.")


dialogId("dr1-v-leif", "font_big", "Or maybe to the great-uncle of Leif the Skillful.")
dialogStr("Eller kanske Leif den kluriges farbrors far.")


dialogId("dr1-v-harold", "font_big", "It could also belong to the niece of Harold the Great.")
dialogStr("Den kan också ha tillhört Harald den stores syster dotter.")


dialogId("dr1-v-snorr", "font_big", "Or possibly to the aunt of Snorr the Courageous.")
dialogStr("Eller möjligtvis Snorre den modiges faster.")


dialogId("dr1-v-thorson", "font_big", "It is even possible it belonged to Thorson the Hard.")
dialogStr("Det är också möjligt att den tillhörde Thorson den hårde.")
...
dialogStr("Jag har alltid trott att jag var Erik den ofärdiges fiskebåt... Men idag har jag fått veta sanningen. Ja, det är aldrig försent att starta ett nytt liv!")


dialogId("dr-m-podivej", "font_small", "Look at that poor dog.")
dialogStr("Titta på den stackars hunden.")


dialogId("dr-m-nedycha", "font_small", "Doesn't he seem to be breathing kind of strangely?")
dialogStr("Ser han inte ut att andas lite konstigt?")


dialogId("dr-v-napsa", "font_big", "For a dog under water I think he's doing rather well.")
dialogStr("För en hund under vattnet så tycker jag han klarar sig bra.")


dialogId("dr-v-nato", "font_big", "He doesn't look all that bad considering that he's been here for a few centuries.")
dialogStr("Han ser faktiskt inte så dålig ut med tanke på att han har varit här i århundraden.")
