...
dialogStr("Det finns ytterst intressanta saker i den här staden!")


dialogId("ves-m-krab", "font_small", "The poor crab!")
dialogStr("Stackars krabba!")


dialogId("ves-v-vyp", "font_big", "We should turn it off!")
dialogStr("Vi borde stänga av musiken!")
