...
dialogStr("Il y a des choses plus intéressantes dans la cité !")


dialogId("ves-m-krab", "font_small", "The poor crab!")
dialogStr("Pauvre crabe !")
...
dialogStr("Mais nous devons le faire tomber de toute façon.")


dialogId("ves-hs-hrajeme", "font_statue", "Now listen to the bit of music!")
dialogStr("Maintenant écoutons un peu de musique !")
