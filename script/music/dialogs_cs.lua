...
dialogStr("V tomhle městě se teda najdou věci!")


dialogId("ves-m-krab", "font_small", "The poor crab!")
dialogStr("Chudáček krab!")


dialogId("ves-v-vyp", "font_big", "We should turn it off!")
dialogStr("Měli bychom to vypnout!")
