...
dialogStr("Es gibt hochinteressante Sachen in dieser Stadt!")


dialogId("ves-m-krab", "font_small", "The poor crab!")
dialogStr("Die arme Krabbe!")


dialogId("ves-v-vyp", "font_big", "We should turn it off!")
dialogStr("Wir sollten die Musik ausmachen!")
...
dialogStr("Wir müssen die Lautsprecher sowieso runterschieben.")


dialogId("ves-hs-hrajeme", "font_statue", "Now listen to the bit of music!")
dialogStr("Erfreut Euch der Musik!")
