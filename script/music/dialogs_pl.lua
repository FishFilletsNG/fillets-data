...
dialogStr("W tym mieście można znaleźć bardzo ciekawe rzeczy.")


dialogId("ves-m-krab", "font_small", "The poor crab!")
dialogStr("Biedny krab!")


dialogId("ves-v-vyp", "font_big", "We should turn it off!")
dialogStr("Wyłączmy to!")
