...
dialogStr("Я, какви интересни неща имало в града!")

dialogId("ves-m-krab", "font_small", "The poor crab!")
dialogStr("Горкото раче!")

dialogId("ves-v-vyp", "font_big", "We should turn it off!")
dialogStr("Трябва да го изключим!")
