...
dialogStr("¡Hay cosas muy interesantes en esta ciudad!")


dialogId("ves-m-krab", "font_small", "The poor crab!")
dialogStr("¡El pobre cangrejo!")


dialogId("ves-v-vyp", "font_big", "We should turn it off!")
dialogStr("¡Deberíamos apagarlo!")
