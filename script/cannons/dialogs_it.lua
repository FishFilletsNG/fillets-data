...
dialogStr("Vedi? Questa nave aveva due ponti di artiglieria. Doveva essere una corvetta. L'acre odore di polvere da sparo sembra ancora aleggiare nell'aria...")


dialogId("del-m-voda", "font_small", "You mean, in the water.")
dialogStr("Vorrai dire nell'acqua.")


dialogId("del-m-ci", "font_small", "Whose ship was she? Maybe she served under admiral Nelson... or captain Hornblower.")
dialogStr("Di chi era questa barca? Forse servì sotto il comando dell'Ammiraglio Nelson... o del Capitano Hornblower.")


dialogId("del-v-splet", "font_big", "No, I think you’re about a hundred years off.")
dialogStr("No, penso che tu sia fuori di circa un cent'anni.")


dialogId("del-v-mec", "font_big", "I have a feeling we’re going to need that sword.")
dialogStr("Sento che avremo bisogno di quella spada.")


dialogId("del-m-tus", "font_small", "You and your 'feelings’. Besides, we’re not supposed to be giving any hints.")
dialogStr("Tu e i tuoi presentimenti. Tra l'altro, noi non dovremmo dare nessun suggerimento.")


dialogId("del-m-jedn0", "font_small", "That was a little too simple, wasn’t it?")
dialogStr("È stato un po' troppo facile, no?")


dialogId("del-m-jedn1", "font_small", "Could it possibly be so simple?")
dialogStr("Possibile che sia così semplice?")


dialogId("del-m-jedn2", "font_small", "There must be some kind of mistake.")
dialogStr("Dev'esserci qualche inghippo.")
