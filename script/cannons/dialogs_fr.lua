...
dialogStr("Tu vois ? Ce navire possède plusieurs canons. Ce devait être un navire de guerre. L'odeur acre de la poudre semble flotter dans l'air...")


dialogId("del-m-voda", "font_small", "You mean, in the water.")
dialogStr("Tu veux dire dans l'eau.")
...
dialogStr("Non, je pense que tu te trompes de siècle.")
