...
dialogStr("Видишь? Этот корабль имеет две пушки на палубе. Это должно быть военный корабль. Едкий запах пороха витает в воздухе...")

dialogId("del-m-voda", "font_small", "You mean, in the water.")
dialogStr("Ты имел ввиду в воде.")

dialogId("del-m-ci", "font_small", "Whose ship was she? Maybe she served under admiral Nelson... or captain Hornblower.")
dialogStr("Чей это корабль? Может быть это адмирала Нельсона... или капитана Хорнбловера.")

dialogId("del-v-splet", "font_big", "No, I think you’re about a hundred years off.")
dialogStr("Нет, я думаю ему уже больше сотни лет.")
