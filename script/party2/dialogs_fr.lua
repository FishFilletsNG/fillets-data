...
dialogStr("Ce bateau fantôme, encore.")


dialogId("pt2-v-zmena", "font_big", "Can you see it? Something has changed while we were away. I tell you, somebody is watching us.")
dialogStr("Tu peux le voir ? Quelque chose a changé depuis que nous sommes partis. Je te dis que quelqu'un nous regarde.")
...
dialogStr("On dirait qu'ils arrivent à la fin de leur pique-nique.")
...
dialogStr("Une sorte de pique-nique par le bas.")
...
dialogStr("Je pense qu'ils n'auront plus l'idée de nous blesser maintenant.")


dialogId("pt2-v-nemohou1", "font_big", "I think they are quite harmless now.")
dialogStr("Je pense qu'ils sont sans danger maintenant.")
