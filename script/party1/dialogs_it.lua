...
dialogStr("Guarda. La nave delle feste.")
...
dialogStr("Forse avevi ragione. Questo pic-nic è un po' strano.")
...
dialogStr("Smettila di pensarci e muovi le pinne cosicché possiamo uscire.")
...
dialogStr("Attenta a non versarne!")
