...
dialogStr("Misschien sproeit die lucht, net als in een bubbelbad.")
...
dialogStr("Nou nee. Maar we zouden hem naar beneden kunnen duwen.")


dialogId("br-m-poklady", "font_small", "Now this is real treasure.")
dialogStr("Dit is pas een echte schat!")


dialogId("br-v-nechat", "font_big", "We should have left it alone.")
dialogStr("We hadden van dat ding af moeten blijven.")
...
dialogStr("Dat is vast leuker dan een achtbaan.")
