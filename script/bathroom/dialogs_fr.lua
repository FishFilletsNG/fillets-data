...
dialogStr("Nous les appelons les sans-coquilles.")
...
dialogStr("Crois-tu que nous pourrons ouvrir le robinet ?")


dialogId("br-v-shodit", "font_big", "Hardly. But we could push it down.")
dialogStr("Difficilement. Mais nous pouvons la faire tomber.")
