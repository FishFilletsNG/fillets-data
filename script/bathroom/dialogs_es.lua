...
dialogStr("¿Qué piensas, vivirá alguien aquí?")


dialogId("br-v-santusak", "font_big", "Some underwater homeless.")
dialogStr("Algún vago sin hogar submarino.")


dialogId("br-m-podvodnik", "font_small", "We call them shell-less.")
dialogStr("Nosotros los llamamos \"Sin concha\".")
