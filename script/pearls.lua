...
createRoom(33, 32, "images/pearls/jednicky-p.png")
...
addItemAnim(wall, "images/pearls/jednicky-w.png")
...
addItemAnim(zeva, "images/pearls/zeva_00.png")
...
addItemAnim(item_light, "images/pearls/koral.png")

item_light = addModel("item_light", 17, 13,
[[
XXX
]])
addItemAnim(item_light, "images/pearls/musle_troj.png")
...
addItemAnim(item_light, "images/pearls/musla.png")
...
addItemAnim(item_heavy, "images/pearls/1-ocel.png")

item_heavy = addModel("item_heavy", 16, 9,
[[
X
]])
addItemAnim(item_heavy, "images/pearls/2-ocel.png")
...
addItemAnim(perla1, "images/pearls/perla_00.png")
...
addItemAnim(perla2, "images/pearls/perla_00.png")
-- extsize=3; first="perla0.BMP"
...
addItemAnim(perla3, "images/pearls/perla_00.png")
-- extsize=3; first="perla0.BMP"
...
addItemAnim(perla4, "images/pearls/perla_00.png")
-- extsize=3; first="perla0.BMP"
...
addItemAnim(perla5, "images/pearls/perla_00.png")
-- extsize=3; first="perla0.BMP"
...
addItemAnim(perla6, "images/pearls/perla_00.png")
-- extsize=3; first="perla0.BMP"
...
addItemAnim(perla7, "images/pearls/perla_00.png")
-- extsize=3; first="perla0.BMP"
...
addItemAnim(perla8, "images/pearls/perla_00.png")
-- extsize=3; first="perla0.BMP"
...
addItemAnim(perla9, "images/pearls/perla_00.png")
-- extsize=3; first="perla0.BMP"
...
addItemAnim(perla10, "images/pearls/perla_00.png")
-- extsize=3; first="perla0.BMP"
...
addItemAnim(perla11, "images/pearls/perla_00.png")
-- extsize=3; first="perla0.BMP"
...
addItemAnim(perla12, "images/pearls/perla_00.png")
-- extsize=3; first="perla0.BMP"
...
addItemAnim(perla13, "images/pearls/perla_00.png")
-- extsize=3; first="perla0.BMP"
...
addItemAnim(perla14, "images/pearls/perla_00.png")
-- extsize=3; first="perla0.BMP"
