...
dialogStr("Donc, voici à quoi ressemble le jeu le plus populaire de tous les temps.")


dialogId("tet-v-ucta", "font_big", "Only deep respect for its memory prevents me from saying what it looks like...")
dialogStr("Seulement le profond respect pour sa mémoire m'empêche de dire à quoi il ressemble.")


dialogId("tet-m-usudek", "font_small", "But everybody else can see for themselves.")
dialogStr("Mais tout le monde peux s'en rendre compte.")
...
dialogStr("Au moins, tu n'as pas à pousser toutes les pièces sur la droite.")


dialogId("tet-m-predmety", "font_small", "The truth is we have an ample supply of suitable objects here.")
dialogStr("En vérité, nous avons amplement tout ce dont nous avons besoin.")
...
dialogStr("Je pense que ce patch du jeu permettra au joueur d'apprécier le tetris original.")


dialogId("tet-m-program", "font_small", "Okay, try to program it!")
dialogStr("Ok, essaie de l'installer.")
