...
dialogStr("Итак, эта игра оказалось очень популярной в своё время.")

dialogId("tet-v-ucta", "font_big", "Only deep respect for its memory prevents me from saying what it looks like...")
dialogStr("Глубокий респект тому, кто сможет в додуматься до решения в памяти...") --- ??? 

dialogId("tet-m-usudek", "font_small", "But everybody else can see for themselves.")
dialogStr("Но все же любой может найти решение.") -- ????
...
dialogStr("Я думаю мы должны улучшить тетрис в этой комнате.")
...
dialogStr("Не понятно, ты хочешь сдвинуть все куски в право.")

dialogId("tet-m-predmety", "font_small", "The truth is we have an ample supply of suitable objects here.")
dialogStr("Истина в том, что нужно собрать объекты достаточно аккуратно.") -- ???
