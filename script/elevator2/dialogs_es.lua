...
dialogStr("Me temo que si usamos ese extraño símbolo podríamos iniciar alguna clase de ritual oscuro, sin saberlo.")


dialogId("zd2-m-douf", "font_small", "I just hope it won`t drop on my head.")
dialogStr("Yo solo espero que no caiga en mi cabeza.")


dialogId("zd2-m-lebka", "font_small", "Another skull. It`s worse than a morgue.")
dialogStr("Otra calavera. Esto es peor que una morgue.")


dialogId("zd2-v-haml", "font_big", "It`s worse than Hamlet.")
dialogStr("Es peor que Hamlet.")
