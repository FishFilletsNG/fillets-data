...
dialogStr("Je peux voir quelques différences ici... Et je ne pense pas que ce sera plus facile.")
...
dialogStr("Si tu as raison, je ne veux pas savoir de quelle religion il s'agissait.")
...
dialogStr("Un autre crâne. C'est pire qu'une morgue.")


dialogId("zd2-v-haml", "font_big", "It`s worse than Hamlet.")
dialogStr("C'est pire que Hamlet.")
