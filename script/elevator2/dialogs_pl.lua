...
dialogStr("Poprzednia winda była nieco wygodniej zaprojektowana.")
...
dialogStr("Zostawcie mnie w spokoju!")


dialogId("zd2-x-nechme", "font_lightgrey", "Leave me alone and get lost!")
dialogStr("Zostaw mnie, daj mi spokój!")
...
dialogStr("Jeśli planujesz złożyć tu ikrę, to zapomnij!")
