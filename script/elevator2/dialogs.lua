dialog_addDialog("zd2-m-dalsi", "en", "", "font_small", "Another elevator? How many more are there to come?")
...
dialog_addDialog("zd2-v-vlevo", "en", "", "font_big", "Can you see that thing in the lower left? It must be some ancient religious symbol.")
...
dialog_addDialog("zd2-m-nevid1", "en", "", "font_small", "If you are right, I`d rather not know what kind of religion it was.")
...
dialog_addDialog("zd2-m-lebka", "en", "", "font_small", "Another skull. It`s worse than a morgue.")
...
dialog_addDialog("zd2-x-ritual", "en", "", "font_lightgrey", "I`ll initiate a dark ritual!")
...
dialog_addDialog("zd2-x-neklast", "en", "", "font_lightgrey", "Just forget about laying your spawn here.")
