...
dialogStr("Bojím se, že při použítí toho podivného symbolu bezděky spustíme nějaký temný rituál.")


dialogId("zd2-m-douf", "font_small", "I just hope it won`t drop on my head.")
dialogStr("Já jen doufám, že mi při tom nespadne na hlavu.")


dialogId("zd2-m-lebka", "font_small", "Another skull. It`s worse than a morgue.")
dialogStr("Zase nějaká lebka. Je to tu horší než v márnici.")


dialogId("zd2-v-haml", "font_big", "It`s worse than Hamlet.")
dialogStr("Je to tu horší než v Hamletovi.")
...
dialogStr("Nepřibližuj se!")


dialogId("zd2-x-kricet", "font_lightgrey", "I`ll scream if you touch me.")
dialogStr("Jestli na mě sáhneš, budu křičet.")
