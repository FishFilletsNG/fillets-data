...
dialogStr("Het ziet er hier wel anders uit... En ik vermoed dat het niet makkelijker zal zijn dan de vorige keer.")
...
dialogStr("Zie je dat ding linksonder? Dat is vast een oud religieus symbool ofzo.")


dialogId("zd2-m-nevid0", "font_small", "Fortunately, I can’t see much of it.")
dialogStr("Gelukkig kan ik het niet goed zien.")
...
dialogStr("Ik hoop alleen maar dat het niet op m'n kop zal vallen.")
...
dialogStr("Het is hier erger dan in Hamlet.")
...
dialogStr("Blijf bij me uit de buurt!")


dialogId("zd2-x-kricet", "font_lightgrey", "I’ll scream if you touch me.")
dialogStr("Ik ga gillen als je aan me komt.")
...
dialogStr("Ik ga een duistere kracht oproepen, hoor!")


dialogId("zd2-x-nechteme", "font_lightgrey", "Leave me alone!")
dialogStr("Laat me met rust!")
