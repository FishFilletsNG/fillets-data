...
dialogStr("Сега можем спокойно да обмислим как да се измъкнем.")

dialogId("mik-m-proc", "font_small", "White fish, why do you have such big eyes?")
dialogStr("Бяла рибо, защо са ти толкова големи очите?")
...
dialogId("mik-x-stebet1", "", "")
dialogStr("")

dialogId("mik-x-stebet2", "", "")
dialogStr("")

dialogId("mik-x-stebet3", "", "")
dialogStr("")
