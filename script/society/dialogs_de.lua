...
dialogStr("Ich wusste nicht, dass Einsiedlerkrebse so gesprächig sein können.")


dialogId("mik-v-ticho0", "font_big", "Shut up!")
dialogStr("Haltet den Mund!")
...
dialogStr("Jetzt können wir in Ruhe grübeln, wie wir hier rauskommen.")


dialogId("mik-m-proc", "font_small", "White fish, why do you have such big eyes?")
dialogStr("Weißer Fisch, warum hast du so große Augen?")
