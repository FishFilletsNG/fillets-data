...
dialogStr("Rrrottige kapitein Silverrrr...")
...
dialogStr("Een grrrote schat, rrranddebielen...")
...
dialogStr("Hierrr lig ik vrrreselijk in de weg.")
...
dialogStr("Laat me met rrrust en verrrdwijn!")


dialogId("k1-m-copak", "font_small", "What could be inside?")
dialogStr("Wat zou daar in zitten?")
...
dialogStr("Zou dit de legendarische schat van kapitein Silver kunnen zijn?")


dialogId("k1-v-bedna", "font_big", "In such a small chest? The boss surely wouldn`t contact us for such a little case.")
dialogStr("In zo'n klein kistje? Voor zoiets kleins zou de baas ons niet optrommelen.")
...
dialogStr("Dat moet wel een rare figuur geweest zijn.")
...
dialogStr("Kijk dan, hij had hier een menselijke schedel liggen!")
...
dialogStr("Waar zie je die wieg?")


dialogId("k1-v-cit", "font_big", "Oh, you don`t have any feeling for poetry at all...")
dialogStr("Jij hebt ook echt geen poëtische ziel.")
