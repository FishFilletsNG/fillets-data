...
dialogStr("Krrrutý, krrrutý, krrrutý kapitán Silverrrr...")
...
dialogStr("Krrrutý kapitán Silverrrr...")


dialogId("k1-pap-drahokamy", "font_parrot", "Trrreasurre, you foools...")
dialogStr("Drrrahokamy, trrroubové...")
...
dialogStr("To si vyprrrošuju, Lóra je pánův drrrahoušek.")


dialogId("k1-pap-nestrkej", "font_parrot", "Don`t ppppush me!")
dialogStr("Nestrrrkej do mě!")
...
dialogStr("Myslíš, že by to mohl být legendarní Silverův poklad?")


dialogId("k1-v-bedna", "font_big", "In such a small chest? The boss surely wouldn`t contact us for such a little case.")
dialogStr("V tak malé truhle? Kvůli jedné takové bedničce by nás šéf určitě nekontaktoval.")
...
dialogStr("Podívej, měl tu lidskou lebku!")


dialogId("k1-v-jejeho", "font_big", "Well, maybe it`s his own skull.")
dialogStr("Víš, možná je to ta jeho.")
...
dialogStr("Cítíš tu tíživou atmosféru? Potopený vrak, kostra papouška, lidská lebka, převrácená kolébka...")


dialogId("k1-m-kolebku", "font_small", "Where do you see the cradle?")
dialogStr("Kde vidíš tu kolébku?")


dialogId("k1-v-cit", "font_big", "Oh, you don`t have any feeling for poetry at all...")
dialogStr("Ach jo, ty nemáš vůbec cit pro poezii...")
