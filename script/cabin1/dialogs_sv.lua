...
dialogStr("Grrrrymma, grrrymma, grrrymma kapten Silverrr...")
...
dialogStr("Grrrymma kapten Silverrr...")


dialogId("k1-pap-drahokamy", "font_parrot", "Trrreasurre, you foools...")
dialogStr("Skatterrr, errra narrrarrrr...")
...
dialogStr("Lämna mig i fred och dra!")


dialogId("k1-m-copak", "font_small", "What could be inside?")
dialogStr("Vad kan finnas i den?")
...
dialogStr("Hon kanske tillhörde den person som bodde i den här hytten.")


dialogId("k1-m-podivin", "font_small", "Whoever lived here sure was weird.")
dialogStr("Den som bodde här var verkligen konstig.")
