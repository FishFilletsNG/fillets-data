...
dialogStr("Усещаш ли атмосферата на леш и разложение? Потънали останки, папагалски скелет, човешки череп и счупена свещ...")

dialogId("k1-m-kolebku", "font_small", "Where do you see the cradle?")
dialogStr("Къде видя свещ?")

dialogId("k1-v-cit", "font_big", "Oh, you don`t have any feeling for poetry at all...")
dialogStr("О, изобщо нямаш чувство за поезия...")
