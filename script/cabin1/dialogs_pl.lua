...
dialogStr("Jesteś za grrruby, nie przepłyniesz...")


dialogId("k1-pap-sucharek", "font_parrot", "Polly wants a crrracker!")
dialogStr("Polly chce krrrakerrrsa!")
...
dialogStr("Zostaw mnie i spierrrniczaj!")


dialogId("k1-m-copak", "font_small", "What could be inside?")
dialogStr("Jak myślisz, co jest w środku?")
...
dialogStr("Myślísz, że to może być legendarny skarb Silvera?")


dialogId("k1-v-bedna", "font_big", "In such a small chest? The boss surely wouldn`t contact us for such a little case.")
dialogStr("W takim małym kuferku? Szef z pewnością nie zaganiałby nas do takiej banalnej sprawy.")
...
dialogStr("Spójrz, trzymał tu ludzką czaszkę!")


dialogId("k1-v-jejeho", "font_big", "Well, maybe it`s his own skull.")
dialogStr("Może to jego własna?")
...
dialogStr("Czujesz tę przegniłą atmosferę? Zatopiony wrak, szkielet papugi, ludzka czaszka i połamana kolebka.")


dialogId("k1-m-kolebku", "font_small", "Where do you see the cradle?")
dialogStr("Gdzie ty tu widzisz kolebkę?")


dialogId("k1-v-cit", "font_big", "Oh, you don`t have any feeling for poetry at all...")
dialogStr("Ech, w ogóle się nie znasz na poezji...")
