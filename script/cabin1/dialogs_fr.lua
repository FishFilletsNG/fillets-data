...
dialogStr("Que peut-il y avoir à l'intérieur ?")
...
dialogStr("Dans un si petit coffre ? Le patron n'aurait sûrement pas fait appel à nous pour un cas si mineur.")
...
dialogStr("Je suis désolé. Je serai plus prudent la prochaine fois.")


dialogId("k1-v-opatrne", "font_big", "Be careful! Don`t hurt it!")
dialogStr("Attention ! Ne le blesse pas !")
...
dialogStr("Quiconque vivait ici devait être dérangé.")
...
dialogStr("Regarde, il avait un crâne humain là !")


dialogId("k1-v-jejeho", "font_big", "Well, maybe it`s his own skull.")
dialogStr("Hé bien, c'est peut être son propre crâne.")
...
dialogStr("Tu ne sens pas l'atmosphère de pourriture et de décrépitude ? l'épave engloutie, le squelette de perroquet, le crâne humain, et le berceau brisé...")


dialogId("k1-m-kolebku", "font_small", "Where do you see the cradle?")
dialogStr("Où vois-tu un berceau ?")


dialogId("k1-v-cit", "font_big", "Oh, you don`t have any feeling for poetry at all...")
dialogStr("Oh, tu n'as vraiment aucun sens de la poésie...")
