...
dialogStr("¿Puedes sentir la atmósfera de podredumbre y decadencia? El fregadero en ruinas, el esqueleto del loro, la calavera humana, y la cuna quebrada...")


dialogId("k1-m-kolebku", "font_small", "Where do you see the cradle?")
dialogStr("¿Donde puedes ver la cuna?")


dialogId("k1-v-cit", "font_big", "Oh, you don`t have any feeling for poetry at all...")
dialogStr("Oh, no tienes ningún sentimiento poético... para nada.")
