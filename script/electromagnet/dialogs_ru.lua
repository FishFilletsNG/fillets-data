...
dialogStr("Как я и сказал, это неопознанный инопланетный артефакт.")

dialogId("rand-6-4", "font_small", "Yes. But what is its purpose?")
dialogStr("Да, но для чего он нужен?")
...
dialogStr("Если бы я знал, я называл бы его не неопознанный инопланетный артефакт, а просто инопланетный артефакт.")
...
dialogStr("Ой щекотно.")

dialogId("b-hurt-1", "font_big", "That prickles.")
dialogStr("Ай колется.")
