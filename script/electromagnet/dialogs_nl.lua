...
dialogStr("We zitten vast.")

dialogId("init-1", "font_small", "We will find a way out of here.")
dialogStr("We vinden wel een manier om eruit te komen.")
...
dialogStr("Ja, maar waar is het voor?")
...
dialogStr("Als ik dat wist, dan was het geen ongeïdentificeerd buitenaards artefact meer, maar een gewoon buitenaards artefact.")
