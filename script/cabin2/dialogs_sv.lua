...
dialogStr("Någon bor antagligen på land. De här skeletten är synliga bevis på deras försök att fylla havet med saker som inte hör hemma här.")
...
dialogStr("Låt oss tänka efter. Kan vi ta lösningen från förra hytten och modifiera den lite?")


dialogId("ka2-m-tezko", "font_small", "Hmm... I don’t think so.")
dialogStr("Tja... jag tror det.")


dialogId("ka2-m-svitit", "font_small", "So, let’s shed some light on it.")
dialogStr("Så, låt oss sprida lite ljus över det.")


dialogId("ka2-v-hrbet", "font_big", "My back aches.")
dialogStr("Min rygg värker.")
