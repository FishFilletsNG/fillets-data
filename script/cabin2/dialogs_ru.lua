...
dialogStr("Кто мог жить на земле. Эти скелеты очень похожи на доказательств того, что они прожили в океане.") -- FIXME
...
dialogStr("Давай начнем пытаться думать. Мы не можем взять нашего скелета в предыдущею кабину и немного его модифицировать?")

dialogId("ka2-m-tezko", "font_small", "Hmm... I don’t think so.")
dialogStr("Хм... думаю что нет.")

dialogId("ka2-m-svitit", "font_small", "So, let’s shed some light on it.")
dialogStr("Итак, попробуем пролить немного света на это.")

dialogId("ka2-v-hrbet", "font_big", "My back aches.")
dialogStr("Моя боль возвращается.") -- FIXME
