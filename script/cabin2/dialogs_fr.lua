...
dialogStr("Non, tu te trompes. Cette cabine est cent quarante quatre carrés plus grande...")
...
dialogStr("Tu as vu ? Cette pièce est quasiment la dernière. Se pourrait-il que se soit vraiment le trésor ?")


dialogId("ka2-v-mapa0", "font_big", "And what would be in the other two?")
dialogStr("Et qu'est ce qu'il y aurait dans les deux autres ?")


dialogId("ka2-v-mapa1", "font_big", "They told us clearly to find the map. Nobody mentioned treasure.")
dialogStr("Ils nous ont clairement dit de trouver la carte. Personne n'a parlé du trésor.")


dialogId("ka2-v-mapa2", "font_big", "Don’t be so annoying. The authors of the game would surely let the player know.")
dialogStr("Ne sois pas si pénible. Les auteurs du jeu voulaient sûrement que le joueur sache.")


dialogId("ka2-m-chapadlo", "font_small", "This octopus has unpleasantly knotted tentacles. I can’t fit between them.")
dialogStr("Ce poulpe a emmêlé ces tentacules de manière désagréable. Je ne peux pas me glisser entre elles.")
...
dialogStr("Petit poulpe, pourrais-tu te déplacer un petit peu, s'il te plaît ?")
...
dialogStr("Les squelettes semblent être le décor favori des auteurs de ce jeu.")
...
dialogStr("Qui vivent probablement sur terre. Ces squelettes sont la preuve visible de leur effort de bourrer l'océan avec tout ce qui n'a rien à y faire.")
...
dialogStr("Alors, faisons un peu de lumière là dessus.")
