...
dialogStr("Tu as vu ? Cette pièce et quasiment identique à la précédente. Se pourrait-il que se soit vraiment le trésor ?")


dialogId("ka2-v-mapa0", "font_big", "And what would be in the other two?")
dialogStr("Et qu'est qu'il y a dans les deux autres ?")


dialogId("ka2-v-mapa1", "font_big", "They told us clearly to find the map. Nobody mentioned treasure.")
dialogStr("Ils nous ont clairement dit de trouver la carte. Personne n'a parlé de trésor.")


dialogId("ka2-v-mapa2", "font_big", "Don`t be so annoying. The authors of the game would surely let the player know.")
dialogStr("Soit pas si contrariant. Les auteurs du jeu voulait sûrement que le joueur sache.")


dialogId("ka2-m-chapadlo", "font_small", "This octopus has unpleasantly knotted tentacles. I can`t fit between them.")
dialogStr("Cette pieuvre a emmêlé ces tentacules de manière disgracieuse. Je ne peux pas me glisser entre elles.")


dialogId("ka2-v-fik", "font_big", "... so what if we cut one off?!")
dialogStr("... et si nous en coupons une ?!")


dialogId("ka2-v-napad", "font_big", "I am sorry, it was just an idea.")
dialogStr("Désolé, c'était juste une idée.")


dialogId("ka2-m-hej", "font_small", "Little octopus, couldn`t you move away a little bit, please?")
dialogStr("Petite pieuvre, pourrais-tu te déplacer un petit peu, s'il te plaît ?")


dialogId("ka2-m-diky", "font_small", "Hmm... thanks a lot.")
dialogStr("Hum... Merci beaucoup.")


dialogId("ka2-v-kostry", "font_big", "Skeletons seem to be a favorite motif of this game authors.")
dialogStr("Les squelettes semblent être un motif favori pour les auteurs de ce jeu.")
...
dialogStr("Qui vivent probablement sur terre. Ces squelettes sont la preuve visible de leur effort de bourrer l'océan avec tout ce qu'ils ne veulent plus là haut.")
...
dialogStr("Réfléchissons. Est-ce que nous ne pouvons pas appliquer la solution de la cabine précédente en la modifiant un peu.")


dialogId("ka2-m-tezko", "font_small", "Hmm... I don`t think so.")
dialogStr("Hum... Je ne crois pas.")


dialogId("ka2-m-svitit", "font_small", "So, let`s shed some light on it.")
dialogStr("Ainsi, faisons un peu de lumière là dessus.")


dialogId("ka2-v-hrbet", "font_big", "My back aches.")
dialogStr("Mon dos me fait mal.")
