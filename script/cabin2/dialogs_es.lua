...
dialogId("k1-pap-sakris", "font_parrot", "Darrrn!")
dialogStr("¡Desdichaaa!")
...
dialogStr("Quienes están probablemente viviendo en tierra. Esos esqueletos son la prueba visible de su esfuerzo para llenar el océano con todas las cosas que no pertenecen ahí.")
...
dialogStr("Tratemos de pensar. ¿Podemos tomar nuestra solución de esa cabina previa y modificarla un poquito?")


dialogId("ka2-m-tezko", "font_small", "Hmm... I don`t think so.")
dialogStr("Hmm... No lo creo.")


dialogId("ka2-m-svitit", "font_small", "So, let`s shed some light on it.")
dialogStr("Asi pues, pongamos un poco de luz a esto.")


dialogId("ka2-v-hrbet", "font_big", "My back aches.")
dialogStr("Mi espalda me duele.")
