...
dialogStr("Moet je die papegaai zien!!!")


dialogId("ka2-m-kostra", "font_small", "So what? It's a normal skeleton.")
dialogStr("Nou en? Het is een normaal papegaaienskelet.")
...
dialogStr("En wat zit er dan in de volgende twee velden?")
...
dialogStr("... en als we er eentje afhakken?!")
