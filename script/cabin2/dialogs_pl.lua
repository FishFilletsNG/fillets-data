...
dialogStr("To już prawie ostatnie pomieszczenie. Czy to może być skarb, którego szukamy?")
...
dialogStr("... a może jej jedną obetniemy?!")
...
dialogStr("Hmmm... dzięki.")


dialogId("ka2-v-kostry", "font_big", "Skeletons seem to be a favorite motif of this game authors.")
dialogStr("Szkielety są najwyraźniej ulubionym motywem twórców tej gry.")
...
dialogStr("Już mnie grzbiet boli.")
