...
dialogStr("Patrně jsou to suchozemci. Ty kostry jsou zřejmým důsledkem snahy nacpat pod vodu co nejvíce tvorů, kteří tam nemají co dělat.")
...
dialogStr("Zkusme se zamyslet. Nedalo by se nějak vyjít z toho, jak jsme projeli tu předchozí kajutu?")


dialogId("ka2-m-tezko", "font_small", "Hmm... I don`t think so.")
dialogStr("Hmmm... těžko.")


dialogId("ka2-m-svitit", "font_small", "So, let`s shed some light on it.")
dialogStr("Tak si na to posvítíme.")


dialogId("ka2-v-hrbet", "font_big", "My back aches.")
dialogStr("Už mě bolí hřbet.")
