...
dialogStr("Grrrausamer, grrrausamer Kapitän Silverrrr...")


dialogId("k1-pap-kruty", "font_parrot", "Crrruel Captain Silverrrr...")
dialogStr("Grrrausamer Kapitän Silverrrr...")
...
dialogStr("Haben wir das nicht irgendwo schon mal gesehen?")
...
dialogStr("Schau, der Papagei!!!")


dialogId("ka2-m-kostra", "font_small", "So what? It's a normal skeleton.")
dialogStr("Na und? Ein normales Skelett.")
...
dialogStr("Die wahrscheinlich an Land leben. Diese Skelette sind der sichtbare Beweis für ihre Anstrengungen, das Meer mit all den Dingen vollzustopfen, die hier nicht hergehören.")
...
dialogStr("Lass uns nachdenken. Können wir nicht die Lösung aus der vorherigen Kajüte nehmen und ein wenig abändern?")


dialogId("ka2-m-tezko", "font_small", "Hmm... I don`t think so.")
dialogStr("Hmm... Ich glaube nicht.")


dialogId("ka2-m-svitit", "font_small", "So, let`s shed some light on it.")
dialogStr("So, lass uns ein wenig Licht ins Dunkel bringen.")


dialogId("ka2-v-hrbet", "font_big", "My back aches.")
dialogStr("Mein Rücken tut weh.")
