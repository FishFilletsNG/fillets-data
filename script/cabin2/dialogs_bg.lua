...
dialogStr("Това не го ли видяхме вече?")

dialogId("ka2-m-kdepak", "font_small", "No, you’re wrong. This cabin is one hundred and forty four squares larger...")
dialogStr("Не, грешиш. Тази каюта е сто четирдесет и четири квадратчета по-голяма...")
...
dialogStr("На разни сухоземни. Тези скелети са видимо доказателство за усилията им да задръстят океана с неща, на които не им е тук мястото.")
...
dialogStr("Да опитаме да помислим. Не може ли да приложим решението от предишната каюта като го изменим малко?")

dialogId("ka2-m-tezko", "font_small", "Hmm... I don’t think so.")
dialogStr("Хм... Не мисля.")

dialogId("ka2-m-svitit", "font_small", "So, let’s shed some light on it.")
dialogStr("Да хвърлим малко светлина.")

dialogId("ka2-v-hrbet", "font_big", "My back aches.")
dialogStr("Гърбът ме наболява.")
