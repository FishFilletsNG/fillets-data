...
dialogStr("PREMIERE CHAMBRE TORPEDO CHARGEE...")


dialogId("zr-m-obliceje", "font_small", "Stop making faces and come help me.")
dialogStr("Arrête tes grimaces et viens m'aider.")
...
dialogStr("Comme d'habitude. Il me laisse simplement derrière.")


dialogId("zr-m-pockej", "font_small", "Wait! What about me? I want to get out of here, too!")
dialogStr("Attends ! Et moi ! Je veux sortir d'ici moi aussi.")


dialogId("zr-v-hej", "font_big", "Hey, is anybody down there?")
dialogStr("Hé, Il y a quelqu'un en bas ?")


dialogId("zr-v-halo", "font_big", "Hello, can you hear me in there?")
dialogStr("Salut, peux-tu m'entendre là dedans ?")
...
dialogStr("Arrête de crier et sort moi d'ici.")
...
dialogStr("Voilà. Je peux sortir.")


dialogId("zr-m-komu", "font_small", "Whose eyes are those?")
dialogStr("A qui sont ces yeux .")
