...
dialogStr("Das ist grossartig! Er macht sich einfach aus dem Staub. Und ich?")


dialogId("zr-v-nevim", "font_big", "I don`t know. Maybe the periscope is connected to some other dimension.")
dialogStr("Ich weiss nicht. Vielleicht ist das Periskop mit einer anderen Dimension verbunden.")
