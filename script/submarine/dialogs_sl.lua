...
dialogStr("PRVI TORPEDO NALOŽEN...")

dialogId("zr-m-obliceje", "font_small", "Stop making faces and come help me.")
dialogStr("Nehaj se pačit in mi pridi pomagat.")
...
dialogStr("Nehaj kričati in me že spravi od tu.")
