...
dialogStr("PRVNÍ NÁBOJOVÁ KOMORA NABITA...")


dialogId("zr-m-obliceje", "font_small", "Stop making faces and come help me.")
dialogStr("Nedělej na sebe obličeje a pomoz mi.")
