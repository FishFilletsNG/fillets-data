...
dialogStr("EERSTE TORPEDOBUIS GELADEN...")


dialogId("zr-m-obliceje", "font_small", "Stop making faces and come help me.")
dialogStr("Hou op met rare gezichten trekken en help mij eens.")
...
dialogStr("Dat is geweldig! Hij smeert hem gewoon. Wat moet ik nu?")
...
dialogStr("Wacht! En ik dan? Ik wil hier ook weg!")


dialogId("zr-v-hej", "font_big", "Hey, is anybody down there?")
dialogStr("Hallo, is daar iemand, daar beneden?")
