...
dialogStr("Voilà à quoi ça ressemble quand vous ne rangez pas votre bureau.")


dialogId("win-m-costim0", "font_small", "Wouldn`t it help us if we select Desktop/Line up Icons?")
dialogStr("Est-ce que ça ne n'aiderait pas de lancer Bureau/Réorganiser les icônes ?")
...
dialogStr("Et si nous fermions quelques unes de ces fenêtres.")


dialogId("win-m-costim3", "font_small", "What about shutting down the whole thing and switching to command prompt only?")
dialogStr("Et si nous arrêtions tout pour passer en mode ligne de commande?")


dialogId("win-m-costim4", "font_small", "What about giving up altogether and swimming to the pub instead?")
dialogStr("Et si on laissait tout bonnement tomber pour aller au bar à la place ?")
...
dialogStr("Je n'ai pas besoin de les compter. Il y en a quatre-vingt quinze.")


dialogId("win-m-blok", "font_small", "Can you see that Notepad? Now is a good time to send a message to the player!")
dialogStr("Vois-tu cet éditeur de texte ? C'est l'occasion rêvée d'envoyer un message au joueur(se) !")


dialogId("win-v-premyslej", "font_big", "Stop that folly and try to think instead.")
dialogStr("Arrête ton délire et essaie plutôt de réfléchir.")
...
dialogStr("Juste un bip de temps à autre...")


dialogId("win-v-hav", "font_big", "But fortunately the authors got back to it and gave it this modern facelift.")
dialogStr("Mais heureusement que les auteurs l'ont refait pour lui donner cette apparence moderne.")


dialogId("win-m-zahrat", "font_small", "But I`d like to play it sometime, anyway!")
dialogStr("Mais parfois j'aimerais y jouer malgré tout!")
...
dialogStr("Je ne peux pas bouger cette fenêtre. Là en bas, c'est un cylindre en acier, bien que seulement en seize couleurs VGA.")
...
dialogStr("Un instant joueur(se). Nous avons quelque chose à expliquer. Ces deux poissons, c'est nous plus jeunes.")
...
dialogStr("Et bien faisons la grève. Personnellement, je comprends très bien le gros poisson qui se trouve à l'intérieur.")
...
dialogStr("Nous refusons de jouer tant que tu n'as pas sauvé ces deux là, c'est compris?")
...
dialogStr("Fichtre, il a pris le jeu trop à coeur !")
