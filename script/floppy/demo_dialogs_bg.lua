...
dialogStr("Много нови възможности. Нови длъжности. Нова система за създаване на герои, при която нарастват уменията вместо животите. Нов, елегантен механизъм за игра.")

dialogId("dlg-x-poster8", "font_orange", "A game for 21. century.")
dialogStr("Игра за 21-ви век.")

dialogId("dlg-x-poster9", "font_orange", "GAMES HAVE CHANGED")
dialogStr("ИГРИТЕ НЕ СА СЪЩИТЕ")
...
dialogStr("Това получаваме след поставяне на водонепроницаемата дискета, която беше намерена при разследването на тайна криминална организация.")

dialogId("dlg-x-poster11", "font_poster", "We are shocked. Do not let journalists know it.")
dialogStr("Шокиране сме. Пресата не бива да научава за това.")

dialogId("dlg-x-poster12", "font_poster", "You must prevent the panic.")
dialogStr("Трябва да предотвратите паниката.")

dialogId("dlg-x-poster13", "font_poster", "And subscribe two copies for us.")
dialogStr("И да поръчате две копия за нас.")
