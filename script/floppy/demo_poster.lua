...
dialog_addDialog("dlg-x-poster6", "cs", "", "font_orange", "Je to nová hra.")
...
dialog_addDialog("dlg-x-poster7", "cs", "", "font_orange", "Spousta nových možností. Nová povolání. Nový systém tvorby postavy, kde rostou tvoje vlastnosti místo životů. Nový elegantní herní mechanismus.")
