...
dialogStr("Lleno de nuevas posibilidades. Nuevas ocupaciones. Nuevo sistema de creación de personajes, donde, en lugar de tus vidas, tus habilidades crecen. Nuevo elegante mecanismo de juego.")


dialogId("dlg-x-poster8", "font_orange", "A game for 21. century.")
dialogStr("Un juego para el 21. Siglo.")


dialogId("dlg-x-poster9", "font_orange", "GAMES HAVE CHANGED")
dialogStr("LOS JUEGOS HAN CAMBIADO")
...
dialogStr("Esto es lo que obtenemos del computador después de insertar el diskette a prueba de agua que fué encontrado en nuestra investigación de la organización criminal secreta.")


dialogId("dlg-x-poster11", "font_poster", "We are shocked. Do not let journalists know it.")
dialogStr("Estamos impactados. No permitan que los periodistas sepan de esto.")


dialogId("dlg-x-poster12", "font_poster", "You must prevent the panic.")
dialogStr("Ustedes deben de prevenir el pánico.")


dialogId("dlg-x-poster13", "font_poster", "And subscribe two copies for us.")
dialogStr("Y pedir dos copias para nosotros.")
