...
dialogStr("Dragon's Lair Plus это не только новая версия.")


dialogId("dlg-x-poster6", "font_orange", "It's a new game.")
dialogStr("Это новая игра.")
...
dialogStr("Это игра для 21 века.")


dialogId("dlg-x-poster9", "font_orange", "GAMES HAVE CHANGED")
dialogStr("ИГРА ИЗМЕНИЛАСЬ")
...
dialogStr("И записывать по две копии.")
