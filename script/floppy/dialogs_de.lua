...
dialogStr("Denkst du, wir können sie anheben?")
...
dialogStr("Ich denke, es ist nicht möglich. Warum sollten sie sie hier verstecken, wenn wir sie anheben können?")
...
dialogStr("Was sind das für kleine Kreaturen?")


dialogId("disk-v-viry", "font_big", "These must be computer viruses.")
dialogStr("Das müssen Computerviren sein.")
