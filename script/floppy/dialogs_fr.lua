...
dialogStr("Penses-tu que c'est ça ?")
...
dialogStr("Penses-tu que nous pourrons la soulever ?")


dialogId("disk-v-tezko", "font_big", "It will be difficult.")
dialogStr("Ca va être difficile.")


dialogId("disk-v-nejde", "font_big", "I don't think it can be done. Why would they be hiding it here, if we could lift it?")
dialogStr("Je ne pense pas que ce soit possible. Pourquoi est-ce qu'ils l'auraient cachée ici, si nous pouvons la soulever ?")


dialogId("disk-v-ulamu", "font_big", "Shut up, or I will break off your pins!")
dialogStr("Tais-toi, ou je te casse une patte !")
...
dialogStr("Ne serait-il pas suffisant de télécharger le plan depuis la disquette vers notre ordinateur portable ?")


dialogId("disk-v-mas", "font_big", "Why not. Take it out.")
dialogStr("Pourquoi pas, vas-y sors le.")
...
dialogStr("Est-ce que nous allons le chercher ?")


dialogId("disk-v-naano", "font_big", "Never. It may seem funny to you, but my fins are sore.")
dialogStr("Jamais. C'est peut-être marrant pour toi, mais moi j'ai les nageoires endolories.")
...
dialogStr("Et s'il n'y avait aucun plan sur la disquette ? Et si c'était juste pour nous tromper ?")


dialogId("disk-v-neverim", "font_big", "I don`t believe that. Is there some other object that would be more difficult to get out?")
dialogStr("Je ne crois pas. Est-ce qu'il y a ici un objet plus difficile à emporter ?")


dialogId("disk-m-tvorecci", "font_small", "What kind of little creatures are those?")
dialogStr("Quelle sorte de petites créatures est-ce ?")
...
dialogStr("Notre but est de faire sortir la disquette.")


dialogId("disk-x-nepohnes", "font_darkgrey", "You won`t move me easily!")
dialogStr("Vous ne me bougerez pas facilement !")


dialogId("disk-x-mazany", "font_darkgrey", "That was smart!")
dialogStr("Plutôt malin !")
