...
dialogStr("Viele neue Möglichkeiten. Neue Karrieren. Neues System zur Erschaffung von Spielfiguren, in dem deine Fähigkeiten anstatt deine Leben anwachsen. Neuer eleganter Spielmachanismus")


dialogId("dlg-x-poster8", "font_orange", "A game for 21. century.")
dialogStr("Ein Spiel für das 21. Jahrhundert.")


dialogId("dlg-x-poster9", "font_orange", "GAMES HAVE CHANGED")
dialogStr("DIE SPIELE HABEN SICH VERÄNDERT")
...
dialogStr("Das bekommen wir vom Rechner, wenn wir die wasserdichte Diskette einlegen, die während unserer Untersuchung der kriminellen Organisation gefunden wurde.")


dialogId("dlg-x-poster11", "font_poster", "We are shocked. Do not let journalists know it.")
dialogStr("Wir sind schockiert. Erzählen sie nichts der Presse.")


dialogId("dlg-x-poster12", "font_poster", "You must prevent the panic.")
dialogStr("Sie müssen die Panik verhindern.")


dialogId("dlg-x-poster13", "font_poster", "And subscribe two copies for us.")
dialogStr("Und bestellen sie zwei Kopien für uns.")
