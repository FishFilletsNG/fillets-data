...
dialogStr("¿Cómo puede caber todo esto en un diskette de tres y media pulgadas?")
...
dialogStr("No seas siempre tan melancólico. No puedo aguantarlo.")
...
dialogStr("Divertido. Me pregunto cómo lo vas a hacer ahora.")
