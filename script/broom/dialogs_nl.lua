...
dialogStr("We kunnen de boel in ieder geval wat opruimen.")
...
dialogStr("Kun je me die bezem even aangeven?")
...
dialogStr("Vergeet dat blik en veeg al het vuil gewoon naar beneden.")
