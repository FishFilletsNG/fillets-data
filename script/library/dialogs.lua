...
dialog_addDialog("vrak-v-vraky1", "cs", "sound/"..codename.."/cs/vrak-v-vraky1.ogg", "font_big", "Ty potopené lodì u¾ mi jdou na nervy.")

dialog_addDialog("vrak-v-vraky2", "en", "", "font_big", "Oh my, another ship sank. It really makes me itchy.")
dialog_addDialog("vrak-v-vraky2", "cs", "sound/"..codename.."/cs/vrak-v-vraky2.ogg", "font_big", "Ach jo, zase se nìkde potopila loï. U¾ mám tìch vrakù dost!")

dialog_addDialog("vrak-m-vrak0", "en", "", "font_small", "Look, it broke our bookcase!")
dialog_addDialog("vrak-m-vrak0", "cs", "sound/"..codename.."/cs/vrak-m-vrak0.ogg", "font_small", "Podívej, jak nám ponièily knihovnièku!")

dialog_addDialog("vrak-m-vrak1", "en", "", "font_small", "Look, it smashed our shelves.")
dialog_addDialog("vrak-m-vrak1", "cs", "sound/"..codename.."/cs/vrak-m-vrak1.ogg", "font_small", "Podívej, rozbily nám polièky.")

dialog_addDialog("vrak-m-vrak2", "en", "", "font_small", "Look, it invaded our library.")
dialog_addDialog("vrak-m-vrak2", "cs", "sound/"..codename.."/cs/vrak-m-vrak2.ogg", "font_small", "Podívej, vlezly nám a¾ do knihovny.")

dialog_addDialog("vrak-m-kupovat0", "en", "", "font_small", "See? You shouldn`t have bought so many books.")
dialog_addDialog("vrak-m-kupovat0", "cs", "sound/"..codename.."/cs/vrak-m-kupovat0.ogg", "font_small", "To má¹ z toho, ¾e kupuje¹ tolik kní¾ek.")

dialog_addDialog("vrak-m-kupovat1", "en", "", "font_small", "You buy every book you can lay your hand on and now you have problems.")
dialog_addDialog("vrak-m-kupovat1", "cs", "sound/"..codename.."/cs/vrak-m-kupovat1.ogg", "font_small", "To má¹ z toho, ¾e koupí¹ ka¾dou kní¾ku, kterou vidí¹.")

dialog_addDialog("vrak-m-naco", "en", "", "font_small", "Why do you have to have so many of them?")
dialog_addDialog("vrak-m-naco", "cs", "sound/"..codename.."/cs/vrak-m-naco.ogg", "font_small", "Na co ti v¹echny jsou?")
...
dialog_addDialog("vrak-m-knihy1", "cs", "sound/"..codename.."/cs/vrak-m-knihy1.ogg", "font_small", "®ivot po ¾ivotì.")
...
dialog_addDialog("vrak-m-knihy5", "cs", "sound/"..codename.."/cs/vrak-m-knihy5.ogg", "font_small", "Jasnovidcem proti své vùli.")

dialog_addDialog("vrak-m-knihy6", "en", "", "font_small", "Outreaching Daniken.")
dialog_addDialog("vrak-m-knihy6", "cs", "sound/"..codename.."/cs/vrak-m-knihy6.ogg", "font_small", "Co Daniken netu¹il.")

dialog_addDialog("vrak-v-vyhodit", "en", "", "font_big", "I`d throw out these, for example.")
dialog_addDialog("vrak-v-vyhodit", "cs", "sound/"..codename.."/cs/vrak-v-vyhodit.ogg", "font_big", "Já bych vyhodil tøeba támhlety.")

dialog_addDialog("vrak-v-knihy0", "en", "", "font_big", "The Three Little Shrimp")
dialog_addDialog("vrak-v-knihy0", "cs", "sound/"..codename.."/cs/vrak-v-knihy0.ogg", "font_big", "Jak Frk a Brk putovali za sumý¹kem.")
...
dialog_addDialog("vrak-v-knihy2", "cs", "sound/"..codename.."/cs/vrak-v-knihy2.ogg", "font_big", "Dlouhý, ©iroký a Hluboký.")

dialog_addDialog("vrak-v-knihy3", "en", "", "font_big", "Sharkerella")
dialog_addDialog("vrak-v-knihy3", "cs", "sound/"..codename.."/cs/vrak-v-knihy3.ogg", "font_big", "O rybce se zlatou mu¹lí na èele.")

dialog_addDialog("vrak-v-knihy4", "en", "", "font_big", "Slimy Squid and the Seven Dwarfs")
dialog_addDialog("vrak-v-knihy4", "cs", "sound/"..codename.."/cs/vrak-v-knihy4.ogg", "font_big", "Sépijka a sedm trpaslíkù.")
...
dialog_addDialog("vrak-m-cteni0", "cs", "sound/"..codename.."/cs/vrak-m-cteni0.ogg", "font_small", "K èemu je nám tolik kní¾ek, kdy¾ stejnì nejdou vytáhnout z polièek?")
...
dialog_addDialog("vrak-m-cteni1", "cs", "sound/"..codename.."/cs/vrak-m-cteni1.ogg", "font_small", "Kdybys místo ètení o nesmyslech trochu sportoval, ve¹el by ses tam.")

dialog_addDialog("vrak-m-cteni2", "en", "", "font_small", "I told you not to buy that Compleate Dictionary of Abnormal.")
dialog_addDialog("vrak-m-cteni2", "cs", "sound/"..codename.."/cs/vrak-m-cteni2.ogg", "font_small", "Øíkala jsem ti, a» nekupuje¹ ten Velký slovník abnormálních výrazù.")

dialog_addDialog("vrak-v-policky", "en", "", "font_big", "Let`s think. We can`t get these books off the shelf.")
dialog_addDialog("vrak-v-policky", "cs", "sound/"..codename.."/cs/vrak-v-policky.ogg", "font_big", "Zamysleme se. Ty knihy nedostaneme z polièek.")

dialog_addDialog("vrak-m-predmety", "en", "", "font_small", "There are only two objects here which we can move with any results.")
dialog_addDialog("vrak-m-predmety", "cs", "sound/"..codename.."/cs/vrak-m-predmety.ogg", "font_small", "Jsou tu jen dva pøedmìty, se kterými má smysl hýbat.")
...
dialog_addDialog("vrak-m-zivocich", "cs", "sound/"..codename.."/cs/vrak-m-zivocich.ogg", "font_small", "®ivoèichu, zavazí¹!")

dialog_addDialog("vrak-v-potvurka", "en", "", "font_big", "You are an obstacle, strange creature!")
dialog_addDialog("vrak-v-potvurka", "cs", "sound/"..codename.."/cs/vrak-v-potvurka.ogg", "font_big", "Zavazí¹, potvùrko!")

dialog_addDialog("vrak-v-snek", "en", "", "font_big", "Can`t you push that snail to me?")
dialog_addDialog("vrak-v-snek", "cs", "sound/"..codename.."/cs/vrak-v-snek.ogg", "font_big", "Nemù¾e¹ toho ¹neka posunout sem ke mnì?")

dialog_addDialog("vrak-m-ocel", "en", "", "font_small", "How am I to get there through that steel?!")
dialog_addDialog("vrak-m-ocel", "cs", "sound/"..codename.."/cs/vrak-m-ocel.ogg", "font_small", "Jak se tam mám asi dostat, pøes tu ocel?!")
