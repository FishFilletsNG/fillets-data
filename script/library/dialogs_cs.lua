...
dialogStr("K čemu je nám tolik knížek, když stejně nejdou vytáhnout z poliček?")
...
dialogStr("Kdybys místo čtení o nesmyslech trochu sportoval, vešel by ses tam.")
...
dialogStr("Jak se tam mám asi dostat, přes tu ocel?!")


dialogId("vrak-m-restart", "font_small", "What about restarting and trying it again from scratch?")
dialogStr("Co takhle restartovat a zkusit to znovu?")
