...
dialogStr("Diese Schiffwracks werden immer arroganter.")


dialogId("vrak-v-vraky1", "font_big", "These sunken ships really irritate me.")
dialogStr("Diese versunkenen Schiffe ärgern mich wirklich.")


dialogId("vrak-v-vraky2", "font_big", "Oh my, another ship sank. It really makes me itchy.")
dialogStr("Oh Mann, noch ein versunkenes Schiff. Das macht mich echt wütend.")


dialogId("vrak-m-vrak0", "font_small", "Look, it broke our bookcase!")
dialogStr("Schau, es hat unser Bücherregal zerhauen!")


dialogId("vrak-m-vrak1", "font_small", "Look, it smashed our shelves.")
dialogStr("Schau, es hat unsere Regale kaputt gemacht.")
...
dialogStr("Wieso haben wir eigentlich so viele Bücher, wenn wir sie nicht rausziehen können?")
...
dialogStr("Wenn du ein wenig Sport machen würdest, anstatt blödes Zeug zu lesen, würdest du reinpassen.")
...
dialogStr("Es gibt hier nur zwei Gegenstände, die zu einem Ergebnis führen, wenn wir sie bewegen.")


dialogId("vrak-m-ostnatec", "font_small", "How did that prickler get here?")
dialogStr("Wie ist der Stachler denn hierher gekommen?")


dialogId("vrak-m-zivocich", "font_small", "You are in the way, strange life form!")
dialogStr("Du bist im Weg, du komische Lebensform!")
...
dialogStr("Wie soll ich denn dort durch den Stahl kommen?!")


dialogId("vrak-m-restart", "font_small", "What about restarting and trying it again from scratch?")
dialogStr("Wie wäre es mit neustarten und von vorne anfangen?")
