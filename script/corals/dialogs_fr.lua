...
dialogStr("Je n'aime pas le corail violet.")


dialogId("re-m-libi0", "font_small", "I love violet corals...")
dialogStr("J'aime le corail violet.")
...
dialogStr("J'espère qu'il y aura du corail plus intéressant dans les prochains niveaux.")
...
dialogStr("Nous devons soulever cet acier...")


dialogId("re-m-ahoj", "font_small", "Hi, crab!")
dialogStr("Salut, le crabe!")


dialogId("re-m-rozveselit", "font_small", "Won`t we try to cheer that crab up a little?")
dialogStr("N'allons-nous pas remonter le moral de ce crabe un petit peu ?")
