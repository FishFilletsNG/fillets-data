...
dialogStr("Я никогда не видел таких фиолетовых кораллов.")

dialogId("re-v-koraly1", "font_big", "I don’t like violet corals.")
dialogStr("Мне не нравятся фиолетовые кораллы.")

dialogId("re-m-libi0", "font_small", "I love violet corals...")
dialogStr("А я люблю фиолетовые кораллы...")
...
dialogStr("Надеюсь, еще больше интересных кораллов мы найдем на следующем уровне.")

dialogId("re-v-pokoj", "font_big", "God forbid.")
dialogStr("Боже упаси.")

dialogId("re-v-ocel", "font_big", "We will have to lift this steel...")
dialogStr("Нам придется поднять эту трубу...")
...
dialogStr("Разве мы не поприветствуем того краба хоть немного?")
