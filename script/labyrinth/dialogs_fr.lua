...
dialogStr("Maintenant une pièce bizarre.")


dialogId("bl-v-zvlastni1", "font_big", "This is a very unusual room.")
dialogStr("C'est vraiment pas une pièce habituelle.")
...
dialogStr("Et qu'est-ce qui est suspendu ?")
...
dialogStr("Comment le corail a put prendre une forme si bizarre.")


dialogId("bl-v-pestovany", "font_big", "It is carefully grown for the logical games players.")
dialogStr("Il a soigneusement grandit pour un jeu de logique.")


dialogId("bl-v-proc", "font_big", "Why do you want to put that coral down, anyway?")
dialogStr("Pourquoi tu veux faire tomber le corail, après tout ?")
...
dialogStr("Escargot content, escargot heureux, sort tes cornes...")


dialogId("bl-v-dost0", "font_big", "Stop it! As if you don`t know that no object will move if we don`t push it first!")
dialogStr("Arrête ça ! Comme si tu ne savais pas qu'aucun objet ne bouge si nous ne l'avons pas pousser avant !")
...
dialogStr("Arrête ! Ca me hérisse les écailles.")


dialogId("bl-m-snecku2", "font_small", "Don`t listen then. Shalimuddy, shalimuddy, put your...")
dialogStr("N'écoute pas alors. Escargot content, escargot heureux, sort tes...")
