...
dialog_addDialog("bl-m-zvlastni0", "it", "", "font_small", "Ecco, questa è proprio una strana stanza.")
...
dialog_addDialog("bl-v-zvlastni1", "it", "", "font_big", "Proprio una strana stanza.")
...
dialog_addDialog("bl-m-funkce", "it", "", "font_small", "La posizione di assistente coordinatore addetto alla progettazione è stata introdotta in virtù di questo livello. Così il suo autore ha avuto il dovuto riconoscimento.")
...
dialog_addDialog("bl-v-pozadi", "it", "", "font_big", "A posto con i retroscena del gioco e mettiamoci all'opera.")
...
dialog_addDialog("bl-m-koral0", "it", "", "font_small", "Questo è proprio uno strano corallo.")
...
dialog_addDialog("bl-v-koral1", "it", "", "font_big", "Che corallo particolare.")
...
dialog_addDialog("bl-m-visi", "it", "", "font_small", "A cosa è appeso?")
...
dialog_addDialog("bl-v-nevim0", "it", "", "font_big", "Non lo so. Ma dobbiamo tirarlo giù.")
...
dialog_addDialog("bl-v-nevim1", "it", "", "font_big", "Non lo so. Dici che dovremmo tirarlo giù?")
...
dialog_addDialog("bl-m-tvar", "it", "", "font_small", "Come può aver acquisito una forma così bizzarra questo corallo?")
...
dialog_addDialog("bl-v-pestovany", "it", "", "font_big", "E` stato accuratamente coltivato per i solutori di rompicapi.")
...
dialog_addDialog("bl-v-proc", "it", "", "font_big", "Ma perché lo vuoi tirare giù, dopotutto?")
...
dialog_addDialog("bl-m-zeptej", "it", "", "font_small", "Non ne ho idea. Chiedilo al giocatore.")
...
dialog_addDialog("bl-m-snecku0", "it", "", "font_small", "Lumachì, lumacà, le tue corna metti là...")
...
dialog_addDialog("bl-v-dost0", "it", "", "font_big", "Smettila! Come se non sapessi che nessun oggetto si muove se noi non lo spingiamo prima!")
...
dialog_addDialog("bl-m-snecku1", "it", "", "font_small", "Ma perché non posso provare? Lumachì lumacà...")
...
dialog_addDialog("bl-v-dost1", "it", "", "font_big", "Basta! Mi viene l'orticaria alle scaglie!")
...
dialog_addDialog("bl-m-snecku2", "it", "", "font_small", "Allora non ascoltare. Lumachì lumacà, le tue corna...")
...
dialog_addDialog("bl-v-dost2", "it", "", "font_big", "Smettila! O ti tiro quel corallo in testa!")
