...
dialogStr("Мы оказались в странной комнате.")
...
dialogStr("Должность помощника заместителя координатора дизайна специально была создана для этого уровня. Так что его автор получил должное признание.")

dialogId("bl-v-pozadi", "font_big", "Enough about the game background. Let’s get to work.")
dialogStr("Хватит про создание игры. Давай работать.")

dialogId("bl-m-koral0", "font_small", "This is a very strange coral.")
dialogStr("Это очень странный коралл.")

dialogId("bl-v-koral1", "font_big", "This is a very peculiar coral.")
dialogStr("Это очень необычный коралл.")

dialogId("bl-m-visi", "font_small", "And what does it hang on?")
dialogStr("И как он держится?")

dialogId("bl-v-nevim0", "font_big", "I don’t know. But we have to get it down anyway.")
dialogStr("Не знаю, но мы в любом случае должны достать его оттуда.")

dialogId("bl-v-nevim1", "font_big", "I don’t know. Do we have to put it down?")
dialogStr("Не знаю. Нам надо опустить его вниз?")
...
dialogStr("Не слушай тогда. Тирли-тирли, покажи свои...")
