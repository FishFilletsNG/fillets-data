...
dialogStr("La musique s'est arrêtée !")


dialogId("d1-1-hudba1", "font_viking1", "They stopped playing!")
dialogStr("Ils ne jouent plus.")
...
dialogStr("Qu'est ce qui s'est passé ?")
...
dialogStr("Cette saleté de musique s'est arrêtée!")
...
dialogStr("Comment est-ce possible ?")
