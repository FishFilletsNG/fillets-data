...
dialogStr("Det här måste vara ett vikingaskepp!")


dialogId("dr-v-jiste", "font_big", "Sure, it’s a drakkar.")
dialogStr("Visst, det är ett långskepp.")


dialogId("dr-m-musela", "font_small", "She must have sunk fast. The oarsmen are still in their places.")
dialogStr("Det måste ha sjunkit fort. Rorsmannen är fortfarande på plats.")
