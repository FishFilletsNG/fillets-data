...
dialogStr("Non curatevene, uomini. Possiamo cantare da noi!")

dialogId("d1-5-nevadi2", "font_viking5", "Never mind, boys. We can sing ourself, like in the old times!")
dialogStr("Nessun problema, uomini. Possiamo cantare da noi, come ai vecchi tempi!")
