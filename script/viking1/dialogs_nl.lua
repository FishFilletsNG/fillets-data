...
dialogStr("Dit is vast een Vikingschip!")


dialogId("dr-v-jiste", "font_big", "Sure, it`s a drakkar.")
dialogStr("Natuurlijk, het is een drakkar.")
...
dialogStr("Misschien hebben ze haar wel expres laten zinken. Krijgers begeleidden vroeger hun leider op zijn weg naar Valhalla.")


dialogId("dr-m-hruza", "font_small", "That's awful. They look like they're still alive.")
dialogStr("Dat is vreselijk. Ze zien er bijna uit alsof ze nog leven.")


dialogId("d1-1-hudba0", "font_viking1", "The music is gone!")
dialogStr("De muziek is weg!")


dialogId("d1-1-hudba1", "font_viking1", "They stopped playing!")
dialogStr("Ze zijn opgehouden met spelen!")


dialogId("d1-1-hudba2", "font_viking1", "The music stopped again!")
dialogStr("De muziek is alweer opgehouden!")
...
dialogStr("Maakt niet uit, jongens. We kunnen zelf ook zingen, net als vroeger!")
