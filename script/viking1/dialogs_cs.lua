...
dialogStr("Musela se potopit hrozně rychle. Veslaři ještě sedí na svých místech.")
...
dialogStr("Už se to stalo zase?")


dialogId("d1-3-brb0", "font_viking3", "What happened?")
dialogStr("Co se děje?")
