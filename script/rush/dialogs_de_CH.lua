dialogId("v-upozornit", "font_big",
"The player should know that the cylinders are linked with the cars of the same color")
...
dialogId("v-chytra", "font_big",
"Don't be clever when somebody else already is.")
