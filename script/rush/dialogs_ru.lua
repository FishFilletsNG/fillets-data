...
dialogStr("Мне кажется, если fish fillets - хорошая игра, реши очередную головоломку.")
...
dialogStr("Игрок должен узнать где-нибудь, как решить, и потом только повторить это здесь.")
