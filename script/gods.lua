...
createRoom(46, 38, "images/gods/pozadi.png")
...
addItemAnim(wall, "images/gods/lode-w.png")
...
addItemAnim(buh2, "images/gods/neptun_00.png")
...
addItemAnim(buh1, "images/gods/poseidon_00.png")
...
addItemAnim(item_heavy, "images/gods/3-ocel.png")

item_heavy = addModel("item_heavy", 14, 13,
[[
X
]])
addItemAnim(item_heavy, "images/gods/4-ocel.png")
...
addItemAnim(item_heavy, "images/gods/5-ocel.png")

item_light = addModel("item_light", 8, 7,
[[
X
]])
addItemAnim(item_light, "images/gods/ping.png")
...
addItemAnim(palka, "images/gods/palka.png")
...
addItemAnim(item_light, "images/gods/domino.png")
...
addItemAnim(item_light, "images/gods/kuzelka.png")

item_light = addModel("item_light", 16, 34,
[[
XXX
]])
addItemAnim(item_light, "images/gods/bota.png")
...
addItemAnim(hul, "images/gods/hul.png")

kriketak = addModel("item_light", 39, 31,
[[
X
]])
addItemAnim(kriketak, "images/gods/tenisak.png")
...
addItemAnim(objekty, "images/gods/potop_00.png")
...
addItemAnim(maska, "images/gods/maska.png")
