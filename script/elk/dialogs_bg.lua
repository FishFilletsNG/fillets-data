...
dialogStr("Войната продължава дори и на океанското дъно.")

dialogId("deu-v-nepratelstvi", "font_big", "The hostility will never ebb.")
dialogStr("Враждебността никога няма да отслабне.")

dialogId("deu-m-bojovat", "font_small", "They will fight to the last... parrot.")
dialogStr("Ще се бият до последния... папагал.")
...
dialogStr("Това вече е странно. Мислех, че лосовете живеят в Швеция.")

dialogId("deu-v-slysel", "font_big", "Yes. I too have heard that they bite tourists there.")
dialogStr("Да. Аз съм чувал, че там хапели туристи.")
