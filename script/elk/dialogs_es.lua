...
dialogStr("La guerra llega incluso hasta aquí, en el suelo del océano.")


dialogId("deu-v-nepratelstvi", "font_big", "The hostility will never ebb.")
dialogStr("La hostilidad no terminará nunca.")


dialogId("deu-m-bojovat", "font_small", "They will fight to the last... parrot.")
dialogStr("Ellos pelearán hasta el último... perico.")
...
dialogStr("Que extraño. Yo creía que los alces solo vivían en Suecia.")
