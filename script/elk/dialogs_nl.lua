...
dialogStr("De oorlog gaat hier op de oceaanbodem gewoon door.")
...
dialogStr("Ja. Ik heb ook gehoord dat ze daar touristen bijten.")
...
dialogStr("Posjhalsta, isvinitjeh.")


dialogId("deu-l-los1", "font_elk", "Chto sluchilos?")
dialogStr("Sjto slutjilos?")
