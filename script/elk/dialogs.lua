...
dialog_addDialog("deu-v-nepratelstvi", "cs", "sound/"..codename.."/cs/deu-v-nepratelstvi.ogg", "font_big", "Nepøátelství nikdy neutichne.")

dialog_addDialog("deu-m-bojovat", "en", "", "font_small", "They will fight to the last... parrot.")
dialog_addDialog("deu-m-bojovat", "cs", "sound/"..codename.."/cs/deu-m-bojovat.ogg", "font_small", "Budou bojovat a¾ do posledního... papou¹ka.")
...
dialog_addDialog("deu-m-zvlastni", "cs", "sound/"..codename.."/cs/deu-m-zvlastni.ogg", "font_small", "To je zvlá¹tní. Myslela jsem, ¾e losové ¾ijí jen ve ©védsku.")

dialog_addDialog("deu-v-slysel", "en", "", "font_big", "Yes. I too have heard that they bite tourists there.")
dialog_addDialog("deu-v-slysel", "cs", "sound/"..codename.."/cs/deu-v-slysel.ogg", "font_big", "Taky jsem sly¹el, ¾e tam hry¾ou turisty.")
...
dialog_addDialog("deu-v-radsi", "cs", "sound/"..codename.."/cs/deu-v-radsi.ogg", "font_big", "Toho losa bych mìl mnohem rad¹i, kdyby tu tolik nepøeká¾el.")

dialog_addDialog("deu-l-pozalsta", "en", "", "font_elk", "Pozhalsta, izvinitye.")
dialog_addDialog("deu-l-pozalsta", "cs", "sound/"..codename.."/cs/deu-l-pozalsta.ogg", "font_elk", "Po¾alsta, izvinitì.")
...
dialog_addDialog("deu-l-los1", "cs", "sound/"..codename.."/cs/deu-l-los1.ogg", "font_elk", "Èto sluèilos?")
...
dialog_addDialog("deu-l-neznaju", "cs", "sound/"..codename.."/cs/deu-l-neznaju.ogg", "font_elk", "Ja nièevo neznaju.")

dialog_addDialog("deu-l-nesmotrel", "en", "", "font_elk", "Ya nichevo nyesmotrel.")
dialog_addDialog("deu-l-nesmotrel", "cs", "sound/"..codename.."/cs/deu-l-nesmotrel.ogg", "font_elk", "Ja nièevo nesmotrel.")

dialog_addDialog("deu-l-zivjot", "en", "", "font_elk", "Pustye zhivyot moguchy Sovietsky Soyuz!")
dialog_addDialog("deu-l-zivjot", "cs", "sound/"..codename.."/cs/deu-l-zivjot.ogg", "font_elk", "Pus» ¾ivjot moguèij Sovìtskij Sojuz!")

dialog_addDialog("deu-l-necital", "en", "", "font_elk", "Ja nichego nechital.")
dialog_addDialog("deu-l-necital", "cs", "sound/"..codename.."/cs/deu-l-necital.ogg", "font_elk", "Ja nièevo neèital.")

dialog_addDialog("deu-l-tovarisci", "en", "", "font_elk", "Tovarishchi, bratya i sestri, dorogiye druzya...")
dialog_addDialog("deu-l-tovarisci", "cs", "sound/"..codename.."/cs/deu-l-tovarisci.ogg", "font_elk", "Tovari¹èi, bra»ja i sestri, dorogije druzja...")
