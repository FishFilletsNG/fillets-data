...
createRoom(43, 35, "images/creatures/koraly-p.png")
...
addItemAnim(wall, "images/creatures/koraly-w.png")

krab1 = addModel("item_light", 23, 12,
[[
XX
]])
addItemAnim(krab1, "images/creatures/krab_00.png")
...
addItemAnim(balalajka, "images/creatures/balal_00.png")
...
addItemAnim(sas1, "images/creatures/sasanka_00.png")
...
addItemAnim(sas2, "images/creatures/sasanka_00.png")
-- extsize=7; first="sasanka1.BMP"
...
addItemAnim(sas3, "images/creatures/sasanka_00.png")
-- extsize=7; first="sasanka1.BMP"
...
addItemAnim(sas4, "images/creatures/sasanka_00.png")
-- extsize=7; first="sasanka1.BMP"
...
addItemAnim(sas5, "images/creatures/sasanka_00.png")
-- extsize=7; first="sasanka1.BMP"
...
addItemAnim(sas6, "images/creatures/sasanka_00.png")
-- extsize=7; first="sasanka1.BMP"
...
addItemAnim(item_heavy, "images/creatures/ocel-2.png")

item_light = addModel("item_light", 27, 11,
[[
X
]])
addItemAnim(item_light, "images/creatures/maly_snek_00.png")
...
addItemAnim(elko, "images/creatures/ocel-1.png")

krab2 = addModel("item_light", 37, 5,
[[
XX
]])
addItemAnim(krab2, "images/creatures/krab_00.png")
-- extsize=9; first="krab1.BMP"
...
addItemAnim(krab3, "images/creatures/krab_00.png")
-- extsize=9; first="krab1.BMP"
...
addItemAnim(krab4, "images/creatures/krab_00.png")
-- extsize=9; first="krab1.BMP"
...
addItemAnim(krab5, "images/creatures/krab_00.png")
-- extsize=9; first="krab1.BMP"
...
addItemAnim(krab6, "images/creatures/krab_00.png")
-- extsize=9; first="krab1.BMP"
...
addItemAnim(item_heavy, "images/creatures/ocel-3.png")
...
addItemAnim(item_light, "images/creatures/shell1.png")
...
addItemAnim(sepie, "images/creatures/sepie_00.png")
