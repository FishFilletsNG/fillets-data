...
dialogStr("Dat is vast voor mij...")
...
dialogStr("Kun je dat telefoontje voor me aannemen, alsjeblieft?")
...
dialogStr("Echt, ik kan zo weg kruipen. Je hoeft het alleen maar te vragen.")
