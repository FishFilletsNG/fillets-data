...
dialogStr("Bara säg till om du vill att jag ska flytta mig.")
...
dialogStr("Är det någon där?")


dialogId("bat-p-2", "font_pizla", "Are you there, brother?")
dialogStr("Är du där, broder?")
...
dialogStr("Hallå, det är polisinspektör Clouseau som talar. Jag letar efter en farlig snigel som... Nej, inte nu, Kato, din gula apa!")
...
dialogStr("Hallå, ni har kommit till nummer 4202-21913271. Ingen av familjen Spätta är för tillfället hemma. Lämna ett meddelande efter pipet. Vad hände?")
