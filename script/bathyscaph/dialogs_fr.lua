...
dialogStr("Donc c'est un bathyscaphe d'exploration.")


dialogId("bat-m-mikro", "font_small", "A nice microscope.")
dialogStr("Joli microscope.")
...
dialogStr("Veux-tu que je soulève ça ?")
...
dialogStr("Maintenant c'est calme ici.")


dialogId("bat-m-sluch", "font_small", "We can`t get to the receiver from here.")
dialogStr("Nous ne pouvons pas atteindre le récepteur d'ici.")
...
dialogStr("Pouvez-vous prendre cet appel pour moi, s'il vous plaît ?")


dialogId("bat-s-snek0", "font_snail", "I hope I am not in the way here.")
dialogStr("J'espère que je ne suis pas sur le chemin ici.")
...
dialogStr("Je ne souhaite pas être un obstacle.")


dialogId("bat-s-snek3", "font_snail", "Just tell me if you want me to move away.")
dialogStr("Vous n'avez qu'à me dire si je dois bouger.")
