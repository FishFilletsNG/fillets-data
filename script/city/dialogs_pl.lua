...
dialogStr("Dokąd biegniesz?")


dialogId("vit-hs-reklama2", "font_white", "To Moon Street. I need to order eight swords.")
dialogStr("Na ulicę Księżycową. Muszę zamówić sześć mieczy.")
...
dialogStr("Obywatele. Pracownicy porządkowi będą jutro w godzinach nocnych robić obchód w celu wykurzenia demonów i duchów. Uprzejmie prosimy o wpuszczanie ich do domostw.")
...
dialogStr("Poczekaj, muszę to jeszcze przemyśleć...")


dialogId("vit-m-vecnost", "font_small", "Just imagine - that head has been like doing this all these years...")
dialogStr("Wyobraź sobie, ta głowa tak gada wieki całe...")
...
dialogStr("Jak, według ciebie, czują się te biedne kraby?!")
