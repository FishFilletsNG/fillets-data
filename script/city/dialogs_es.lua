...
dialogStr("La nave desde Lemuria ha atracado en el muelle #5. Esta nave continúa hacia Utopía, Mu y Atlantis.")
...
dialogStr("Con el seguro de Primer Pescador, su casa está cubierta contra el daño causado por fuego, tornados, huracanes, actos de Dios e incursiones de dragones. Porque un pescador piensa en todo, escoja Primer Pescador.")


dialogId("vit-hs-reklama1", "font_statue", "Where are you running?")
dialogStr("¿Donde vas arrancando?")


dialogId("vit-hs-reklama2", "font_white", "To Moon Street. I need to order eight swords.")
dialogStr("Hacia la calle Luna. Necesito encargar ocho espadas.")


dialogId("vit-hs-reklama3", "font_statue", "Why so many swords?")
dialogStr("¿Porqué tantas espadas?")
...
dialogStr("¡¿No haz escuchado?! ¡Por cada ocho espadas que compres, obtienes un par de aros de bronce absolutamente GRATIS!")


dialogId("vit-hs-reklama5", "font_statue", "Wait for me. I`m coming with you!")
dialogStr("¡Espérame, voy contigo!")
...
dialogStr("La Corte de la Ciudad amablemente le invita al festival anual de las interrogaciones y ejecuciones de la ciudad. Se requiere el traje apropiado.")
...
dialogStr("El consejo de la ciudad ha decidido construir un acueducto, el que proveerá servicio directo de agua para cada hogar.")
...
dialogStr("¿Podría la madre del niño que se extravió en las salas del tesoro de la ciudad por favor venir a recepción a recoger sus restos?")
...
dialogStr("Ciudadanos, nuestros empleados se detendrán en cada casa mañana después de medianoche para liberarla de demonios y fantasmas. Les solicitamos amablemente dejarlos entrar.")
...
dialogStr("Buestro jefe herético Demíkulo presentará una lectura esta tarde en el pequeño auditorio titulada \"¿Existen realmente los dioses? !o descansa en la seguridad de que no te pueden dañar!\".")
...
dialogStr("Venga a visitar nuestro restorant de comida marina ubicado en la plaza central. Deliciosas especialidades de pez y ...")
...
dialogStr("Espera, tengo que pensarlo por un momento...")


dialogId("vit-m-vecnost", "font_small", "Just imagine - that head has been like doing this all these years...")
dialogStr("Sólo imagina - esa cabeza ha estado de esa forma todos estos años...")
...
dialogStr("Bueno, ¡Piensa sobre cómo esos pobres cangrejos se deben sentir!")
