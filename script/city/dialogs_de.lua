...
dialogStr("Willkommen in der schönsten Stadt unter der Sonne.")


dialogId("vit-hs-vitejteB", "font_statue", "Welcome to our city - the city of unlimited opportunities.")
dialogStr("Willkommen in unserer Stadt - der Stadt der unbegrenzten Möglichkeiten.")
...
dialogStr("Willkommen in userer Stadt, dessen Schönheit selbst die der Götter übertrifft.")


dialogId("vit-hs-klid1", "font_statue", "Citizens, please remain calm.")
dialogStr("Werte Bürger, bitte bewahren sie Ruhe.")


dialogId("vit-hs-klid2", "font_statue", "There is no imminent danger.")
dialogStr("Es gibt keine drohende Gefahr.")


dialogId("vit-hs-klid3", "font_statue", "The sinking of the northern part of our island is only temporary.")
dialogStr("Der Untergang des nördlichen Teils unserer Insel ist nur vorübergehend.")


dialogId("vit-hs-klid4", "font_statue", "We have the situation completely under control.")
dialogStr("Wir haben die Situation vollständig unter Kontrolle.")
...
dialogStr("Das Schiff aus Lemurien hat an Landungssteg 5 angelegt. Dieses Schiff fährt weiter nach Utopia, Mu und Atlantis.")
...
dialogStr("Mit der Allgemeinen Angler Versicherung ist ihr Haus gegen Feuer, Wirbelstürme, Windhosen, Gotteswerk und Drachenüberfälle versichert. Weil Angler an alles denkt, wählen sie die Allgemeine Angler Versicherung!")


dialogId("vit-hs-reklama1", "font_statue", "Where are you running?")
dialogStr("Wo läufst Du hin?")


dialogId("vit-hs-reklama2", "font_white", "To Moon Street. I need to order eight swords.")
dialogStr("Zur Mondstraße. Ich muss acht Schwerter bestellen.")


dialogId("vit-hs-reklama3", "font_statue", "Why so many swords?")
dialogStr("Warum so viele Schwerter?")
...
dialogStr("Hast du nicht gehört? Für jedes achte Schwert bekommst du ein paar Bronzeohrringe absolut KOSTENLOS!")


dialogId("vit-hs-reklama5", "font_statue", "Wait for me. I`m coming with you!")
dialogStr("Warte auf mich. Ich komme mit!")
...
dialogStr("Das Stadtgericht lädt sie zum jährlichen Stadtfest der Verhöre und Hinrichtungen ein. Angemessene Kleidung erforderlich.")
...
dialogStr("Der Stadtrat hat beschlossen, ein Aquädukt zu bauen, um einen direkten Wasseranschluss für jedes Haus zu bieten.")
...
dialogStr("Die Mutter des Kindes, das sich in der Schatzkammer der Stadt verlaufen hat, möchte bitte zur Rezeption kommen und seine Überreste abholen.")
...
dialogStr("Werte Bürger, unsere Angestellten werden morgen nach Mitternacht bei einigen Häusern vorbeisehen, um sie von Dämonen und Geistern zu befreien. Wir bitten höflich sie reinzulassen.")
...
dialogStr("Unser Oberketzer Demikuls wird heute Abend einen Vortrag im kleinen Hörsaal halten mit dem Titel \"Gibt es die Götter wirklich? oder Seien Sie versichert, dass sie ihnen nichts anhaben können\".")
...
dialogStr("Warte, ich muss darüber einen Moment nachdenken...")


dialogId("vit-m-vecnost", "font_small", "Just imagine - that head has been like doing this all these years...")
dialogStr("Stell dir bloß vor, dass dieser Kopf die ganzen Jahre so war...")
...
dialogStr("Na denk mal drüber nach, wie diese armen Krabben sich fühlen müssen!")
