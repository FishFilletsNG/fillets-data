...
dialogStr("Nous contrôlons parfaitement la situation.")
...
dialogStr("Avec l'Assurance Premier Pêcheur, votre maison est couverte contre les dommages dûs au feu, aux tornades, aux ouragans, aux actions divines et aux raids de dragons. Parce que les pêcheurs pensent à tout, choisissez Premier Pêcheur.")


dialogId("vit-hs-reklama1", "font_statue", "Where are you running?")
dialogStr("Où cours-tu ?")


dialogId("vit-hs-reklama2", "font_white", "To Moon Street. I need to order eight swords.")
dialogStr("À la rue Lune. Je dois passer commande de huit épées.")
...
dialogStr("Tu n'as pas entendu ?!? Pour huit épées achetées, une paire de boucles d'oreille en bronze est offerte gratuitement.")
...
dialogStr("Le Tribunal de la cité vous invite aimablement au festival annuel d'tortures et d'exécutions. Tenue correcte exigée.")
...
dialogStr("Le Conseil de la cité a décidé de construire un aqueduc pour fournir directement en eau toutes les maisons.")
...
dialogStr("Est-ce que la maman de l'enfant qui s'est perdu dans la salle au trésor de la cité peut venir récupérer ses restes.")
...
dialogStr("Citoyens, nos employés passerons dans chaque maison demain soir après minuit pour vous débarasser des démons et des fantômes. Nous vous demandons de bien vouloir les laisser entrer.")
...
dialogStr("Notre chef hérétique Demikuls lira ce soir dans le petit auditorium 'Les dieux existent-ils ? ou Soyez sûr qu'ils ne peuvent vous blesser!'")
...
dialogStr("Attends, je dois y réfléchir un moment...")


dialogId("vit-m-vecnost", "font_small", "Just imagine - that head has been like doing this all these years...")
dialogStr("Pense un peu que cette tête est comme ça depuis tant d'année...")
...
dialogStr("Et bien réfléchis un peu à ce que ces pauvres crabes doivent ressentir !")
