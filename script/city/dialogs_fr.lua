...
dialogStr("Bienvenu dans la plus belle cité éclairée par le soleil.")


dialogId("vit-hs-vitejteB", "font_statue", "Welcome to our city - the city of unlimited opportunities.")
dialogStr("Bienvenu dans la plus belle cité - la cité de toutes les opportunités.")


dialogId("vit-hs-vitejteC", "font_statue", "On behalf of the citizens of this town I welcome you.")
dialogStr("De la part de la moitié des citoyens de cette cité, je vous souhaite la bienvenue.")


dialogId("vit-hs-vitejteD", "font_statue", "Welcome to our city, whose beauty eclipses that of the gods themselves.")
dialogStr("Bienvenu dans notre cité, dont la beauté éclipse les dieux eux-mêmes.")


dialogId("vit-hs-klid1", "font_statue", "Citizens, please remain calm.")
dialogStr("Citoyens, s'il vous plaît restez calmes.")
...
dialogStr("Cette statue n'a visiblement pas noté que la cité a sombré il y a longtemps.")
