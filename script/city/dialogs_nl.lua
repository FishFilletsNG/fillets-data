...
dialogStr("Met een Vissers Verzekering is uw huis verzekerd tegen schade als gevolg van brand, tornado's, wervelwinden, goddelijk interventie en drakenaanvallen. Omdat vissers overal aan denken, verzeker uw huis bij Vissers.")
...
dialogStr("Ik ga naar Maanstraat. Ik moet acht zwaarden bestellen.")


dialogId("vit-hs-reklama3", "font_statue", "Why so many swords?")
dialogStr("Waarom zoveel zwaarden?")
...
dialogStr("Heb je het niet gehoord? Bij elke acht zwaarden krijg je helemaal GRATIS een paar bronzen oorbellen!")


dialogId("vit-hs-reklama5", "font_statue", "Wait for me. I`m coming with you!")
dialogStr("Wacht op mij. Ik ga mee!")
...
dialogStr("De gemeenteraad heeft besloten een aquaduct te bouwen om direct stromend water naar elk huis mogelijk te maken.")
...
dialogStr("Bezoek ons visrestaurant aan het Marktplein. Heerlijke visspecialiteiten en...")
...
dialogStr("Wat?! Een visrestaurant?")
...
dialogStr("Wacht, ik moet nog even nadenken...")


dialogId("vit-m-vecnost", "font_small", "Just imagine - that head has been like doing this all these years...")
dialogStr("Stel je voor - dat hoofd is al die tijd zo bezig geweest...")
...
dialogStr("Moet je je eens voorstellen hoe die arme krabben zich voelen!")
