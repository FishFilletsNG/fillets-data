...
dialogStr("Каква възхитителна цивилизация — асансьорът продължава да работи дори и след като е прекарал векове под водата.")

dialogId("zd1-m-tlac", "font_small", "Especially, when we push them.")
dialogStr("Особено ако го бутнем.")

dialogId("zd1-m-dolu", "font_small", "But only down.")
dialogStr("Обаче само надолу.")
...
dialogStr("Хуууу ху хууу! Защо ме пренебрегвате?")

dialogId("zd1-x-huhu6", "font_lightgrey", "Hooooo, hooooo, fish! Pay attention to me!")
dialogStr("Хууууу, хууууу, риби! Обърнете ми внимание!")
