...
dialogStr("Wat een geweldige beschaving. Eeuwenlang onderwater en toch doen hun liften het nog.")


dialogId("zd1-m-tlac", "font_small", "Especially, when we push them.")
dialogStr("Vooral als we ze duwen.")


dialogId("zd1-m-dolu", "font_small", "But only down.")
dialogStr("Maar alleen naar beneden.")


dialogId("zd1-m-last", "font_small", "Do you see that shell?")
dialogStr("Zie je deze schelp?")
...
dialogStr("Ik voel me net een muis in een tredmolentje.")


dialogId("zd1-m-slap", "font_small", "A treadmill for fish? But we only have fins.")
dialogStr("Een tredmolen voor vissen? Maar we hebben alleen vinnen.")


dialogId("zd1-x-huhu1", "font_lightgrey", "Hoo, hooooo, hoooo... I`m over heeeere...")
dialogStr("Joehoe, Joehoeoeoeoe... Ik ben hier...")
