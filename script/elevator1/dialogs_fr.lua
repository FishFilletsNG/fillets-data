...
dialogStr("Quelle glorieuse civilisation. Plusieurs siècles sous l'eau et les ascenseurs fonctionnent toujours.")


dialogId("zd1-m-tlac", "font_small", "Especially, when we push them.")
dialogStr("Surtout quand nous les poussons.")


dialogId("zd1-m-dolu", "font_small", "But only down.")
dialogStr("Mais seulement vers le bas.")
...
dialogStr("Ce coquillage, n'est-il pas un petit peu familier.")
...
dialogStr("Ce crâne semble familier.")


dialogId("zd1-m-stejne", "font_small", "All human skulls look the same... Unlike fish skeletons.")
dialogStr("Tous les crânes humains se ressemblent... Contrairement aux squelettes de poissons.")
...
dialogStr("Hoo, hooooo, hoooo... Je suis iciii...")
...
dialogStr("Hoooo ho hooo ! Pourquoi vous m'ignorez ?")


dialogId("zd1-x-huhu6", "font_lightgrey", "Hooooo, hooooo, fish! Pay attention to me!")
dialogStr("Hooooo, hooooo, les poissons ! Je suis là moi !")
