...
dialogStr("Que gloriosa civilización. Tantas centurias bajo el agua y sus ascensores siguen funcionando.")


dialogId("zd1-m-tlac", "font_small", "Especially, when we push them.")
dialogStr("Especialmente, cuando los empujamos.")


dialogId("zd1-m-dolu", "font_small", "But only down.")
dialogStr("Pero sólo hacia abajo.")
...
dialogStr("Deberían de avergonzarse de si mismos. Este es un comercial subliminal.")


dialogId("zd1-v-lebka", "font_big", "That skull looks familiar.")
dialogStr("Esa calavera luce familiar.")


dialogId("zd1-m-stejne", "font_small", "All human skulls look the same... Unlike fish skeletons.")
dialogStr("Todas las calaveras humanas lucen igual... No como los esqueletos de peces.")


dialogId("zd1-m-cesta", "font_small", "This is a tough path.")
dialogStr("Este es un duro camino.")


dialogId("zd1-v-krecek", "font_big", "I feel like a mouse on a treadmill.")
dialogStr("Me siento como un ratón en una rueda de molino.")
...
dialogStr("¡Hoooo ho hooo! ¿Porqué me ignoran?")


dialogId("zd1-x-huhu6", "font_lightgrey", "Hooooo, hooooo, fish! Pay attention to me!")
dialogStr("Hooooo, hooooo, ¡pez! ¡Póneme atención!")
