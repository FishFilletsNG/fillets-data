...
dialogStr("Kako veličastna civilizacija. Veliko stoletij pod vodo in njihova dvigala še vedno delajo.")

dialogId("zd1-m-tlac", "font_small", "Especially, when we push them.")
dialogStr("Zlasti, ko jih porineva.")

dialogId("zd1-m-dolu", "font_small", "But only down.")
dialogStr("Ampak zgolj navzdol.")
...
dialogStr("Hoooo ho hooo! Zakaj me ignorirate?")

dialogId("zd1-x-huhu6", "font_lightgrey", "Hooooo, hooooo, fish! Pay attention to me!")
dialogStr("Hooooo, hooooo, riba! Upoštevaj me!")
