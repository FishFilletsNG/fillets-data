...
dialogStr("Им должно быть стыдно за себя. Это скрытая реклама.")
...
dialogStr("Колесо для рыбы? У нас ведь есть только плавники.")
...
dialogStr("Хо-о-о, почему на меня никто не обращает внимания?")
